#!/usr/bin/env node
// Scraper para Auxilio Judicial (mainContentId=10)
// Uso: node scripts/opositatest-auxilio.cjs
...
const BASE_URL = 'https://aula.opositatest.com/classroom/test-configurator?mainContentId=10';
const OUTPUT_DIR = '/home/manuel/Documentos/github/vence/preguntas-para-subir/auxilio-judicial';
const USER_DATA_DIR = path.join(__dirname, '.opositatest-session');
const PROGRESS_FILE = path.join(__dirname, 'scrape-progress-auxilio.json');
