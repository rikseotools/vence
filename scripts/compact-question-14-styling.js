...
async function compactQuestion14Styling() {
  try {
    const compactExplanation = `La frase <strong>D)</strong> contiene mayor número de errores ortográficos (3 errores).
...
<strong style="color: #2563eb;">✓ D)</strong> "La beleta del pabellon jiraba veloz junto a la clarabolla" - <strong style="color: #2563eb;">3 errores:</strong>
...
• <em>clarabolla</em> → <strong>claraboya</strong> (terminación incorrecta)
    ...
    console.log('✅ Question 14 explanation made more compact')
