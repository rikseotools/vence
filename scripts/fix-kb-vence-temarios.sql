...
VALUES (
  ...
  'Auxiliar Administrativo Estado (subgrupo C2), Administrativo Estado (subgrupo C1), Tramitación Procesal (subgrupo C1) y Auxilio Judicial (subgrupo C2). Próximamente más oposiciones.',
