...
(async () => {
  ...
  // 3. Obtener preguntas con errores (saltando las primeras 20 ya verificadas)
  ...
  console.log(`🔍 Preguntas 21-40 con errores:\n`);

  withErrors.slice(20, 40).forEach((q, idx) => {
    console.log(`${idx + 21}. ${q.id}`);
  });
})();
