...
const FEEDBACK_ID = '270591ac-2455-4884-b66e-615b62d5a13a';

const MENSAJE = `Hola Diego,

Gracias por escribirnos.

Tienes razón: el contador de preguntas diarias no estaba contando bien y te daba el cupo por agotado sin que lo hubieras gastado. Ya debería estar resuelto.

Cuando puedas, entra y prueba a hacer un test (si te siguiera apareciendo el aviso, cierra la aplicación y ábrela de nuevo para que cargue la versión actualizada).
...
(async () => {
  // PUERTA ANTES DE ENVIAR ([T-695]): lo que no se le dice a un usuario se comprueba, no se
