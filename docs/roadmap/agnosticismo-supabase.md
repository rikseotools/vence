...
>
> **SIGUIENTE:** client-trackers (refactor a endpoint, no Drizzle directo) y **Fase 4 Auth** (bloqueador real de RDS). Servidor-puro restante: ver triage abajo (admin/fraudes 14 es client-side page, stripe/webhook 31 con lupa).
>
