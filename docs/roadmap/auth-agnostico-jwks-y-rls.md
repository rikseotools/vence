...
> **Estado:** 🟢 EN CURSO. **Fase A ✅ COMPLETA (A1+A2+A3)** + limpieza segura + **guardrails** (commits `495886aa`, `c9aeb287`, `aaf22f7f`, `86ecc0a7`, `8a4ac51e`). **Fase C1 EN CURSO** (tier público ✅ + 3 user-scoped ✅, ratchet **128→111** sitios / 43→36 ficheros). Fase B pendiente.
