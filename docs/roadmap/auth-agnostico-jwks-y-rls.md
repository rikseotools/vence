...
> **Estado:** 🟢 EN CURSO. **Fase A ✅ COMPLETA (A1+A2+A3)** + limpieza segura + **guardrails** (commits `495886aa`, `c9aeb287`, `aaf22f7f`, `86ecc0a7`, `8a4ac51e`). **Fase C1 ARRANCANDO** (ratchet puesto, primer target scopeado). Fase B pendiente.
