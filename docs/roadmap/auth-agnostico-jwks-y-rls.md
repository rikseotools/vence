...
> **Estado:** 🟢 EN CURSO. **Fase A ✅ COMPLETA (A1+A2+A3)** + limpieza segura + **guardrails** (commits `495886aa`, `c9aeb287`, `aaf22f7f`, `86ecc0a7`, `8a4ac51e`). **Fase C1 EN CURSO** (tier público ✅ + 6 user-scoped ✅, **4 patrones probados** —público, read, write, auth-opcional—, ratchet **128→106** sitios / 43→33 ficheros). Fase B pendiente.
