...
- **COBERTURA de generación T15 (HECHO 19/07):** **50 preguntas** del TR Subvenciones Aragón en 5 lotes → **45/50 arts escopados con banco (90% cobertura)**, doble auditoría Sonnet (tags `gen_zaragoza_t15_tr_subvenciones[_b2..b5]_2026-07-19`). Cubre todo el arco del epígrafe: concepto, ámbito, régimen jurídico, principios, órganos, bases, registro, procedimiento (iniciación/instrucción/resolución/convocatoria abierta/reformulación), concesión directa (nominativas, interés público, norma legal), justificación, gastos, pago (anticipados/aprobación gasto), subcontratación, invalidez/revocación, reintegro (causas/parcial/procedimiento/prescripción/retención). Guardarraíles cazaron **doble solución** (art 2: aplicación plena a Admin CA -2.1- Y entidades locales -2.3- → reformulada a "aplicación parcial" del art 2.2) + varias explicaciones ceñidas al propio artículo. Los arts 55-80 (control/infracciones/sanciones) quedaron fuera de T15 por epígrafe pero están en BD por si otra oposición los escopa.
- **Build de generación pendiente (opcional, ya hay banco):** más lotes T15 (TR Subvenciones Aragón, otros arts) + huecos Ley 7/1999 (T4). Manual `generar-preguntas-con-ia.md`; verificado contra fuente, draft→doble auditoría→approve, NUNCA inventar.
