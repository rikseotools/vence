...
- **PENDIENTE (no bloquea):** escribir a **Cristina Hojda** (feedback c9e50185) que ya está lista — se le prometió "la próxima semana"; borrador aparte, requiere OK. Temas de hacienda finos (7-12 preguntas): engordar en futura tanda. Refinamientos verify:scope de baja confianza sin aplicar: T119 (LGP algo ancha para un epígrafe conceptual), T121 (financiación).
