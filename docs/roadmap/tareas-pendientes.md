...
- **🔴 LO QUE QUEDA — 9 huecos (T11, T12, T13, T14, T15, T18, T19, T22, T23):**
  ...
  - **T11, T12, T14, T15, T18, T19, T22, T23** = **normativa PROPIA de la UAL**. **✅ RECON HECHO (20/07) — VEREDICTO: CONSTRUIBLE.** Los **12 documentos** (T18 y T22 agrupan tres cada uno) están **localizados, accesibles sin login y con estructura aprovechable**; ninguno bloquea. Fuentes, estructura y gotchas por documento en **`docs/roadmap/build-almeria-aux-admin.md`**. Tres trampas a respetar: (a) **T22-C**: la URL que devuelven los buscadores es la versión de **2019**, la vigente es la de **2023** — importar la mala mete contenido caducado sin dar error; (b) **T14** tiene una **modificación de junio 2026** (BOJA 2026/108/28) sin consolidar; (c) **las 3 resoluciones de T18 son ANUALES** y caducan cada curso → registrarlas con fecha para que las cace `staleDatedLaw.ts`. Todo son PDF: el BOUAL solo publica boletines mensuales agrupados y la página de normativas exige JavaScript.
...
>   - `scripts/verificar-batch-generado.cjs <batch_id>` (Paso 5.bis): literalidad tolerante a puntuación, **cita truncada**, longitudes ±30%, coherencia explicación↔clave, distribución y secuencia.
