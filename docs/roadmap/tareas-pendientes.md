...
- **COBERTURA de generación T15 (1er lote HECHO 19/07):** **10 preguntas** del TR Subvenciones Aragón (arts 1, 4, 8, 9, 16, 26, 35, 44, 47, 50 — concepto, principios, órganos, obligaciones, procedimiento, resolución, justificación, pago, reintegro, prescripción), doble auditoría Sonnet (art 1/44 explicaciones ceñidas al artículo), approved/visibles (tag `gen_zaragoza_t15_tr_subvenciones_2026-07-19`). Los arts 55-80 (control/infracciones/sanciones) quedaron fuera de T15 por epígrafe pero están en BD por si otra oposición los escopa.
