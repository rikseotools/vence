...
- **COBERTURA de generación T15 (HECHO 19/07):** **30 preguntas** del TR Subvenciones Aragón en 3 lotes (arts 1-4, 8-11, 16-18, 22, 24-26, 29, 31, 32, 34-36, 44-47, 50-52 — concepto, ámbito, régimen jurídico, principios, órganos, bases, procedimiento, instrucción, resolución, justificación, pago, subcontratación, invalidez, reintegro, prescripción), doble auditoría Sonnet (tags `gen_zaragoza_t15_tr_subvenciones[_b2/_b3]_2026-07-19`). Guardarraíles cazaron **defecto de doble solución** (art 2: la Ley se aplica plena a Admin CA -2.1- Y a entidades locales -2.3- → reformulada a "aplicación parcial" del art 2.2) + varias explicaciones ceñidas al propio artículo (evitar citar arts no incluidos). Los arts 55-80 (control/infracciones/sanciones) quedaron fuera de T15 por epígrafe pero están en BD por si otra oposición los escopa.
