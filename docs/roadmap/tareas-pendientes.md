...
- **COBERTURA de generación T15 (HECHO 19/07):** **20 preguntas** del TR Subvenciones Aragón en 2 lotes (arts 1, 2, 4, 8-11, 16, 17, 25, 26, 29, 31, 35, 36, 44, 45, 47, 50, 51 — concepto, ámbito, principios, órganos, bases, procedimiento, resolución, justificación, pago, reintegro, prescripción), doble auditoría Sonnet (tags `gen_zaragoza_t15_tr_subvenciones[_b2]_2026-07-19`). Guardarraíles cazaron **defecto de doble solución** (art 2: la Ley se aplica plena a Admin CA -2.1- Y a entidades locales -2.3- → reformulada a "aplicación parcial" del art 2.2) + explicaciones ceñidas al artículo. Los arts 55-80 (control/infracciones/sanciones) quedaron fuera de T15 por epígrafe pero están en BD por si otra oposición los escopa.
