...
- **T4 scope + generación HECHO 19/07** (verified_correct): añadida Ley 7/1999 Admin Local Aragón arts 1-6 + 72-138 (rango curado, no invade T9/T10/T12/T13/T16). **Generadas 28 preguntas en 3 lotes**, doble auditoría Sonnet, todas approved/visibles: lote 1 (arts 1-6, 72, 74) + lote 2 (arts 75-79, 88, 96, 98) + lote 3 (arts 82, 84-87, 91, 93, 94 estatutos/interés comarcal/ELM; tags `gen_zaragoza_t4_ley7_1999[_b2/_b3]_2026-07-19`). Los guardarraíles anti-tell (longitud + enumeración + omisión sustantiva) cazaron **5 defectos** → reequilibrados/completados + re-auditados PERFECT. **COBERTURA pendiente:** faltan lotes para arts 80-81, 89-90, 92, 95-138 (procedimiento estatutos, competencias/organización/funcionamiento comarcas, transferencia/delegación/encomienda, régimen jurídico general) → seguir generando.
...
- **Build de generación pendiente:** más lotes T4 (Ley 7/1999 89-138) + T15 (importar Ley 5/2015 + generar). Manual `generar-preguntas-con-ia.md`; verificado contra fuente, draft→doble auditoría→approve, NUNCA inventar.
