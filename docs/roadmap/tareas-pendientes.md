...
- **Qué:** tres bolsas de preguntas ACTIVAS que el sistema de revisión dio por buenas y que los usuarios están cazando por nosotros. Las tres salieron de impugnaciones del 16/07, no del pipeline:
  ...
  3. **234 candidatas a vínculo de ley equivocado** (enunciado cita una norma y cuelga de otra), sin triar. Precisión baja (hay falsos positivos legítimos: derogatorias, textos refundidos), necesita pase semántico. Tirando del primer hilo salió el nudo de Seguridad Privada (537 preguntas mal colgadas, ya arreglado).
...
- **Estado:** cubo 2 CERRADO (16/07). Cubos 1 (7.158) y 3 (234) medidos y sin drenar. Prioridad alta: son preguntas VIVAS enseñando datos falsos (el caso de Sandra llevaba activo desde el 22/03).
