...
> - ✅ **27 LOSCAM Madrid REHECHO multi-ley con articulado literal**: contenedor repurposed a **Ley 12/2001** (180 arts BOE-A-2002-4375) + creadas como leyes reales propias **Ley 6/2009 Libre Elección** (`e2295ec8`, BOE-A-2010-2187) y **Ley 11/2017 Buen Gobierno** (`1583cb85`, BOE-A-2018-1610), ambas añadidas al `topic_scope` del tema (topic `930705c8`). 77/104 preguntas vinculadas a su ley+artículo real (Ley 12/2001: 57, Ley 6/2009: 10, Ley 11/2017: 10); 20 de Convenio Colectivo CM + conexas (Decreto 24/2008, 246/2023, RD 187/2008, CPDI, distritos, SUMMA) + 7 baja confianza → pendientes. **Patrón cajón-de-sastre multi-ley validado: crear cada norma como ley real + añadir al topic_scope + vincular cada pregunta a su norma.**
> - ✅ **29 Aragón (Ley 6/2002) REHECHO multi-ley con articulado literal**: contenedor repurposed a **Ley 6/2002** (88 arts BOE-A-2002-9667) + creadas como leyes reales **DL 2/2004 SALUD** (`c13df12a`, BOA-d-2005-90000, 52 bloques) y **Ley 9/2013 Autoridad Profesionales** (`92183373`, BOE-A-2013-13652, 13), ambas en el `topic_scope`. 184/317 preguntas vinculadas a su ley+artículo real por similitud de contenido sobre la unión de las 3 leyes (Ley 6/2002: 143, DL 2/2004: 37, Ley 9/2013: 4). **107 pendientes = decretos reglamentarios aragoneses (174/2010, 122/2020, 168/2021, 37/2011, 100/2003, 59/1997, 286/2003, 23/2016), Orden SAN/441/2021, Convenio Colectivo y geografía sanitaria — solo en BOA, NO en la API del BOE** → follow-up: importar literal desde boa.es. + 26 baja confianza.
> - 🔧 **Gotcha BOA:** los documentos del BOA en la API del BOE usan ids de bloque internos (a1-2, a2-3…) con el nº real de artículo en el atributo `titulo` → derivar `article_number` del título, no del id de bloque. Y borrar artículos inventados falla si tienen preguntas INACTIVAS colgando (mover TODAS, activas+inactivas, antes de borrar).
>
> **Corrección legislativa COMPLETA: 26 Murcia, 27 Madrid, 28 Galicia, 29 Aragón rehechos con articulado literal; 30 Carta ya era correcta. Pendiente transversal: importar normas conexas no-BOE (decretos regionales BOA/BOCM/DOG, convenios, órdenes) desde su boletín y enlazar las preguntas aparcadas en los `_tmp_hold`.**
...
Hecho (otras regiones, conexas en BOE): ✅ **Ley 3/2001 Galicia** (consentimiento informado e historia clínica, `7f6ac9c1`, 26 arts, BOE-A-2001-12770) + ✅ **RD 187/2008** (Red Hospitalaria Defensa, `89251403`, 16 arts, BOE-A-2008-3177) creados + topic_scope + relink. Pendientes (boletines sin API): decretos DOG Galicia (54/2015, 55/2015, 206/2005), decretos BORM Murcia (80/2005, 236/2010), Convenio+decretos BOCM Madrid (24/2008, 246/2023), decretos menores BOA Aragón (37/2011, 100/2003, 59/1997, 286/2003, 23/2016, Orden SAN/441) + mapa 168/2021. DOG es HTML; BORM/BOCM son PDF (requieren extracción PDF).

Herramientas de extracción validadas (las 4 fuentes): (1) **BOE opendata API** (BOE-A-* y BOA-d-* con rango de ley); (2) **BOA latin1** (curl ISO-8859-1 + parse "Artículo N.-"); (3) **PDF column-aware** vía pdfjs-dist leyendo coordenadas x/y + de-hyphenación (`/tmp/aulaplus_audit/_pdfcol.cjs`) — para BORM/BOCM a 2 columnas; (4) DOG HTML pendiente de método. ✅ **Decreto 80/2005 Murcia** (instrucciones previas, `b65df625`, 13 arts) creado desde BORM PDF (`borm.es/services/anuncio/132928/pdf`) + topic_scope + relink. Long tail restante (grinding con herramientas ya probadas, falta cazar URL de cada doc): Decreto 236/2010 Murcia (BORM), Decretos DOG Galicia (54/2015, 55/2015, 206/2005), Convenio+Decretos BOCM Madrid (24/2008, 246/2023), Decretos menores BOA Aragón (37/2011, 100/2003, 59/1997, 286/2003, 23/2016, Orden SAN/441) + mapa 168/2021 (tabular).
