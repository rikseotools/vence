...
- **batch**: `gen_trebep_2026-07-26` — **10 preguntas** sobre los arts. **47, 51, 72 y 99** del Real Decreto Legislativo 5/2015 (TREBEP), elegidos con `npm run cobertura:huerfanos`: ratio 1,0 (4 artículos cierran 4 temas) y **~3.100 opositores** detrás. Triple auditoría 10/10 en las tres pasadas. Verificado que el art. 47 va en su redacción vigente tras el **RD-ley 2/2024**.
