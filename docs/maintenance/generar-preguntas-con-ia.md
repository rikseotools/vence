...
> ⚖️ **El tell de longitud también existe INVERTIDO (25/07/2026, batch `gen_atc_t202`).** `analizarLongitud` solo penaliza que la correcta sea la MÁS LARGA (§2.2-bis), pero la auditoría ciega cazó dos preguntas con el vicio simétrico: la correcta era una remisión legal corta y desnuda (art. 12.1 LGT *"El apartado 1 del artículo 3 del Código Civil."*, 46 ch; art. 4.1 *"Corresponde exclusivamente al Estado, mediante ley."*, 51 ch) frente a **tres distractores de 88-98 ch**. Se delata igual por la forma: destaca la rara. **Arreglo correcto = ACORTAR los distractores, nunca inflar la correcta** — alargarla con una coletilla que no está en el artículo rompe la literalidad de §2.2, que es la regla cero. Cuando el artículo responde con una remisión breve, los cuatro textos deben ser igual de breves.
