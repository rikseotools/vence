...
| `harvest_volume` | responde lo que se le sirve, pero el volumen es de otra liga (≥5.000 servidas) | opositor obsesivo en sprint final — mirar reparto por días antes de confirmar |
