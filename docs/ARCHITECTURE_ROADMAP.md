...
> **🟢 Estado 2026-05-24:** **2/5 endpoints migrados y canary ACTIVO** — `medals` (GET+POST) y `answer-and-save` (KEYSTONE real). Pendientes: `test-config` family, `daily-limit`, `stats` (este último despriorizado tras EXPLAIN ANALYZE). El plan ejecutado para answer-and-save está en [`docs/architecture/bloque3-answer-save-plan.md`](architecture/bloque3-answer-save-plan.md) (6 fases, cumplidas las 6).
>
