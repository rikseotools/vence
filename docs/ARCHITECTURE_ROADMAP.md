...
| **Paneles admin — cache + bulkhead** (system-health/infra-stats) | escaneo repetido de `observable_events` 5,4GB cada 60s/admin saturaba el primario (era la query #1 en total_time) | ✅ **APLICADO (12-jul)** | `runbooks/contencion-rds-paneles-admin.md` |
