// app/administrativo-asturias/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-asturias', topicNumber)
  ...
  return {
    title: `${content.title} | Administrativo Principado de Asturias`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Administrativo Principado de Asturias`,
    openGraph: {
      title: `${content.title} | Administrativo Principado de Asturias`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/administrativo-asturias/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/administrativo-asturias/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-asturias" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
