// app/subalterno-parlamento-andalucia/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('subalterno-parlamento-andalucia', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Subalternos del Parlamento de Andalucía`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Subalternos del Parlamento de Andalucía`,
    openGraph: {
      title: `${content.title} | Cuerpo Subalternos del Parlamento de Andalucía`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/subalterno-parlamento-andalucia/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/subalterno-parlamento-andalucia/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="subalterno-parlamento-andalucia" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
