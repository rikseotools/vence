// app/subalterno-parlamento-andalucia/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Subalternos Parlamento Andalucía (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 10) {
    return { block: 'Bloque I. Materia General y de Andalucía', displayNum: topicNumber }
  } else if (topicNumber >= 11 && topicNumber <= 15) {
    return { block: 'Bloque II. El Parlamento de Andalucía', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'subalterno-parlamento-andalucia', updatedAt }: TopicContentViewProps) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <Link
                  href="/login?oposicion=subalterno_parlamento_andalucia&return_to=/subalterno-parlamento-andalucia/temario"
