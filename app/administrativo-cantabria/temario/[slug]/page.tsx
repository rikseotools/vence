// app/administrativo-cantabria/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-cantabria', topicNumber)
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.vence.es/administrativo-cantabria/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-cantabria" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
