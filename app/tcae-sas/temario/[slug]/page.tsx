// app/tcae-sas/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('tcae-sas', topicNumber)
  ...
  return {
    title: `${content.title} | TCAE SAS`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para TCAE SAS`,
    openGraph: {
      title: `${content.title} | TCAE SAS`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/tcae-sas/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/tcae-sas/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="tcae-sas" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
