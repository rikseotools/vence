...
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 11 && topicNumber <= 29) {
    return { block: 'Materia Específica', displayNum: topicNumber - 10 }
  }
  return { block: 'Temario', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'tcae-sas', updatedAt }: TopicContentViewProps) {
