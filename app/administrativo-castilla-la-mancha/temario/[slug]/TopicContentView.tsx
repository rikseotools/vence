// app/administrativo-castilla-la-mancha/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el grupo según el número de tema (Administrativo CLM)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  // Administrativo C1 CLM: numeración secuencial 1-36; Parte Común 1-10, Parte Específica 11-36
  if (topicNumber >= 1 && topicNumber <= 10) {
    return { block: 'Parte Común', displayNum: topicNumber }
  } else if (topicNumber >= 11 && topicNumber <= 36) {
    return { block: 'Parte Específica', displayNum: topicNumber - 10 }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'administrativo-castilla-la-mancha', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=administrativo_castilla_la_mancha&return_to=/administrativo-castilla-la-mancha/temario"
