// app/cuidador-diputacion-cordoba/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('cuidador-diputacion-cordoba', topicNumber)
  ...
  return {
    title: `${content.title} | Cuidador/a de la Diputación Provincial de Córdoba`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuidador/a de la Diputación Provincial de Córdoba`,
    openGraph: {
      title: `${content.title} | Cuidador/a de la Diputación Provincial de Córdoba`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/cuidador-diputacion-cordoba/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/cuidador-diputacion-cordoba/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="cuidador-diputacion-cordoba" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
