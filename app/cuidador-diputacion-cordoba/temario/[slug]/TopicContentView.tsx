// app/cuidador-diputacion-cordoba/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Cuidador/a de la Diputación Provincial de Córdoba)
...
export default function TopicContentView({ content, oposicion = 'cuidador-diputacion-cordoba', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=cuidador_diputacion_cordoba&return_to=/cuidador-diputacion-cordoba/temario"
