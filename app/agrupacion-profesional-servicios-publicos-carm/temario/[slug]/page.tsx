// app/agrupacion-profesional-servicios-publicos-carm/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('agrupacion-profesional-servicios-publicos-carm', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Agrup. Prof. Servicios Públicos CARM`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Agrup. Prof. Servicios Públicos CARM`,
    openGraph: {
      title: `${content.title} | Cuerpo Agrup. Prof. Servicios Públicos CARM`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/agrupacion-profesional-servicios-publicos-carm/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/agrupacion-profesional-servicios-publicos-carm/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="agrupacion-profesional-servicios-publicos-carm" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
