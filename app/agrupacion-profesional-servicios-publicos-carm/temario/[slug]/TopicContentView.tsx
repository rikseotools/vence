// app/agrupacion-profesional-servicios-publicos-carm/temario/[slug]/TopicContentView.tsx
'use client'
...
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  // Numeración secuencial 1-12 en 2 bloques
  if (topicNumber >= 1 && topicNumber <= 7) {
    return { block: 'Parte General', displayNum: topicNumber }
  } else if (topicNumber >= 8 && topicNumber <= 12) {
    return { block: 'Funciones de Servicios Públicos', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'agrupacion-profesional-servicios-publicos-carm', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=agrupacion_profesional_servicios_publicos_carm&return_to=/agrupacion-profesional-servicios-publicos-carm/temario"
