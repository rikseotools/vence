// app/enfermero-sacyl/temario/[slug]/TopicContentView.tsx
// Enfermero SACYL: 2 bloques (Parte General T1-9 / Parte Específica T10-54)
'use client'
...
// 2 bloques: Parte General (1-9), Parte Específica (10-54)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  if (topicNumber >= 10 && topicNumber <= 54) {
    return { block: 'Parte Específica', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'enfermero-sacyl', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=enfermero_sacyl&return_to=/enfermero-sacyl/temario"
