// app/administrativo-diputacion-valencia/temario/[slug]/TopicContentView.tsx
...
// Determinar el bloque segun el numero de tema (Administrativo Diputación de Valencia C1)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 16 && topicNumber <= 40) {
    return { block: 'Bloque II', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'administrativo-diputacion-valencia', updatedAt }: TopicContentViewProps) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <Link
                  href="/login?oposicion=auxiliar_administrativo_valencia&return_to=/administrativo-diputacion-valencia/temario"
