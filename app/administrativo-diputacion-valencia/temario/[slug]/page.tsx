// app/administrativo-diputacion-valencia/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-diputacion-valencia', topicNumber)
  ...
  return {
    title: `${content.title} | Administrativo Diputación de Valencia C1-01`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Administrativo Diputación de Valencia C1-01`,
    openGraph: {
      title: `${content.title} | Administrativo Diputación de Valencia C1-01`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/administrativo-diputacion-valencia/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/administrativo-diputacion-valencia/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-diputacion-valencia" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
