// app/administrativa-universidad-de-murcia/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativa-universidad-de-murcia', topicNumber)
  ...
  return {
    title: `${content.title} | Administrativa - Universidad de Murcia`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Administrativa - Universidad de Murcia`,
    openGraph: {
      title: `${content.title} | Administrativa - Universidad de Murcia`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/administrativa-universidad-de-murcia/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/administrativa-universidad-de-murcia/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativa-universidad-de-murcia" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
