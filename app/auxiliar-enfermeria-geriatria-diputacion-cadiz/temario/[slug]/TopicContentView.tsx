// app/auxiliar-enfermeria-geriatria-diputacion-cadiz/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Aux. Enfermería Geriatría Dip. Cádiz (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 9 && topicNumber <= 25) {
    return { block: 'Materias Específicas', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-enfermeria-geriatria-diputacion-cadiz', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_enfermeria_geriatria_diputacion_cadiz&return_to=/auxiliar-enfermeria-geriatria-diputacion-cadiz/temario"
