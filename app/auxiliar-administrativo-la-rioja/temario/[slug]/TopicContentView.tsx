// app/auxiliar-administrativo-la-rioja/temario/[slug]/TopicContentView.tsx
// Reuses the shared TopicContentView pattern with La Rioja-specific block ranges
'use client'
...
// Determinar el bloque segun el numero de tema (Auxiliar Administrativo La Rioja)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 22 && topicNumber <= 23) {
    return { block: 'Informatica', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-la-rioja', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_la_rioja&return_to=/auxiliar-administrativo-la-rioja/temario"
