// app/auxiliar-administrativo-la-rioja/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('auxiliar-administrativo-la-rioja', topicNumber)
  ...
  return {
    title: `${content.title} | Auxiliar Administrativo Gobierno de La Rioja`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Auxiliar Administrativo del Gobierno de La Rioja`,
    openGraph: {
      title: `${content.title} | Auxiliar Administrativo Gobierno de La Rioja`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/auxiliar-administrativo-la-rioja/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/auxiliar-administrativo-la-rioja/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="auxiliar-administrativo-la-rioja" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
