// app/auxiliar-administrativo-ayuntamiento-sevilla/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Auxiliar Administrativo del Ayuntamiento de Sevilla)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 18) {
    return { block: 'Parte I: Organización pública y Derecho administrativo', displayNum: topicNumber }
  } else if (topicNumber >= 19 && topicNumber <= 26) {
    return { block: 'Parte II: Ofimática', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-ayuntamiento-sevilla', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_ayuntamiento_sevilla&return_to=/auxiliar-administrativo-ayuntamiento-sevilla/temario"
