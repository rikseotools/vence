// app/auxiliar-administrativo-diputacion-alicante/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Auxiliar Administrativo de la Diputación Provincial de Alicante)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 18) {
    return { block: 'Materias jurídico-administrativas', displayNum: topicNumber }
  } else if (topicNumber >= 19 && topicNumber <= 20) {
    return { block: 'Ofimática', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-diputacion-alicante', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_diputacion_alicante&return_to=/auxiliar-administrativo-diputacion-alicante/temario"
