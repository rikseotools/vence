// app/tecnico-auxiliar-universidad-de-murcia/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Técnico Auxiliar (Auxiliar de Servicios) de la Universidad de Murcia)
...
export default function TopicContentView({ content, oposicion = 'tecnico-auxiliar-universidad-de-murcia', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=tecnico_auxiliar_universidad_de_murcia&return_to=/tecnico-auxiliar-universidad-de-murcia/temario"
