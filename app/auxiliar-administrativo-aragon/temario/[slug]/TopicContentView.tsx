// app/auxiliar-administrativo-aragon/temario/[slug]/TopicContentView.tsx
// Reuses the CyL TopicContentView with Aragon-specific block ranges
'use client'
...
// Determinar el bloque segun el numero de tema (Auxiliar Administrativo Aragon)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 16 && topicNumber <= 20) {
    return { block: 'Materias Especificas', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-aragon', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_aragon&return_to=/auxiliar-administrativo-aragon/temario"
