...
function TestPersonalizadoContent({ params }: ContentProps) {
  ...
  useEffect(() => {
    async function resolveParams() {
      ...
      if (process.env.NODE_ENV === 'development') {
        console.log('🎯 Test personalizado Aux. Aragon tema:', tema)
  ...
  if (isNaN(temaNumber) || temaNumber < 1 || temaNumber > 20) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber} no es valido para Auxiliar Administrativo de Aragon. Debe ser del 1 al 20.
          </p>
          <a
  ...
  return (
    <TestPageWrapper
      ...
      customSubtitle=""
      customIcon="✨"
      customColor="from-yellow-500 to-yellow-600"
      positionType="auxiliar_administrativo_aragon"
