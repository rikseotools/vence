// app/auxiliar-administrativo-scs-canarias/temario/[slug]/TopicContentView.tsx
...
// Determinar el bloque segun el numero de tema (Auxiliar Administrativo del Servicio Canario de la Salud (SCS))
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 20) {
    return { block: 'Materias jurídicas, sanitarias y de personal', displayNum: topicNumber }
  } else if (topicNumber >= 21 && topicNumber <= 22) {
    return { block: 'Ofimática y herramientas informáticas', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-scs-canarias', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_scs_canarias&return_to=/auxiliar-administrativo-scs-canarias/temario"
