// app/enfermero-ics/temario/[slug]/TopicContentView.tsx
// Enfermero ICS: 2 bloques (Transversal T1-11 / Específico T12-19)
'use client'
...
export default function TopicContentView({ content, oposicion = 'enfermero-ics', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=enfermero_ics&return_to=/enfermero-ics/temario"
