// app/auxiliar-administrativo-canarias/test/tema/[numero]/test-examen/page.tsx
'use client'
...
function TestExamenContent({ params }: ContentProps) {
  ...
  useEffect(() => {
    async function resolveParams() {
      ...
      if (process.env.NODE_ENV === 'development') {
        console.log('📝 Test examen Aux. Canarias tema:', tema)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <a
            href={`/auxiliar-administrativo-canarias/test/tema/${temaNumber}`}
  ...
  if (isNaN(temaNumber) || temaNumber < 1 || temaNumber > 40) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          <div className="text-6xl mb-4">❌</div>
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber} no es valido para Auxiliar Administrativo Gobierno de Canarias.
          </p>
          <a
