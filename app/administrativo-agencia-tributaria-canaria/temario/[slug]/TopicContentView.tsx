// app/administrativo-agencia-tributaria-canaria/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Agentes Tributos Canarias (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 15) {
    return { block: 'Bloque I: Derecho Constitucional, Europeo, Administrativo y de Canarias', displayNum: topicNumber }
  } else if (topicNumber >= 201 && topicNumber <= 225) {
    return { block: 'Bloque II: Derecho Tributario', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'administrativo-agencia-tributaria-canaria', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=administrativo_agencia_tributaria_canaria&return_to=/administrativo-agencia-tributaria-canaria/temario"
