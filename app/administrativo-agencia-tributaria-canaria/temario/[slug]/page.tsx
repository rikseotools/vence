// app/administrativo-agencia-tributaria-canaria/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-agencia-tributaria-canaria', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Agentes de Tributos - Agencia Tributaria Canaria`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Agentes de Tributos - Agencia Tributaria Canaria`,
    openGraph: {
      title: `${content.title} | Cuerpo Agentes de Tributos - Agencia Tributaria Canaria`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/administrativo-agencia-tributaria-canaria/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/administrativo-agencia-tributaria-canaria/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-agencia-tributaria-canaria" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
