// app/celador-sescam-clm/temario/[slug]/TopicContentView.tsx
// Celador SESCAM Castilla-La Mancha: 1 bloque, temas 1-14
'use client'
...
// Celador SESCAM Castilla-La Mancha: 1 solo bloque, temas 1-14
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 9 && topicNumber <= 17) {
    return { block: 'Parte Específica', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'celador-sescam-clm', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=celador_sescam_clm&return_to=/celador-sescam-clm/temario"
