...
export function oposicionToCcaa(opoSlug: string): string | null {
  const map: Record<string, string> = {
    'agente-hacienda': 'estado',
    'auxiliar-enfermeria-geriatria-diputacion-cadiz': 'andalucia',
    'auxiliar-clinica-diputacion-sevilla': 'andalucia',
    ...
    'auxiliar-administrativo-universidad-almeria': 'andalucia',
    ...
    'cuidador-diputacion-cordoba': 'andalucia',
    'auxiliar-administrativo-ayuntamiento-cordoba': 'andalucia',
    ...
    'administrativo-universidad-leon': 'castilla-y-leon',
    'auxiliar-administrativo-diputacion-zamora': 'castilla-y-leon',
    'auxiliar-administrativo-diputacion-leon': 'castilla-y-leon',
    'auxiliar-administrativo-diputacion-avila': 'castilla-y-leon',
    'auxiliar-administrativo-diputacion-segovia': 'castilla-y-leon',
    'auxiliar-administrativo-clm': 'castilla-la-mancha',
    'administrativo-castilla-la-mancha': 'castilla-la-mancha',
    ...
    'administrativo-asturias': 'asturias',
    ...
    'enfermero-scs-canarias': 'canarias',
