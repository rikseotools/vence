// app/auxiliar-administrativo-extremadura/test/test-aleatorio-examen/page.tsx
'use client'
...
const POSITION_TYPE = slugToPositionType('auxiliar-administrativo-extremadura')

// Obtener nombres de temas desde la configuracion
const config = OPOSICION_BLOCKS_CONFIG['auxiliar-administrativo-extremadura']
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <a
            href="/auxiliar-administrativo-extremadura/test/aleatorio"
...
export default function TestAleatorioExamenExtremaduraPage() {
  return (
    <Suspense
      fallback={
