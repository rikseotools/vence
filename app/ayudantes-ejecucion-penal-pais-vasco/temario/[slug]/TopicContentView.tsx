// app/ayudantes-ejecucion-penal-pais-vasco/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Ayudantes en Ejecución Penal ULE)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  // Ayudantes Ejecución Penal Euskadi: Parte general (1-25) + Parte específica (101-128, displayNumber 1-28).
  if (topicNumber >= 1 && topicNumber <= 25) {
    return { block: 'Parte general', displayNum: topicNumber }
  } else if (topicNumber >= 101 && topicNumber <= 128) {
    return { block: 'Parte específica', displayNum: topicNumber - 100 }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'ayudantes-ejecucion-penal-pais-vasco', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=ayudantes_ejecucion_penal_pais_vasco&return_to=/ayudantes-ejecucion-penal-pais-vasco/temario"
