// app/agente-hacienda/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('agente-hacienda', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Agente de la Hacienda Pública`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Agente de la Hacienda Pública`,
    openGraph: {
      title: `${content.title} | Cuerpo Agente de la Hacienda Pública`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/agente-hacienda/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/agente-hacienda/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="agente-hacienda" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
