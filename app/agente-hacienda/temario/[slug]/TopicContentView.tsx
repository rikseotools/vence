// app/agente-hacienda/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Agente de Hacienda (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 13 && topicNumber <= 32) {
    return { block: 'Materias Específicas (Hacienda Pública y Derecho Tributario)', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'agente-hacienda', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=agente_hacienda&return_to=/agente-hacienda/temario"
