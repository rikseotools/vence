// app/enfermero-sas-andalucia/temario/[slug]/TopicContentView.tsx
// Enfermero SAS Andalucía: 2 bloques (Común T1-10 / Específico T11-79)
'use client'
...
// 2 bloques: Común (1-10), Específico (11-79)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  if (topicNumber >= 11 && topicNumber <= 79) {
    return { block: 'Temario Específico', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'enfermero-sas-andalucia', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=enfermero_sas_andalucia&return_to=/enfermero-sas-andalucia/temario"
