// app/auxiliar-administrativo-pais-vasco/temario/[slug]/TopicContentView.tsx
// Reuses the CyL TopicContentView with País Vasco-specific block ranges
'use client'
...
// Determinar el bloque segun el numero de tema (Auxiliar Administrativo País Vasco)
// Bloque único 1-13 (Cuerpo Auxiliar Eusko Jaurlaritza, en elaboración)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 13) {
    return { block: 'Temario General', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-pais-vasco', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_pais_vasco&return_to=/auxiliar-administrativo-pais-vasco/temario"
