// app/tcae-sescam/temario/[slug]/TopicContentView.tsx
// TCAE SESCAM: Bloque I común 1-5 + Bloque II específico 6-30 (numeración secuencial)
'use client'
...
// Determinar el bloque según el número de tema (TCAE SESCAM)
// Bloque I (Común): temas 1-5
// Bloque II (Específico): temas 6-30
...
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 6 && topicNumber <= 30) {
    return { block: 'Temario Específico', displayNum: topicNumber }
  }
  return { block: 'Temario', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'tcae-sescam', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=tcae_sescam&return_to=/tcae-sescam/temario"
