// app/administrativo-pais-vasco/temario/[slug]/TopicContentView.tsx
...
// Determinar el bloque segun el numero de tema (Administrativo País Vasco)
// Bloque único 1-13 (Cuerpo Administrativo Eusko Jaurlaritza, en elaboración)
...
export default function TopicContentView({ content, oposicion = 'administrativo-pais-vasco', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=administrativo_pais_vasco&return_to=/administrativo-pais-vasco/temario"
