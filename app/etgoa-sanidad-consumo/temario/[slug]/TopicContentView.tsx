// app/etgoa-sanidad-consumo/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (ETGOA Sanidad y Consumo)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  // ETGOA: Parte común (topic_number 1-20) + Área de Consumo (topic_number 101-200, displayNumber 1-100).
  if (topicNumber >= 1 && topicNumber <= 20) {
    return { block: 'Parte común', displayNum: topicNumber }
  } else if (topicNumber >= 101 && topicNumber <= 200) {
    return { block: 'Área de Consumo', displayNum: topicNumber - 100 }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'etgoa-sanidad-consumo', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=etgoa_sanidad_consumo&return_to=/etgoa-sanidad-consumo/temario"
