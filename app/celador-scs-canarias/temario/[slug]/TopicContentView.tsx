// app/celador-scs-canarias/temario/[slug]/TopicContentView.tsx
// Celador SCS Canarias: 1 bloque, temas 1-14
'use client'
...
const topicVideoCourses: Record<number, {
  ...
  // Celador SCS Canarias no tiene cursos de video específicos aún
}
...
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 14) {
    return { block: 'Temario Oficial', displayNum: topicNumber }
  }
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <Link
                  href="/login?oposicion=celador_scs_canarias&return_to=/celador-scs-canarias/temario"
