// app/ayudante-instituciones-penitenciarias/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('ayudante-instituciones-penitenciarias', topicNumber)
  ...
  return {
    title: `${content.title} | Ayudante de Instituciones Penitenciarias`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Ayudante de Instituciones Penitenciarias`,
    openGraph: {
      title: `${content.title} | Ayudante de Instituciones Penitenciarias`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/ayudante-instituciones-penitenciarias/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/ayudante-instituciones-penitenciarias/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="ayudante-instituciones-penitenciarias" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
