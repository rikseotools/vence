// app/administrativo-junta-general-asturias/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-junta-general-asturias', topicNumber)
  ...
  return {
    title: `${content.title} | Administrativo de la Junta General del Principado de Asturias`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Administrativo de la Junta General del Principado de Asturias`,
    openGraph: {
      title: `${content.title} | Administrativo de la Junta General del Principado de Asturias`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/administrativo-junta-general-asturias/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/administrativo-junta-general-asturias/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-junta-general-asturias" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
