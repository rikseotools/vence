// app/auxiliar-administrativo-galicia/temario/[slug]/TopicContentView.tsx
...
// Determinar la parte segun el numero de tema (Auxiliar Administrativo Xunta de Galicia)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 14 && topicNumber <= 17) {
    return { block: 'Parte Especifica', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-galicia', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_galicia&return_to=/auxiliar-administrativo-galicia/temario"
