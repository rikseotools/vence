// app/auxiliar-administrativo-galicia/test/tema/[numero]/test-personalizado/page.tsx
'use client'
...
function TestPersonalizadoContent({ params }: ContentProps) {
  ...
  useEffect(() => {
    async function resolveParams() {
      ...
      if (process.env.NODE_ENV === 'development') {
        console.log('\ud83c\udfaf Test personalizado Aux. Galicia tema:', tema)
  ...
  if (isNaN(temaNumber) || temaNumber < 1 || temaNumber > 17) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber} no es valido para Auxiliar Administrativo Xunta de Galicia. Debe ser del 1 al 17.
          </p>
          <a
  ...
  return (
    ...
    <TestPageWrapper
      ...
      customTitle={`Test Personalizado - Tema ${temaNumber}${parteInfo}`}
