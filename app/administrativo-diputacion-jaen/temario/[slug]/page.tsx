// app/administrativo-diputacion-jaen/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-diputacion-jaen', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Administrativo Diputación de Jaén`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Administrativo Diputación de Jaén`,
    openGraph: {
      title: `${content.title} | Cuerpo Administrativo Diputación de Jaén`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/administrativo-diputacion-jaen/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/administrativo-diputacion-jaen/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-diputacion-jaen" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
