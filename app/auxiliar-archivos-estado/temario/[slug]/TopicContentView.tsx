// app/auxiliar-archivos-estado/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Auxiliar de Archivos (Estado) (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 101 && topicNumber <= 107) {
    return { block: 'Historia cultural', displayNum: topicNumber - 100 }
  } else if (topicNumber >= 201 && topicNumber <= 227) {
    return { block: 'Archivística (parte específica)', displayNum: topicNumber - 200 }
...
export default function TopicContentView({ content, oposicion = 'auxiliar-archivos-estado', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_archivos_estado&return_to=/auxiliar-archivos-estado/temario"
