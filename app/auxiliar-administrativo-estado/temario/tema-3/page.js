// app/auxiliar-administrativo-estado/temario/tema-3/page.js - TEMA 3: LAS CORTES GENERALES
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <a href="/auxiliar-administrativo-estado" className="hover:text-blue-600 transition-colors">
              Auxiliar Administrativo del Estado
            </a>
            <span>›</span>
            <a href="/auxiliar-administrativo-estado/temario" className="hover:text-blue-600 transition-colors">
              Temario
            </a>
            <span>›</span>
