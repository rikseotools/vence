// app/auxiliar-administrativo-estado/temario/tema-1/page.js
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.ilovetest.pro/auxiliar-administrativo-estado/temario/tema-1',
  ...
  alternates: {
    canonical: 'https://www.ilovetest.pro/auxiliar-administrativo-estado/temario/tema-1',
  },
  robots: {
    index: true,
    follow: true,
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://www.ilovetest.pro/auxiliar-administrativo-estado/temario/tema-1"
    }
  ]
};
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <section className="mt-16 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link href="/auxiliar-administrativo-estado/temario" 
              ...
              <Link href="/auxiliar-administrativo-estado/test/tema/1" 
              ...
              <Link href="/auxiliar-administrativo-estado/temario/tema-2" 
                    className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
