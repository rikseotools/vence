...
export default function TestAleatorioPage() {
  ...
  const themeBlocks = [
    ...
    },
    {
      ...
      themes: [
        ...
        { id: 106, name: "Tema 6: Sistema operativo Windows 11" },
        { id: 107, name: "Tema 7: Explorador de Windows 11" },
  ...
  // ✅ Usa API Layer con Drizzle + Zod para mejor rendimiento
  const checkAvailableQuestions = async () => {
    ...
    try {
      ...
      if (!result.success) {
        // Fallback estimado si hay error
