// app/administrativo-extremadura/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-extremadura', topicNumber)
  ...
  return {
    title: `${content.title} | Administrativo Junta de Extremadura`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Administrativo Junta de Extremadura`,
    openGraph: {
      title: `${content.title} | Administrativo Junta de Extremadura`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/administrativo-extremadura/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/administrativo-extremadura/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-extremadura" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
