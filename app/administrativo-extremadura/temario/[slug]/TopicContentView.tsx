// app/administrativo-extremadura/temario/[slug]/TopicContentView.tsx
...
// Determinar el bloque segun el numero de tema (Administrativo Extremadura)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 13) {
    return { block: 'Organizacion y Empleo Publico de Extremadura', displayNum: topicNumber }
  } else if (topicNumber >= 14 && topicNumber <= 30) {
    return { block: 'Derecho Administrativo, Contratacion y Hacienda', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'administrativo-extremadura', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=administrativo_extremadura&return_to=/administrativo-extremadura/temario"
