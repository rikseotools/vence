// app/auxiliar-administrativo-cantabria/temario/[slug]/TopicContentView.tsx
// Reuses the CyL TopicContentView with Cantabria-specific block ranges
'use client'
...
// Determinar el bloque segun el numero de tema (Auxiliar Administrativo Cantabria)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 18) {
...
export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-cantabria', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_cantabria&return_to=/auxiliar-administrativo-cantabria/temario"
