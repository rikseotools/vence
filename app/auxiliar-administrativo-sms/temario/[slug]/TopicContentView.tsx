// app/auxiliar-administrativo-sms/temario/[slug]/TopicContentView.tsx
// Bloques SMS: Parte general (1-6) / Parte especifica (7-24)
'use client'
...
// Determinar el bloque segun el numero de tema (Auxiliar Administrativo SMS)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 7 && topicNumber <= 24) {
    return { block: 'Parte especifica', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-sms', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_sms&return_to=/auxiliar-administrativo-sms/temario"
