...
export const metadata: Metadata = {
  ...
  keywords: ['test auxiliar administrativo salamanca', 'oposiciones salamanca', 'examen auxiliar administrativo salamanca', 'test oposiciones C2 salamanca'],
  openGraph: {
    title: 'Tests Cuerpo Auxiliar Administrativo Salamanca - Practica por Temas',
    description: 'Prepara tu oposición de Cuerpo Auxiliar Administrativo Salamanca con tests organizados por temas. 27 temas oficiales del Ayuntamiento de Salamanca.',
    type: 'website',
  },
}
