// app/auxiliar-administrativo-ayuntamiento-salamanca/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('auxiliar-administrativo-ayuntamiento-salamanca', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Auxiliar Administrativo Salamanca`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Auxiliar Administrativo Salamanca`,
    openGraph: {
      title: `${content.title} | Cuerpo Auxiliar Administrativo Salamanca`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/auxiliar-administrativo-ayuntamiento-salamanca/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/auxiliar-administrativo-ayuntamiento-salamanca/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="auxiliar-administrativo-ayuntamiento-salamanca" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
