// app/debug/notifications/page.js - PÁGINA DEDICADA PARA TESTING DE NOTIFICACIONES
'use client'
...
export default function NotificationsDebugPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-red-600">404 - No encontrado</h1>
          <p className="text-gray-600">Esta página solo está disponible en desarrollo.</p>
        </div>
      </div>
    )
  }
  ...
  const testNotifications = {
    ...
    problematic_articles_ce: {
      id: 'test-problematic-articles-ce',
      type: 'problematic_articles',
      title: '📉 Artículos Problemáticos CE Detectados',
      message: 'Hemos detectado 3 artículos de la Constitución Española donde tienes más errores: Art. 14, 20, 47.',
      timestamp: new Date().toISOString(),
      isRead: false,
      law_short_name: 'CE',
      ...
      articlesCount: 3,
      articlesList: [
        { article_number: 14, error_rate: 80 },
        { article_number: 20, error_rate: 75 },
        { article_number: 47, error_rate: 70 }
      ]
    },
    
    problematic_articles_ley40: {
      id: 'test-problematic-articles-ley40',
      type: 'problematic_articles',
      title: '📉 Artículos Problemáticos Ley 40/2015 Detectados',
      message: 'Hemos detectado 3 artículos de la Ley 40/2015 donde tienes más errores: Art. 3, 8, 15.',
      timestamp: new Date().toISOString(),
      isRead: false,
      law_short_name: 'Ley 40/2015',
      law_full_name: 'Ley 40/2015 del Régimen Jurídico del Sector Público',
      articlesCount: 3,
      articlesList: [
        { article_number: 3, error_rate: 85 },
        { article_number: 8, error_rate: 78 },
        { article_number: 15, error_rate: 72 }
      ]
    },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            🧪 Notifications Debug Center
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Panel completo para testing y debugging del sistema de notificaciones
          </p>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 text-xs rounded border transition-colors ${
                          config.bgColor || 'bg-gray-50 dark:bg-gray-700'
                        } ${config.borderColor || 'border-gray-200 dark:border-gray-600'} hover:opacity-80`}
                      >
              ...
              <div className="space-y-2">
                <button
                  onClick={clearAll}
                  className="w-full px-4 py-2 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 rounded hover:bg-red-200 dark:hover:bg-red-800 transition-colors"
                >
                  🧹 Limpiar Todo
                </button>
              </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 mt-2 text-xs text-gray-500">
                            ...
                            <span>Prioridad: {notification.priority || 'N/A'}</span>
                          </div>
                        </div>
