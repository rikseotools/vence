...
export default function BatchDebugPage() {
  ...
  const currentBatch = {
    name: "Series de Letras - Preguntas 92-100 (9 preguntas)",
    startNumber: 92,
    questionIds: [
      '7b29a24f-7a14-42e5-9474-60a7bdb798be',   // P92: Error detection y, t, q, m, j, f, b
      'a5693d75-6406-4408-804a-f73bcc2191f3',   // P93: Series constante b, d, f, h, j, l, n, p, ?
      '0ba56886-e6c3-4f83-bc22-3a48388ecb2e',   // P94: Multiple letters h, i, j, n, ñ, o, s, t, u, ?, ?, ?
      '50f40e03-5250-49bd-892f-953f39290f67',   // P95: Block series N O Ñ - Q S R - U W V - Y A Z - ?
      'a968d093-1955-45fa-be97-2637a168e510',   // P96: Simple series v - p - k - e - y - ?
      'fcc8cc77-92c9-41b6-92f5-a17bc46d2851',   // P97: Correlative series A, C, F, H, K, M, ?
      '6c992bae-ce11-494a-a70f-b97985a84afc',   // P98: Complex correlative S, T, U, V, Z, A, B, F, G, ?
      '0193f486-e438-49b3-9538-3fb4472b0e0e',   // P99: Completion series c, x, e, v, h, s, l, o, [ ], k
      '53020915-1ffe-4e2c-9a4e-181824d1a6b6'    // P100: Cyclic series F, T, F, S, G, R, G, Q, H, P, H, O, ?
    ]
  }
