// app/auxiliar-clinica-diputacion-sevilla/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Auxiliar de Clínica Dip. Sevilla (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 4) {
    ...
    return { block: 'Materias Específicas (atención sociosanitaria residencial)', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-clinica-diputacion-sevilla', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_clinica_diputacion_sevilla&return_to=/auxiliar-clinica-diputacion-sevilla/temario"
