// app/oficial-de-gestion-parlamento-de-andalucia/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Oficial de Gestión Parlamento Andalucía (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 16) {
    return { block: 'Bloque I. Materia General del Estado', displayNum: topicNumber }
  } else if (topicNumber >= 17 && topicNumber <= 44) {
    return { block: 'Bloque II. Andalucía y el Parlamento', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'oficial-de-gestion-parlamento-de-andalucia', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=oficial_de_gestion_parlamento_de_andalucia&return_to=/oficial-de-gestion-parlamento-de-andalucia/temario"
