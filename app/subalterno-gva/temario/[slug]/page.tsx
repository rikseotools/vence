// app/subalterno-gva/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('subalterno-gva', topicNumber)
  ...
  return {
    title: `${content.title} | Subalterno/a de la Generalitat Valenciana`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Subalterno/a de la Generalitat Valenciana`,
    openGraph: {
      title: `${content.title} | Subalterno/a de la Generalitat Valenciana`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/subalterno-gva/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/subalterno-gva/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="subalterno-gva" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
