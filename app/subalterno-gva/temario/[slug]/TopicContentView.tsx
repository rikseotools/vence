// app/subalterno-gva/temario/[slug]/TopicContentView.tsx
...
// Determinar el bloque segun el numero de tema (Subalterno/a de la Generalitat Valenciana)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 8 && topicNumber <= 15) {
    return { block: 'Materias Especificas', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'subalterno-gva', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=subalterno_gva&return_to=/subalterno-gva/temario"
