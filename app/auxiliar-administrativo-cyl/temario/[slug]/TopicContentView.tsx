// app/auxiliar-administrativo-cyl/temario/[slug]/TopicContentView.tsx
'use client'
...
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 20 && topicNumber <= 28) {
    return { block: 'Grupo II', displayNum: topicNumber }
  }
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_cyl&return_to=/auxiliar-administrativo-cyl/temario"
