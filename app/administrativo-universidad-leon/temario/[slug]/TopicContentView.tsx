// app/administrativo-universidad-leon/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Escala Administrativa ULE)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  // Escala Administrativa ULE: 25 temas en 5 bloques, numeración 1-25 continua.
  if (topicNumber >= 1 && topicNumber <= 5) {
    return { block: 'Bloque 1', displayNum: topicNumber }
  } else if (topicNumber >= 6 && topicNumber <= 11) {
    return { block: 'Bloque 2', displayNum: topicNumber }
  } else if (topicNumber >= 12 && topicNumber <= 15) {
    return { block: 'Bloque 3', displayNum: topicNumber }
  } else if (topicNumber >= 16 && topicNumber <= 21) {
    return { block: 'Bloque 4', displayNum: topicNumber }
  } else if (topicNumber >= 22 && topicNumber <= 25) {
    return { block: 'Bloque 5', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'administrativo-universidad-leon', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=administrativo_universidad_leon&return_to=/administrativo-universidad-leon/temario"
