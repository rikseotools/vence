// app/auxiliar-administrativo-ayuntamiento-marbella/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('auxiliar-administrativo-ayuntamiento-marbella', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Auxiliar Administrativo Marbella`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Auxiliar Administrativo Marbella`,
    openGraph: {
      title: `${content.title} | Cuerpo Auxiliar Administrativo Marbella`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/auxiliar-administrativo-ayuntamiento-marbella/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/auxiliar-administrativo-ayuntamiento-marbella/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="auxiliar-administrativo-ayuntamiento-marbella" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
