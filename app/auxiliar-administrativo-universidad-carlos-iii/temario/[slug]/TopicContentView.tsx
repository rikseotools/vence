// app/auxiliar-administrativo-universidad-carlos-iii/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Auxiliar Administrativo de la Universidad Carlos III de Madrid)
...
export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-universidad-carlos-iii', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_universidad_carlos_iii&return_to=/auxiliar-administrativo-universidad-carlos-iii/temario"
