// app/correos-personal-operativo/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Personal Operativo de Correos)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 6) {
    return { block: 'Bloque I: La Empresa y sus Productos', displayNum: topicNumber }
  } else if (topicNumber >= 7 && topicNumber <= 12) {
    return { block: 'Bloque II: Operaciones y Normativa', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'correos-personal-operativo', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=correos_personal_operativo&return_to=/correos-personal-operativo/temario"
