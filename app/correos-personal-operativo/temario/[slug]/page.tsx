// app/correos-personal-operativo/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('correos-personal-operativo', topicNumber)
  ...
  return {
    title: `${content.title} | Personal Operativo de Correos`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Personal Operativo de Correos`,
    openGraph: {
      title: `${content.title} | Personal Operativo de Correos`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/correos-personal-operativo/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/correos-personal-operativo/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="correos-personal-operativo" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
