// app/policia-nacional/temario/[slug]/page.tsx
...
export async function generateStaticParams() {
  // Policía Nacional tiene 45 temas
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('policia-nacional', topicNumber)
  ...
  return {
    title: `${content.title} | Policía Nacional`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Policía Nacional`,
    openGraph: {
      title: `${content.title} | Policía Nacional`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/policia-nacional/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/policia-nacional/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="policia-nacional" />
    </div>
  )
}
