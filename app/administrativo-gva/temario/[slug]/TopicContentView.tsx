// app/administrativo-gva/temario/[slug]/TopicContentView.tsx
...
// Determinar el bloque segun el numero de tema (Administrativo Generalitat Valenciana C1-01)
...
export default function TopicContentView({ content, oposicion = 'administrativo-gva', updatedAt }: TopicContentViewProps) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <Link
                  href="/login?oposicion=auxiliar_administrativo_valencia&return_to=/administrativo-gva/temario"
