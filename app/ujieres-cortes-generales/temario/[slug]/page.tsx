// app/ujieres-cortes-generales/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('ujieres-cortes-generales', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Cuerpo de Ujieres de las Cortes Generales`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Cuerpo de Ujieres de las Cortes Generales`,
    openGraph: {
      title: `${content.title} | Cuerpo Cuerpo de Ujieres de las Cortes Generales`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/ujieres-cortes-generales/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/ujieres-cortes-generales/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="ujieres-cortes-generales" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
