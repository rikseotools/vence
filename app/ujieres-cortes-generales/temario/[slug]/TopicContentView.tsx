// app/ujieres-cortes-generales/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Ujieres Cortes Generales (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 17) {
    return { block: 'Programa oficial (Anexo I)', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'ujieres-cortes-generales', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=ujieres_cortes_generales&return_to=/ujieres-cortes-generales/temario"
