// app/auxilio-judicial/temario/[slug]/TopicContentView.tsx
'use client'
...
// Mapping de temas a cursos de video (auxilio judicial comparte informática con tramitación)
...
// Determinar el bloque según el número de tema (auxilio judicial)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 16 && topicNumber <= 26) {
    return { block: 'Bloque III', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxilio-judicial', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxilio_judicial&return_to=/auxilio-judicial/temario"
