// app/enfermero-scs-canarias/temario/[slug]/TopicContentView.tsx
// Enfermero SCS Canarias: 2 bloques (Común T1-7 / Específico T8-50)
'use client'
...
// 2 bloques: Común (1-7), Específico (8-50)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  if (topicNumber >= 8 && topicNumber <= 50) {
    return { block: 'Temario Específico', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'enfermero-scs-canarias', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=enfermero_scs_canarias&return_to=/enfermero-scs-canarias/temario"
