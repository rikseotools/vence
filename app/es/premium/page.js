// app/es/premium/page.js - FLUJO PROFESIONAL OPCIÓN A
'use client'
  ...
  const handleSignupFirst = async () => {
    ...
    try {
      ...
      const { error: authError } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: `${window.location.origin}/auth/callback?return_to=${encodeURIComponent('/es/premium?start_checkout=true')}`,
          queryParams: {
            access_type: 'offline',
            ...
            {!authLoading && !user && (
              <div>
                ...
                <div className="text-center mt-6 pt-4 border-t border-gray-200">
                  ...
                  <a
                    href="/es/login?return_to=/es/premium"
