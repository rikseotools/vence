// app/es/teoria/[law]/[articleNumber]/page.js - SOLUCIÓN SIMPLE PARA NEXT.JS 15
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <nav className="text-sm text-gray-500">
            <Link href="/es/leyes" className="hover:text-gray-700">
              Leyes
            </Link>
            <span className="mx-2">→</span>
            <Link href={`/es/leyes/${lawSlug}`} className="hover:text-gray-700">
              {article.law.short_name}
            </Link>
            <span className="mx-2">→</span>
        ...
        <div className="flex items-center justify-between gap-2 py-4 mb-6">
          ...
          {previousArticle ? (
            <Link 
              href={`/es/teoria/${lawSlug}/articulo-${previousArticle}`}
          ...
          {nextArticle ? (
            <Link 
              href={`/es/teoria/${lawSlug}/articulo-${nextArticle}`}
              className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
            >
            ...
            <div className="space-y-3">
              {relatedArticles.map((related) => (
                <Link 
                  ...
                  href={`/es/teoria/${related.lawSlug}/articulo-${related.article_number}`}
