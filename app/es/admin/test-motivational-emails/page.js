// app/es/admin/test-motivational-emails/page.js - PÁGINA DE PRUEBAS MOTIVACIONALES
'use client'
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
            <p className="text-blue-800">
              ...
              <strong>Analytics:</strong> <a href="/es/admin/notificaciones/email" className="underline">Ver en panel admin</a>
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li>Ve al <a href="/es/admin/notificaciones/email" className="text-blue-600 underline">panel de analytics</a> para ver los eventos</li>
