// app/es/admin/notificaciones/email/subscripciones/page.js - Página detallada de subscripciones de email
'use client'
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-4">
            ...
            <span>›</span>
            <Link href="/es/admin/notificaciones/email" className="hover:text-blue-600">Email Analytics</Link>
            <span>›</span>
                    ...
                    {filteredUsers.map((user, index) => (
                      <tr key={user.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <Link
                            href={`/es/admin/usuarios/${user.id}/emails`}
