// app/es/admin/notificaciones/email/page.js - PÁGINA DETALLADA DE EMAIL TRACKING
'use client'
        ...
        {!data ? (
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <Link href="/es/admin/notificaciones/email/subscripciones" className="block group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link 
                    href="/es/admin/notificaciones/email/subscripciones"
        ...
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="text-align: center; margin: 35px 0;">
              <a href="https://www.ilovetest.pro/es/auxiliar-administrativo-estado/test" 
          ...
          <div style="background: #f8f9fa; padding: 20px 30px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #666;">
              <a href="https://www.ilovetest.pro/es/perfil?tab=emails" style="color: #ffd700; text-decoration: none;">Gestionar preferencias de notificaciones</a>
            </p>
    ...
    <html>
      ...
      <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="background: #f8f9fa; padding: 20px 30px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #666;">
              <a href="https://www.ilovetest.pro/es/perfil?tab=emails" style="color: #ef4444; text-decoration: none;">Gestionar preferencias de notificaciones</a>
            </p>
            <p style="margin: 5px 0 0 0; font-size: 12px; color: #999;">
              © 2025 ILoveTest. Te ayudamos a conseguir tu plaza.
            </p>
    ...
    <html>
      ...
      <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="background: #f8f9fa; padding: 20px 30px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #666;">
              <a href="https://www.ilovetest.pro/es/perfil?tab=emails" style="color: #667eea; text-decoration: none;">Gestionar preferencias de notificaciones</a>
            </p>
            <p style="margin: 5px 0 0 0; font-size: 12px; color: #999;">
              © 2025 ILoveTest. Te ayudamos a conseguir tu plaza.
            </p>
    ...
    <html>
      ...
      <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="background: #f8f9fa; padding: 20px 30px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin: 0; font-size: 12px; color: #666;">
              <a href="https://www.ilovetest.pro/es/perfil?tab=emails" style="color: #667eea; text-decoration: none;">Gestionar preferencias</a>
            </p>
            <p style="margin: 5px 0 0 0; font-size: 12px; color: #999;">
              © 2025 ILoveTest
            </p>
