// app/es/admin/notificaciones/page.js - PANEL ADMIN DE SEGUIMIENTO DE NOTIFICACIONES
'use client'
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard
          ...
          href="/es/admin/notificaciones/users"
        />
        <StatCard
          title="Push Enviadas"
          ...
          href="/es/admin/notificaciones/push"
        />
        <StatCard
          ...
          href="/es/admin/notificaciones/events"
        />
      </div>
