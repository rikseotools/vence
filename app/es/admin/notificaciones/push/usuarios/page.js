// app/es/admin/notificaciones/push/usuarios/page.js - USUARIOS ACTIVOS DE PUSH
'use client'
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
              <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-2">
                ...
                <span>›</span>
                <Link href="/es/admin/notificaciones/push" className="hover:text-blue-600">Push Notifications</Link>
                <span>›</span>
