// app/es/admin/usuarios/[id]/emails/page.js - Historial de emails de un usuario específico
'use client'
      ...
      <html>
        ...
        <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333;">
          <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
            ...
            <div style="background: #f8f9fa; padding: 20px 30px; text-align: center; border-top: 1px solid #eee;">
              <p style="margin: 0; font-size: 12px; color: #666;">
                <a href="https://www.ilovetest.pro/es/perfil" style="color: #667eea; text-decoration: none;">Gestionar preferencias de notificaciones</a>
              </p>
            </div>
          </div>
        </body>
