// app/es/auxiliar-administrativo-estado/temario/tema-7/page.js
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.ilovetest.pro/es/auxiliar-administrativo-estado/temario/tema-7',
  ...
  alternates: {
    canonical: 'https://www.ilovetest.pro/es/auxiliar-administrativo-estado/temario/tema-7',
  },
  robots: {
    index: true,
    follow: true,
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://www.ilovetest.pro/es/auxiliar-administrativo-estado/temario/tema-7"
    }
  ]
};
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <section className="mt-16 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link href="/es/auxiliar-administrativo-estado/temario/tema-6" 
              ...
              <Link href="/es/auxiliar-administrativo-estado/test/tema/7" 
              ...
              <Link href="/es/auxiliar-administrativo-estado/temario/tema-8" 
                    className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
