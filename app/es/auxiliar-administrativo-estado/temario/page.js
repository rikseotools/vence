                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    {isUnlocked ? (
                      <>
                        <Link 
                          href={`/es/auxiliar-administrativo-estado/temario/tema-${tema.numero}`}
                        ...
                        <Link 
                          href={`/es/auxiliar-administrativo-estado/test/tema/${tema.numero}`}
          ...
          <div className="bg-white rounded-xl max-w-md w-full mx-4 shadow-2xl">
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3 mt-6">
                <Link
                  href={`/es/auxiliar-administrativo-estado/test/tema/${modalTema.numero - 1}`}
                ...
                <Link
                  href={`/es/auxiliar-administrativo-estado/test/tema/${modalTema.numero}`}
