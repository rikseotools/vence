// app/es/auxiliar-administrativo-estado/temario/tema-4/page.js - TEMA 4: EL PODER JUDICIAL
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <a href="/es/auxiliar-administrativo-estado" className="hover:text-amber-600 transition-colors">
              Auxiliar Administrativo del Estado
            </a>
            <span>›</span>
            <a href="/es/auxiliar-administrativo-estado/temario" className="hover:text-amber-600 transition-colors">
              Temario
            </a>
            <span>›</span>
