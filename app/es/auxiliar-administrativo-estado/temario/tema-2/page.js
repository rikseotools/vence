// app/es/auxiliar-administrativo-estado/temario/tema-2/page.js
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <nav className="mb-6">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>›</span>
              <a href="/es/auxiliar-administrativo-estado" className="hover:text-red-600">Auxiliar Administrativo</a>
              <span>›</span>
              <a href="/es/auxiliar-administrativo-estado/temario" className="hover:text-red-600">Temario</a>
              <span>›</span>
