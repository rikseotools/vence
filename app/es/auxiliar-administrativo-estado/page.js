// app/es/auxiliar-administrativo-estado/page.js
...
export const metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/es/auxiliar-administrativo-estado`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  const serviciosPrincipales = [
    {
      ...
      enlace: "/es/auxiliar-administrativo-estado/temario",
      cta: "📚 Ver Temarios",
    ...
    },
    {
      ...
      enlace: "/es/auxiliar-administrativo-estado/test",
      cta: "🎯 Empezar Tests",
