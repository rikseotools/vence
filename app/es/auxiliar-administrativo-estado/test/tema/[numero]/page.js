// app/es/auxiliar-administrativo-estado/test/tema/[numero]/page.js - PÁGINA DINÁMICA MEJORADA
'use client'
...
export default function TemaPage({ params }) {
  ...
  async function handleStartCustomTest(config) {
    ...
    try {
      ...
      const testUrl = `/es/auxiliar-administrativo-estado/test/tema/${temaNumber}/test-personalizado?${params.toString()}`
