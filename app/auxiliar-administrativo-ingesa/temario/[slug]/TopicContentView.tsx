// app/auxiliar-administrativo-ingesa/temario/[slug]/TopicContentView.tsx
...
// Determinar el bloque segun el numero de tema (Auxiliar Administrativo del INGESA (Ceuta y Melilla))
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 16 && topicNumber <= 35) {
    return { block: 'Parte específica', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-ingesa', updatedAt }: TopicContentViewProps) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <Link
                  href="/login?oposicion=auxiliar_administrativo_scs_canarias&return_to=/auxiliar-administrativo-ingesa/temario"
