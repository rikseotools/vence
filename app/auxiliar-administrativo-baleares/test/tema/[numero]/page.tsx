...
export default function TemaBalearesPage({ params }: PageProps) {
  ...
  async function handleStartCustomTest(config: any) {
    ...
    try {
      ...
      const testUrl = `/auxiliar-administrativo-baleares/test/tema/${temaNumber}/${testPath}?${testParams.toString()}`
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber || ''} no existe o no esta disponible para Auxiliar Administrativo de la CAIB.
          </p>
          <Link
      ...
      <div className="max-w-4xl mx-auto px-3 py-6">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block" ref={dropdownRef}>
            <div className="inline-flex items-center px-3 py-1 bg-cyan-100 text-cyan-800 rounded-full text-xs font-medium mb-3">
              <span className="mr-1">🏝️</span>
              <Link href="/auxiliar-administrativo-baleares/test" className="hover:text-cyan-900 transition-colors">
                Aux. Admin. Baleares (C2)
              </Link>
          ...
          <div className="space-y-2">
            ...
            {officialQuestionsCount > 0 && (
              <p className="text-cyan-600 font-medium text-sm md:text-base">
        ...
        <section className="mb-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className={`p-4 rounded-lg ${testMode === 'practica' ? 'bg-cyan-50 border border-cyan-200' : 'bg-cyan-50 border border-cyan-200'}`}>
              <div className="text-sm">
                {testMode === 'practica' ? (
                  <>
                    <span className="font-semibold text-cyan-800">Modo Practica:</span>
                    <span className="text-cyan-700"> Veras una pregunta a la vez con explicacion inmediata.</span>
                  </>
                ) : (
                  <>
                    <span className="font-semibold text-cyan-800">Modo Examen:</span>
                    <span className="text-cyan-700"> Veras todas las preguntas en scroll. Correccion al final.</span>
                  </>
                )}
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="mt-4 pt-3 border-t border-gray-200">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-cyan-600 text-lg">{totalQuestions} preguntas</span>
              </div>
            </div>
          </div>
        )}
