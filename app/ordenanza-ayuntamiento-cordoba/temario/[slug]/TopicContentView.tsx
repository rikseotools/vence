// app/ordenanza-ayuntamiento-cordoba/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Ordenanza del Ayuntamiento de Córdoba)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 4) {
    return { block: 'Temas Generales', displayNum: topicNumber }
  } else if (topicNumber >= 5 && topicNumber <= 10) {
    return { block: 'Temas Específicos', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'ordenanza-ayuntamiento-cordoba', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=ordenanza_ayuntamiento_cordoba&return_to=/ordenanza-ayuntamiento-cordoba/temario"
