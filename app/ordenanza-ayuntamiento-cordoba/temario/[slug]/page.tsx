// app/ordenanza-ayuntamiento-cordoba/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('ordenanza-ayuntamiento-cordoba', topicNumber)
  ...
  return {
    title: `${content.title} | Ordenanza del Ayuntamiento de Córdoba`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Ordenanza del Ayuntamiento de Córdoba`,
    openGraph: {
      title: `${content.title} | Ordenanza del Ayuntamiento de Córdoba`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/ordenanza-ayuntamiento-cordoba/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/ordenanza-ayuntamiento-cordoba/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="ordenanza-ayuntamiento-cordoba" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
