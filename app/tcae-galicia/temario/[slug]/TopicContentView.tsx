...
const topicVideoCourses: Record<number, {
  ...
  // TCAE Osakidetza no tiene cursos de video específicos aún
}
...
export default function TopicContentView({ content, oposicion = 'auxiliar-enfermeria-osakidetza' }: TopicContentViewProps) {
