// app/administrativo-andalucia/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('administrativo-andalucia', topicNumber)
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.vence.es/administrativo-andalucia/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="administrativo-andalucia" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
