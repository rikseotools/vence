...
export const metadata: Metadata = {
  ...
  keywords: ['test administrativo castilla y leon', 'oposiciones cyl', 'examen administrativo cyl', 'test oposiciones C1 castilla y leon'],
  openGraph: {
...
export default function TestsAdministrativoCylPage() {
