// app/celador-sermas-madrid/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('celador-sermas-madrid', topicNumber)
  ...
  return {
    title: `${content.title} | Celador SERMAS Madrid`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Celador SERMAS Madrid`,
    openGraph: {
      title: `${content.title} | Celador SERMAS Madrid`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/celador-sermas-madrid/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/celador-sermas-madrid/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="celador-sermas-madrid" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
