// app/policia-municipal-madrid/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Policía Municipal del Ayuntamiento de Madrid - 3 bloques, 45 temas)
...
export default function TopicContentView({ content, oposicion = 'policia-municipal-madrid', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=policia_municipal_madrid&return_to=/policia-municipal-madrid/temario"
