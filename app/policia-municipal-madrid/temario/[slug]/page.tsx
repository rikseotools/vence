// app/policia-municipal-madrid/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('policia-municipal-madrid', topicNumber)
  ...
  return {
    title: `${content.title} | Policía Municipal del Ayuntamiento de Madrid`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Policía Municipal del Ayuntamiento de Madrid`,
    openGraph: {
      title: `${content.title} | Policía Municipal del Ayuntamiento de Madrid`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/policia-municipal-madrid/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/policia-municipal-madrid/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="policia-municipal-madrid" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
