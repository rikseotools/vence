// app/auxiliar-administrativo-ayuntamiento-granada/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Auxiliar Administrativo de la Ayuntamiento de Granada)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  if (topicNumber >= 6 && topicNumber <= 22) {
    return { block: 'Materias Específicas', displayNum: topicNumber - 5 }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-ayuntamiento-granada', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_ayuntamiento_granada&return_to=/auxiliar-administrativo-ayuntamiento-granada/temario"
