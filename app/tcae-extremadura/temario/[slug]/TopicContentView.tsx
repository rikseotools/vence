// app/tcae-extremadura/temario/[slug]/TopicContentView.tsx
// TCAE SES Extremadura: Bloque I común 1-4 + Bloque II específico 5-30 (numeración secuencial)
'use client'
...
// Determinar el bloque según el número de tema (TCAE SES Extremadura)
// Bloque I (Común): temas 1-4
// Bloque II (Específico): temas 5-30
// Numeración secuencial → displayNum = topicNumber
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 4) {
    return { block: 'Temario Común', displayNum: topicNumber }
  } else if (topicNumber >= 5 && topicNumber <= 30) {
    return { block: 'Temario Específico', displayNum: topicNumber }
  }
  return { block: 'Temario', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'tcae-extremadura', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=tcae_extremadura&return_to=/tcae-extremadura/temario"
