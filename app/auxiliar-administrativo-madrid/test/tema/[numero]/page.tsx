// app/auxiliar-administrativo-madrid/test/tema/[numero]/page.tsx
'use client'
...
export default function TemaMadridPage({ params }: PageProps) {
  ...
  async function handleStartCustomTest(config: any) {
    ...
    try {
      ...
      const testUrl = `/auxiliar-administrativo-madrid/test/tema/${temaNumber}/${testPath}?${testParams.toString()}`
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber || ''} no existe o no está disponible para Auxiliar Administrativo Comunidad de Madrid.
          </p>
          <Link
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block" ref={dropdownRef}>
            <div className="inline-flex items-center px-3 py-1 bg-red-100 text-red-800 rounded-full text-xs font-medium mb-3">
              ...
              <Link href="/auxiliar-administrativo-madrid/test" className="hover:text-red-900 transition-colors">
                Aux. Madrid (C2)
              </Link>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className={`p-4 rounded-lg ${testMode === 'practica' ? 'bg-red-50 border border-red-200' : 'bg-red-50 border border-red-200'}`}>
              <div className="text-sm">
                {testMode === 'practica' ? (
                  <>
                    <span className="font-semibold text-red-800">Modo Práctica:</span>
                    <span className="text-red-700"> Verás una pregunta a la vez con explicación inmediata.</span>
                  </>
                ) : (
                  <>
                    <span className="font-semibold text-red-800">Modo Examen:</span>
                    <span className="text-red-700"> Verás todas las preguntas en scroll. Corrección al final.</span>
                  </>
                )}
              </div>
            </div>
