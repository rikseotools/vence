// app/auxiliar-administrativo-madrid/test/examen-oficial/page.tsx
'use client'
...
function OfficialExamContent() {
  ...
  const oposicion = 'auxiliar-administrativo-madrid'
  ...
  return (
    <OfficialExamLayout
      ...
      config={{
        ...
        backUrl: '/auxiliar-administrativo-madrid/test',
