...
export const metadata = {
  ...
  description: 'Temario oficial BORM de TCAE (Auxiliar de Enfermeria) del SMS. 44 temas en 2 bloques: legislacion sanitaria y cuidados auxiliares de enfermeria. Acceso gratuito.',
  alternates: {
