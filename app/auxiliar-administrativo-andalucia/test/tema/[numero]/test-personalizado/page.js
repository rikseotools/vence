...
function TestPersonalizadoContent({ params }) {
  ...
  if (isNaN(temaNumber) || temaNumber < 1 || temaNumber > 22) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber} no es válido para Auxiliar Administrativo Junta de Andalucía. Debe ser del 1 al 22.
          </p>
          <a
  ...
  return (
    <TestPageWrapper
      ...
      customIcon="✨"
      customColor="from-teal-600 to-teal-700"
      positionType="auxiliar_administrativo_andalucia"
    />
  )
}
