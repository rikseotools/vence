// app/auxiliar-administrativo-carm/test/tema/[numero]/test-personalizado/page.js
'use client'
  ...
  useEffect(() => {
    async function resolveParams() {
      ...
      if (process.env.NODE_ENV === 'development') {
        console.log('🎯 Test personalizado Aux. Admin. CARM tema:', tema)
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber} no es válido para Auxiliar Administrativo CARM. Debe ser del 1 al 16.
          </p>
          <a
