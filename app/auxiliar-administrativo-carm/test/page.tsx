...
export const metadata: Metadata = {
  ...
  description: 'Prepara tu oposición de Auxiliar Administrativo CARM (Murcia) con tests organizados por temas. 21 temas en 3 bloques: Derecho, Gestión Pública e Informática.',
  ...
  openGraph: {
    ...
    description: 'Prepara tu oposición de Auxiliar Administrativo CARM con tests organizados por temas. 21 temas oficiales BORM.',
    type: 'website',
  },
}
