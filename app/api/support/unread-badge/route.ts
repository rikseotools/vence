...
// [T-482] Autentica, así que NO puede servirse de la caché de Next: sin esto el servidor puede
// contestar 200 con el contador de OTRO usuario sin llegar a ejecutar la guarda. Lo cazó el
// guardarraíl `rutaAutenticadaEsDinamica` al fusionar esta rama — en la rama, aislada, no había
// con qué chocar. Lo declaran ya 96 rutas.
