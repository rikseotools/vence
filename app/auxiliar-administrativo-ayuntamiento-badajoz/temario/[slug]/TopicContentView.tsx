// app/auxiliar-administrativo-ayuntamiento-badajoz/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Auxiliar Administrativo Ayuntamiento de Badajoz)
// Bloque I: temario común (temas 1-4) | Bloque II: temario específico (temas 5-20)
...
export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-ayuntamiento-badajoz', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_ayuntamiento_badajoz&return_to=/auxiliar-administrativo-ayuntamiento-badajoz/temario"
