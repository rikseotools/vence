// app/guardia-civil/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('guardia-civil', topicNumber)
  ...
  return {
    title: `${content.title} | Guardia Civil`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Guardia Civil`,
    openGraph: {
      title: `${content.title} | Guardia Civil`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/guardia-civil/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/guardia-civil/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="guardia-civil" />
    </div>
  )
}
