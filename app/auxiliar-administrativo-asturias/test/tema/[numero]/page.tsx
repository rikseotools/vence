// app/auxiliar-administrativo-asturias/test/tema/[numero]/page.tsx
'use client'
...
export default function TemaAsturiasPage({ params }: PageProps) {
  ...
  async function handleStartCustomTest(config: any) {
    ...
    try {
      ...
      const testUrl = `/auxiliar-administrativo-asturias/test/tema/${temaNumber}/${testPath}?${testParams.toString()}`
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber || ''} no existe o no esta disponible para Auxiliar Administrativo Principado de Asturias.
          </p>
          <Link
      ...
      <div className="max-w-4xl mx-auto px-3 py-6">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block" ref={dropdownRef}>
            <div className="inline-flex items-center px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-xs font-medium mb-3">
              <span className="mr-1">⛰️</span>
              <Link href="/auxiliar-administrativo-asturias/test" className="hover:text-indigo-900 transition-colors">
                Aux. Asturias (C2)
              </Link>
        ...
        <section className="mb-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className={`p-4 rounded-lg ${testMode === 'practica' ? 'bg-indigo-50 border border-indigo-200' : 'bg-indigo-50 border border-indigo-200'}`}>
              <div className="text-sm">
                {testMode === 'practica' ? (
                  <>
                    <span className="font-semibold text-indigo-800">Modo Practica:</span>
                    <span className="text-indigo-700"> Veras una pregunta a la vez con explicacion inmediata.</span>
                  </>
                ) : (
                  <>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="mt-4 pt-3 border-t border-gray-200">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-indigo-600 text-lg">{totalQuestions} preguntas</span>
              </div>
            </div>
          </div>
        )}
