// app/enfermero-scs-cantabria/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('enfermero-scs-cantabria', topicNumber)
  ...
  return {
    title: `${content.title} | Enfermero/a SCS Cantabria Cantabria`,
    description: content.description || `Contenido teorico del Tema ${topicNumber} para Enfermero/a SCS Cantabria Cantabria`,
    openGraph: {
      title: `${content.title} | Enfermero/a SCS Cantabria Cantabria`,
      description: content.description || `Contenido teorico del Tema ${topicNumber}`,
      url: `https://www.vence.es/enfermero-scs-cantabria/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/enfermero-scs-cantabria/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="enfermero-scs-cantabria" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
