// app/auxiliar-administrativo-madrid-2027/temario/[slug]/TopicContentView.tsx
...
export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-madrid-2027', updatedAt }: TopicContentViewProps) {
