// app/administrativo-seguridad-social/temario/[slug]/TopicContentView.tsx
// Bloque I General: temas 1-23
// Bloque II Específico SS: temas 101-113 (display 1-13)
'use client'
...
// Determinar la parte segun el numero de tema (Administrativo Seguridad Social C1)
// Bloque I General: topic_number 1-23
// Bloque II Específico SS: topic_number 101-113 con displayNum 1-13
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 23) {
    return { block: 'Bloque I: Temario general', displayNum: topicNumber }
  } else if (topicNumber >= 101 && topicNumber <= 113) {
    return { block: 'Bloque II: Temario específico de Seguridad Social', displayNum: topicNumber - 100 }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'administrativo-seguridad-social', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=administrativo_seguridad_social&return_to=/administrativo-seguridad-social/temario"
