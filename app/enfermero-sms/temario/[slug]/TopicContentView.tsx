// app/enfermero-sms/temario/[slug]/TopicContentView.tsx
// Enfermero SMS Murcia: 2 bloques (Común T1-7 / Específico T8-50)
'use client'
...
// 2 bloques: Común (1-15), Específico (16-71). displayNum = número oficial por bloque.
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  if (topicNumber >= 16 && topicNumber <= 71) {
    return { block: 'Parte Específica', displayNum: topicNumber - 15 }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'enfermero-sms', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=enfermero_sms&return_to=/enfermero-sms/temario"
