  ...
  async function loadExamQuestions() {
    try {
      ...
      for (const mapping of mappings) {
        ...
        // Si article_numbers es null, obtener todas las preguntas de la ley
        ...
        try {
          ...
          // Solo filtrar por articulos si hay especificos
      ...
      // Seleccion proporcional para multi-tema
...
export default function TestAleatorioExamenTramitacionPage() {
  return (
    <Suspense
      fallback={
