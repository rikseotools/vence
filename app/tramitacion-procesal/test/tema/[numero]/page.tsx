...
export default function TemaTramitacionPage({ params }: PageProps) {
  ...
  async function handleStartCustomTest(config: any) {
    ...
    try {
      ...
      const testUrl = `/tramitacion-procesal/test/tema/${temaNumber}/${testPath}?${testParams.toString()}`
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber || ''} no existe o no está disponible para Tramitación Procesal.
          </p>
          <Link
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block" ref={dropdownRef}>
            <div className="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-medium mb-3">
              ...
              <Link href="/tramitacion-procesal/test" className="hover:text-blue-900 transition-colors">
                ...
                <div className="py-2">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium">Tramitación Procesal (C1)</div>
              ...
              <div className="text-sm">
                {testMode === 'practica' ? (
                  ...
                  <>
                    ...
                    <span className="text-indigo-700"> Verás todas las preguntas en scroll. Corrección al final.</span>
                  </>
                )}
              </div>
            </div>
