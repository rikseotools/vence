// app/test-oposiciones/test-ley-39-2015/titulo-iii-capitulo-iii-nulidad-anulabilidad/page.js
...
export async function generateMetadata() {
  const data = await loadSectionData('titulo-iii-capitulo-iii-nulidad-anulabilidad')
