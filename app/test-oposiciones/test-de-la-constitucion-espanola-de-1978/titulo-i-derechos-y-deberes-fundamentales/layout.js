...
export const metadata = {
  ...
  keywords: 'derechos fundamentales constitución, libertades públicas, test título I constitución, artículos 10-55, auxiliar administrativo',
  openGraph: {
    title: 'Test Título I - Derechos y Deberes Fundamentales - Constitución Española 1978',
    description: 'Practica con preguntas específicas del Título I sobre derechos y deberes fundamentales de la Constitución.',
    type: 'website'
  }
}

export default function TituloIDerechosLayout({ children }) {
  return children
}