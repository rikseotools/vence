...
export const metadata = {
  ...
  keywords: 'relaciones gobierno cortes, moción censura, cuestión confianza, test título V constitución, artículos 108-116',
  openGraph: {
    title: 'Test Título V - Relaciones entre el Gobierno y las Cortes - Constitución Española 1978',
    description: 'Practica con preguntas específicas del Título V sobre las relaciones entre el Gobierno y las Cortes.',
    type: 'website'
  }
}

export default function TituloVLayout({ children }) {
  return children
}