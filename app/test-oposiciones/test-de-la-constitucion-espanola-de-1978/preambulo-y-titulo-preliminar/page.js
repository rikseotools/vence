// app/test-oposiciones/constitucion-titulos/preambulo-y-titulo-preliminar/page.js
...
export async function generateMetadata() {
  const data = await loadConstitucionSectionData('preambulo-y-titulo-preliminar')
