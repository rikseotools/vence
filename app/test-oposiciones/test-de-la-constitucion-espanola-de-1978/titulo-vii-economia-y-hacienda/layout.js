...
export const metadata = {
  ...
  keywords: 'economía hacienda constitución, presupuestos generales estado, tribunal cuentas, test título VII constitución',
  openGraph: {
    title: 'Test Título VII - Economía y Hacienda - Constitución Española 1978',
    description: 'Practica con preguntas específicas del Título VII sobre Economía y Hacienda de la Constitución.',
    type: 'website'
  }
}

export default function TituloVIILayout({ children }) {
  return children
}