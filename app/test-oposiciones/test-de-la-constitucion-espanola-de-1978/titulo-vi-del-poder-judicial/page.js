// app/test-oposiciones/constitucion-titulos/titulo-vi-del-poder-judicial/page.js
...
export async function generateMetadata() {
  const data = await loadConstitucionSectionData('titulo-vi-del-poder-judicial')
