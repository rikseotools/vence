...
export const metadata = {
  ...
  keywords: 'corona constitución, rey españa, test título II constitución, artículos 56-65, auxiliar administrativo',
  openGraph: {
    title: 'Test Título II - De la Corona - Constitución Española 1978',
    description: 'Practica con preguntas específicas del Título II sobre la Corona de la Constitución.',
    type: 'website'
  }
}

export default function TituloIILayout({ children }) {
  return children
}