// app/test-oposiciones/constitucion-titulos/titulo-iii-de-las-cortes-generales/page.js
...
export async function generateMetadata() {
  const data = await loadConstitucionSectionData('titulo-iii-de-las-cortes-generales')
