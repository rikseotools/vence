...
export const metadata = {
  ...
  keywords: 'reforma constitucional, procedimientos reforma, test título X constitución, artículos 166-169',
  openGraph: {
    title: 'Test Título X - De la Reforma Constitucional - Constitución Española 1978',
    description: 'Practica con preguntas específicas del Título X sobre la reforma constitucional.',
    type: 'website'
  }
}

export default function TituloXLayout({ children }) {
  return children
}