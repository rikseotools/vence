...
export const metadata = {
  ...
  keywords: 'gobierno constitución, administración pública, test título IV constitución, artículos 97-107, auxiliar administrativo',
  openGraph: {
    title: 'Test Título IV - Del Gobierno y la Administración - Constitución Española 1978',
    description: 'Practica con preguntas específicas del Título IV sobre el Gobierno y la Administración de la Constitución.',
    type: 'website'
  }
}

export default function TituloIVLayout({ children }) {
  return children
}