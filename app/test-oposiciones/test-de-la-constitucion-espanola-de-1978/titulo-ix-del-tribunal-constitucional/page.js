// app/test-oposiciones/constitucion-titulos/titulo-ix-del-tribunal-constitucional/page.js
...
export async function generateMetadata() {
  const data = await loadConstitucionSectionData('titulo-ix-del-tribunal-constitucional')
