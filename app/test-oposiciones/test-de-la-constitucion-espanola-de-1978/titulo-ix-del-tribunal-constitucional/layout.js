...
export const metadata = {
  ...
  keywords: 'tribunal constitucional, recurso amparo, inconstitucionalidad, test título IX constitución, artículos 159-165',
  openGraph: {
    title: 'Test Título IX - Del Tribunal Constitucional - Constitución Española 1978',
    description: 'Practica con preguntas específicas del Título IX sobre el Tribunal Constitucional.',
    type: 'website'
  }
}

export default function TituloIXLayout({ children }) {
  return children
}