// app/auxiliar-administrativo-ayuntamiento-valencia/test/test-personalizado/page.tsx
'use client'
...
function TestPersonalizadoContent() {
  ...
  return (
    <TestPageWrapper
      ...
      customSubtitle=""
      customIcon="🎲"
      customColor="from-amber-500 to-orange-600"
...
export default function TestPersonalizadoAyuntamientoValenciaPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
