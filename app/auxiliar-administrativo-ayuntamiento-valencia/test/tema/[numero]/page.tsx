...
export default function TemaAyuntamientoValenciaPage({ params }: PageProps) {
  ...
  useEffect(() => {
    async function resolveParams() {
      ...
      if (isNaN(tema) || tema < 1 || tema > TOTAL_TEMAS) {
  ...
  async function handleStartCustomTest(config: TestStartConfig) {
    ...
    try {
      window.location.href = buildTestUrl({
        basePath: '/auxiliar-administrativo-ayuntamiento-valencia',
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <p className="text-gray-600 mb-6">
            El Tema {temaNumber || ''} no existe o no está disponible para Auxiliar Administrativo Ayuntamiento de Valencia.
          </p>
          <Link
      ...
      <div className="max-w-4xl mx-auto px-3 py-6">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block" ref={dropdownRef}>
            <div className="inline-flex items-center px-3 py-1 bg-amber-100 text-amber-800 rounded-full text-xs font-medium mb-3">
              ...
              <Link href="/auxiliar-administrativo-ayuntamiento-valencia/test" className="hover:text-amber-900 transition-colors">
                Aux. Admin. Ayto. Valencia (C2)
              </Link>
        ...
        <section className="mb-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className={`p-4 rounded-lg ${testMode === 'practica' ? 'bg-amber-50 border border-amber-200' : 'bg-orange-50 border border-orange-200'}`}>
              <div className="text-sm">
                {testMode === 'practica' ? (
                  <>
                    <span className="font-semibold text-amber-800">Modo Práctica:</span>
                    <span className="text-amber-700"> Verás una pregunta a la vez con explicación inmediata.</span>
                  </>
                ) : (
                  <>
