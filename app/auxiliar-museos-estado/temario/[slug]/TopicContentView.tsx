// app/auxiliar-museos-estado/temario/[slug]/TopicContentView.tsx
'use client'
...
// Bloques de Auxiliar de Museos (Estado) (generado por el scaffolder desde el spec)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  ...
  } else if (topicNumber >= 201 && topicNumber <= 224) {
    return { block: 'Museología (parte específica)', displayNum: topicNumber - 200 }
...
export default function TopicContentView({ content, oposicion = 'auxiliar-museos-estado', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_museos_estado&return_to=/auxiliar-museos-estado/temario"
