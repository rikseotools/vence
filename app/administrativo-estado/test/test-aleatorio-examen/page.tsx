...
// app/administrativo-estado/test/test-aleatorio-examen/page.tsx
'use client'
...
const POSITION_TYPE = slugToPositionType('administrativo-estado')

// Obtener nombres de temas desde la configuracion
const config = OPOSICION_BLOCKS_CONFIG['administrativo-estado']
...
export default function TestAleatorioExamenAdministrativoPage() {
  return (
    <Suspense
      fallback={
