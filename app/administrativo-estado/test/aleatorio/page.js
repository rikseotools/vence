...
export default function TestAleatorioAdministrativoPage() {
  ...
  const [expandedBlocks, setExpandedBlocks] = useState({ block1: true, block2: false, block3: false, block4: false, block5: false, block6: false }) // Bloques expandidos por defecto
  ...
  const getThemeTotalQuestions = (themeId) => {
    // Conteo de preguntas para Administrativo del Estado (C1) - 45 temas
    // TODO: Actualizar estos valores conforme se agreguen preguntas a cada tema
    const themeQuestionCounts = {
      1: 308,   // La Constitución Española de 1978
      2: 0,     // Los derechos y deberes fundamentales
      3: 0,     // El Tribunal Constitucional
      4: 0,     // La Corona
      5: 0,     // Las Cortes Generales
      6: 0,     // El Gobierno
      7: 0,     // La Administración General del Estado
      8: 0,     // La organización territorial del Estado
      9: 0,     // Las Comunidades Autónomas
      10: 0,    // La Administración Local
      11: 0,    // La Unión Europea
      12: 0,    // Atención al ciudadano
      13: 0,    // Los servicios de información administrativa
      14: 0,    // El registro de documentos
      15: 0,    // Los archivos
      16: 0,    // El acto administrativo
      17: 0,    // El procedimiento administrativo común
      18: 0,    // Los recursos administrativos
      19: 0,    // La jurisdicción contencioso-administrativa
      20: 0,    // Los contratos del sector público
      21: 0,    // La responsabilidad de las Administraciones Públicas
      22: 0,    // La potestad sancionadora
      23: 0,    // El personal al servicio de las Administraciones Públicas
      24: 0,    // Acceso al empleo público
      25: 0,    // La provisión de puestos de trabajo
      26: 0,    // Situaciones administrativas
      27: 0,    // Derechos de los empleados públicos
      28: 0,    // Deberes de los empleados públicos
      29: 0,    // El régimen disciplinario
      30: 0,    // El régimen de Seguridad Social
      31: 0,    // Prevención de riesgos laborales
      32: 0,    // El Presupuesto del Estado
      33: 0,    // El ciclo presupuestario
      34: 0,    // El gasto público
      35: 0,    // La contabilidad pública
      36: 0,    // El control del gasto público
      37: 0,    // Las subvenciones públicas
      38: 0,    // Informática básica
      39: 0,    // Sistema operativo Windows
      40: 0,    // Procesador de textos Word
      41: 0,    // Hoja de cálculo Excel
      42: 0,    // Base de datos Access
      43: 0,    // Correo electrónico
      44: 0,    // Internet y navegadores
      45: 0     // Seguridad informática
    }
  ...
  const generateRandomTest = async () => {
    ...
    try {
      ...
      router.push(`/administrativo-estado/test/${testPath}?${testParams.toString()}`)
    } catch (error) {
      if (process.env.NODE_ENV === 'development') {
