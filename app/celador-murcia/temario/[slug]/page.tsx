// app/celador-murcia/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('celador-murcia', topicNumber)
  ...
  return {
    title: `${content.title} | Cuerpo Celador/a-Subalterno/a del Servicio Murciano de Salud (SMS)`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Cuerpo Celador/a-Subalterno/a del Servicio Murciano de Salud (SMS)`,
    openGraph: {
      title: `${content.title} | Cuerpo Celador/a-Subalterno/a del Servicio Murciano de Salud (SMS)`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/celador-murcia/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/celador-murcia/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="celador-murcia" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
