// app/escala-administrativa-universidad-de-granada/temario/[slug]/page.tsx
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const content = await getTopicContent('escala-administrativa-universidad-de-granada', topicNumber)
  ...
  return {
    title: `${content.title} | Escala Administrativa - Universidad de Granada`,
    description: content.description || `Contenido teórico del Tema ${topicNumber} para Escala Administrativa - Universidad de Granada`,
    openGraph: {
      title: `${content.title} | Escala Administrativa - Universidad de Granada`,
      description: content.description || `Contenido teórico del Tema ${topicNumber}`,
      url: `https://www.vence.es/escala-administrativa-universidad-de-granada/temario/${slug}`,
      siteName: 'Vence.es',
      locale: 'es_ES',
      type: 'article',
    },
    alternates: {
      canonical: `https://www.vence.es/escala-administrativa-universidad-de-granada/temario/${slug}`,
    },
  }
}
...
export default async function TemarioTemaPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <TopicContentView content={content} oposicion="escala-administrativa-universidad-de-granada" updatedAt={formatUpdatedAt()} />
    </div>
  )
}
