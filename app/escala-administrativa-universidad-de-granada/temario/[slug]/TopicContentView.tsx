// app/escala-administrativa-universidad-de-granada/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Escala Administrativa - Universidad de Granada)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 7) {
    return { block: 'Parte General Común', displayNum: topicNumber }
  }
  if (topicNumber >= 8 && topicNumber <= 18) {
    return { block: 'Parte Específica', displayNum: topicNumber - 7 }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'escala-administrativa-universidad-de-granada', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=escala_administrativa_universidad_de_granada&return_to=/escala-administrativa-universidad-de-granada/temario"
