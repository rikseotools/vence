...
export const metadata = {
  ...
  keywords: [
    ...
    'tests administrativo galicia',
    'tests temas administrativo galicia',
    'test administrativo xunta de galicia',
    'tests oposiciones galicia',
    'preguntas administrativo galicia',
    'examen administrativo galicia',
    '19 temas administrativo galicia',
    'C1 xunta de galicia'
  ].join(', '),
  authors: [{ name: 'Vence' }],
  creator: 'Vence',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Vence - Tests Administrativo Xunta de Galicia',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Tests Administrativo Xunta de Galicia | Vence',
    description: 'Tests de los 19 temas oficiales. Estadisticas por tema y progreso personalizado.',
    images: ['/twitter-image-es.jpg'],
  },
  alternates: {
    canonical: `${SITE_URL}/administrativo-galicia/test`,
  },
  robots: {
    index: true,
    follow: true,
