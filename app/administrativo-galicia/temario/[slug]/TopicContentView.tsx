// app/administrativo-galicia/temario/[slug]/TopicContentView.tsx
// Reuses the CyL TopicContentView with Galicia-specific block ranges
'use client'
...
// Determinar la parte segun el numero de tema (Administrativo Xunta de Galicia C1)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 7) {
    return { block: 'Bloque I: Parte General', displayNum: topicNumber }
  } else if (topicNumber >= 8 && topicNumber <= 19) {
    return { block: 'Bloque II: Parte Específica', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'administrativo-galicia', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=administrativo_galicia&return_to=/administrativo-galicia/temario"
