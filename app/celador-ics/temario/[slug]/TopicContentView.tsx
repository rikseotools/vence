// app/celador-ics/temario/[slug]/TopicContentView.tsx
// Zelador ICS Catalunya: 1 bloque, temas 1-14
'use client'
...
// Zelador ICS Catalunya: 1 solo bloque, temas 1-14
...
export default function TopicContentView({ content, oposicion = 'celador-ics', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=celador_ics&return_to=/celador-ics/temario"
