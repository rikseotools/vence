// app/auxiliar-administrativo-diputacion-leon/temario/[slug]/TopicContentView.tsx
'use client'
...
// Determinar el bloque según el número de tema (Auxiliar Administrativo Diputación Provincial de León)
function getBlockInfo(topicNumber: number): { block: string; displayNum: number } {
  if (topicNumber >= 1 && topicNumber <= 8) {
    return { block: 'Bloque I: Derecho Constitucional, Autonómico y Comunitario', displayNum: topicNumber }
  } else if (topicNumber >= 9 && topicNumber <= 16) {
    return { block: 'Bloque II: Derecho Administrativo General', displayNum: topicNumber }
  } else if (topicNumber >= 17 && topicNumber <= 25) {
    return { block: 'Bloque III: Administración Local y Función Pública', displayNum: topicNumber }
  }
  return { block: '', displayNum: topicNumber }
}

export default function TopicContentView({ content, oposicion = 'auxiliar-administrativo-diputacion-leon', updatedAt }: TopicContentViewProps) {
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <TopicPrintButton
            loginHref="/login?oposicion=auxiliar_administrativo_diputacion_leon&return_to=/auxiliar-administrativo-diputacion-leon/temario"
