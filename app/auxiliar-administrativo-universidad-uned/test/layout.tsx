    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Vence - Tests Auxiliar Administrativo UNED',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Tests Auxiliar Administrativo UNED | Vence',
    description: 'Tests de los 21 temas oficiales. Estadisticas por tema y progreso personalizado.',
    images: ['/twitter-image-es.jpg'],
  },
  alternates: {
    canonical: `${SITE_URL}/auxiliar-administrativo-universidad-uned/test`,
  },
  robots: {
    index: true,
    follow: true,
