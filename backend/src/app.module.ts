...
import { TipificarDocumentosModule } from './tipificar-documentos/tipificar-documentos.module';
...
import { CanaryCompetitorMentionModule } from './canary-competitor-mention/canary-competitor-mention.module';
...
// Canary del PIPELINE de stats materializadas (03/06/2026, post-incidente cutover
// outbox a medias): inyecta respuesta sintética y verifica propagación e2e a
// uqh_v2. Cobertura 24/7 independiente del tráfico (cierra el punto ciego de las
// reglas de frescura/paridad en valle nocturno).
import { CanaryStatsPipelineModule } from './canary-stats-pipeline/canary-stats-pipeline.module';
...
@Module({
  imports: [
    ...
    CanaryCompetitorMentionModule, // cada hora — detecta preguntas visibles que mencionan a un competidor
    ...
    TipificarDocumentosModule, // T-147 — reclasifica 'nota'→tipo real, backlog no se rellena solo
