...
export const OFFICIAL_OPOSICIONES: OposicionItem[] = [
  ...
  },
  {
    ...
    nombre: 'Administrativo (C1) del Principado de Asturias',
    categoria: 'C1',
    administracion: 'Autonómica',
    icon: '⛰️'
  },
  ...
  },
  {
    ...
    nombre: 'Auxiliar Administrativo Ayuntamiento de Marbella',
    categoria: 'C2',
    administracion: 'Autonómica',
    icon: '🏖️'
  },
  {
    ...
    nombre: 'Auxiliar Administrativo Ayuntamiento de Valladolid',
    categoria: 'C2',
    administracion: 'Autonómica',
    icon: '🏛️'
  },
