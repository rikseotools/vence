  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      {question.content_data?.table_data?.example_row && (
        <div className="mb-6">
          <h3 className="font-bold text-gray-900 mb-3">📋 Datos del Seguro:</h3>
          <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-4">
            <div className="flex justify-center">
              <table className="border-collapse">
                <tbody>
                  <tr className="border border-orange-300">
                    <td className="border border-orange-300 px-4 py-2 bg-orange-100 font-semibold text-center">
      ...
      {question.content_data?.criteria && (
        <div className="mb-6">
          <h3 className="font-bold text-gray-900 mb-3">📝 Criterios de Clasificación:</h3>
          <div className="space-y-3">
            {question.content_data.criteria.map((criterion, index) => {
              let criterionClass = "bg-gray-50 border border-gray-200 rounded-lg p-4 cursor-pointer transition-all duration-200 hover:bg-blue-50 hover:border-blue-300"
              ...
              if (showResult) {
                if (index === question.correct_option) {
                  ...
                  criterionClass = "bg-gray-50 border border-gray-200 rounded-lg p-4"
                }
              } else if (selectedAnswer !== null && selectedAnswer === index) {
                criterionClass = "bg-blue-50 border-2 border-blue-500 rounded-lg p-4"
              }
              ...
              return (
                ...
                >
                  <div className="flex items-start">
                    <span className="font-bold text-lg text-blue-600 mr-3 bg-blue-100 w-8 h-8 rounded-full flex items-center justify-center">
                      {criterion.column}
                    </span>
        ...
        {options.map((option, index) => {
          ...
          if (showResult) {
            if (index === question.correct_option) {
              ...
              buttonClass += "bg-white border-2 border-gray-300 text-gray-600"
            }
          } else if (selectedAnswer !== null && selectedAnswer === index) {
            ...
            buttonClass += "bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-50"
          }
              ...
              {analysisSteps.map((step, index) => (
                <div key={index} className={`bg-white p-4 rounded-lg border-l-4 ${
                  ...
                  <h5 className={`font-semibold mb-2 ${
                    step.matches ? 'text-green-800' : 'text-red-800'
                  }`}>
                  ...
                  <div className="space-y-2">
                    {step.analysis.checks.map((check, checkIndex) => (
                      <div key={checkIndex} className="flex items-center justify-between text-xs bg-gray-50 p-2 rounded">
                        <span className="text-gray-600">{check.condition}</span>
                        <span className="text-gray-800 font-medium">{check.actual}</span>
                        <span className={check.result ? 'text-green-600' : 'text-red-600'}>
                          {check.description}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className={`mt-2 p-2 rounded text-xs font-medium ${
                    step.matches ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                  }`}>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-white p-3 rounded border-l-4 border-yellow-500">
                    <h6 className="font-semibold text-yellow-800 mb-1">🔍 Método 1: Análisis sistemático</h6>
                  ...
                  <div className="bg-white p-3 rounded border-l-4 border-orange-500">
                    <h6 className="font-semibold text-orange-800 mb-1">📅 Método 2: Atajos para fechas</h6>
                    <p className="text-gray-700">
                  ...
                  <div className="bg-white p-3 rounded border-l-4 border-purple-500">
                    <h6 className="font-semibold text-purple-800 mb-1">💰 Método 3: Rangos de cantidad</h6>
                    <p className="text-gray-700">
