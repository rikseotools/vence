...
async function main() {
  const corrections = JSON.parse(fs.readFileSync("t103_corrections.json", "utf8"));
  ...
  // Verify: count remaining errors for T103
  const topicId = "9b2d8bc2-d248-4841-9cc9-dad6c51facc3";
