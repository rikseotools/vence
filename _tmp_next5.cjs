...
(async () => {
  ...
  const fixed = new Set([
    "9553bc73-95cc-4913-a17a-d6bec1c30c4e",
    "3fe6dda0-b00d-43a3-b125-16472eab53cc",
    "748a7f71-f684-490c-9232-efd1d11d6c77",
    "bcadf039-6975-4a3e-8351-feb7e5831aed"
  ]);
  const seen = new Set();
  ...
  console.log("NO HAY MAS PREGUNTAS CON EXPLICACION INSUFICIENTE EN ESTE RANGO");
})();
