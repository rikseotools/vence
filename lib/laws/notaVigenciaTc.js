 ...
 *
 * Incluye la forma VERBAL «se anula / se anulan» (T-169, 27/07/2026). Es como el BOE
 * redacta las anulaciones del **Tribunal Supremo**, que no usan la fórmula del TC:
 *
 *     "Se anula el apartado 2.b) por Sentencias del TS de 8 de febrero de 2012"
 *
 * Ni «anula» ni «anulan» casaban con `\banulad`, así que tres artículos del RD 1720/2007
 * quedaban capturados con `esAnulacion=false` y el detector los reportaba eternamente. Un
 * reglamento anulado por el Supremo está tan fuera de vigencia como uno anulado por el TC:
 * para el opositor es idéntico.
 *
 * OJO al ampliar: se exige el «se» delante justamente para no casar con el articulado que
 * HABLA de anular («el órgano podrá anular el acto»), que es texto legal, no nota.
 */
const RE_NULIDAD = /\binconstitucional|\bnul(?:idad|o|a|os|as)\b|\banulad|\bse\s+anulan?\b/i
