    ...
    const response = await fetch('/api/emails/send-admin-notification', {
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          adminUrl: `https://www.ilovetest.pro/admin#feedback-${feedbackData.id}`
        }
      })
    })
    ...
    const response = await fetch('/api/emails/send-admin-notification', {
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          adminUrl: `https://www.ilovetest.pro/admin/impugnaciones#dispute-${disputeData.id}`
        }
      })
    })
    ...
    const response = await fetch('/api/emails/send-admin-notification', {
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          adminUrl: `https://www.ilovetest.pro/admin/usuarios/${userData.id}`
        }
      })
    })
