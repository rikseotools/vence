...
const RE_INSTRUMENTO =
  /\b(plan(es)? (estrategico|estrategicos|de igualdad|nacional|director|de accion)|estrategia (nacional|andaluza|estatal|espanola|de [a-z]+)|informe de evaluacion de impacto)/
