...
function numeros(texto) {
  ...
  while ((m = re.exec(String(texto || ''))) !== null) {
    ...
    // AMBIGÜEDAD REAL: `20,120` puede ser el decimal 20,12 o los dos números de una serie.
    // En español los miles van con punto, así que la coma seguida de tres cifras no se puede
    // resolver mirando el texto. Se devuelven LAS DOS lecturas: el detector pregunta «¿menciona
    // alguna cifra de la clave?», y ampliar el candidato evita marcar una pregunta sana.
