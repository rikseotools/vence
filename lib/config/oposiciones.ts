    ...
    blocks: [
      ...
      },
      {
        ...
        themes: [
          ...
          { id: 18, name: 'Hacienda Pública de Navarra (Ley Foral 13/2007)' },
          { id: 19, name: 'Contratos Públicos Navarra (Ley Foral 2/2018)' },
          { id: 20, name: 'Administración Electrónica en Navarra' },
          { id: 21, name: 'Transparencia Navarra (Ley Foral 5/2018)' },
          { id: 22, name: 'Protección de datos (LO 3/2018)' },
          { id: 23, name: 'Igualdad de género (LO 3/2007 + Ley Foral 17/2019)' },
        ],
      },
      {
        id: 'bloque3',
