...
export const OPOSICIONES: Oposicion[] = [
  // Agente de la Hacienda Pública
  {
    ...
    positionType: 'agente_hacienda',
    examScoring: { penaltyDivisor: 3, source: 'BOE-A-2025-27056, base 7. Pendiente de confirmar el divisor exacto contra el texto de la base al preparar el simulacro: se fija 3 (la regla habitual de la AEAT) y se marca para verificar antes de publicar simulacros.' },
    hasPsychometricTest: false,
    name: 'Agente de la Hacienda Pública',
    shortName: 'Agente de Hacienda',
    emoji: '🏛️',
    badge: 'C1',
    color: 'blue',
    administracion: 'estado',
    aliases: ['agente de hacienda', 'agente hacienda publica', 'agentes de la hacienda publica', 'oposicion agente de hacienda', 'agente tributario aeat', 'cuerpo general administrativo hacienda'],
    blocks: [
      {
        id: 'bloque1',
        ...
        themes: [
          ...
          { id: 5, name: 'El funcionamiento electrónico del sector público' },
          { id: 6, name: 'Políticas de igualdad de género, no discriminación y contra la violencia de género' },
          { id: 7, name: 'Régimen jurídico del personal al servicio de las Administraciones Públicas' },
          { id: 8, name: 'Las fuentes del Derecho Administrativo' },
          { id: 9, name: 'Los actos administrativos' },
          { id: 10, name: 'El procedimiento administrativo común' },
          { id: 11, name: 'Las fases del procedimiento administrativo' },
          { id: 12, name: 'Los recursos administrativos' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Materias Específicas (Hacienda Pública y Derecho Tributario)',
        subtitle: null,
        icon: '🏛️',
        themes: [
          { id: 13, name: 'El sistema fiscal español' },
          { id: 14, name: 'La Agencia Estatal de Administración Tributaria' },
          { id: 15, name: 'Derecho Tributario' },
          { id: 16, name: 'Obligaciones tributarias formales' },
          { id: 17, name: 'Información y Asistencia a los obligados tributarios' },
          { id: 18, name: 'Las declaraciones tributarias' },
          { id: 19, name: 'Actuaciones y procedimiento de gestión tributaria' },
          { id: 20, name: 'Actuaciones y procedimiento de inspección' },
          { id: 21, name: 'La extinción de la deuda tributaria (I)' },
          { id: 22, name: 'La extinción de la deuda tributaria (II)' },
          { id: 23, name: 'Las actuaciones y el procedimiento de recaudación tributaria' },
          { id: 24, name: 'El embargo' },
          { id: 25, name: 'La potestad sancionadora en materia tributaria' },
          { id: 26, name: 'Revisión en vía administrativa' },
          { id: 27, name: 'El Impuesto sobre la Renta de las Personas Físicas (I)' },
          { id: 28, name: 'El Impuesto sobre la Renta de las Personas Físicas (II)' },
          { id: 29, name: 'El Impuesto sobre Sociedades' },
          { id: 30, name: 'El Impuesto sobre el Valor Añadido (I)' },
          { id: 31, name: 'El Impuesto sobre el Valor Añadido (II)' },
          { id: 32, name: 'La Aduana' },
        ],
      },
    ],
    totalTopics: 32,
    navLinks: [
      ...
      { href: '/agente-hacienda', label: 'Mi Oposición', icon: '🏛️', featured: true },
      { href: '/agente-hacienda/temario', label: 'Temario', icon: '📚' },
      { href: '/agente-hacienda/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // Auxiliar de Enfermería Geriatría de la Diputación de Cádiz
  {
    id: 'auxiliar_enfermeria_geriatria_diputacion_cadiz',
    slug: 'auxiliar-enfermeria-geriatria-diputacion-cadiz',
    positionType: 'auxiliar_enfermeria_geriatria_diputacion_cadiz',
    examScoring: { penaltyDivisor: 2.6667, source: 'BOP Cádiz nº 28 de 11/02/2026, bases específicas, base séptima 2.1 y 2.2: «Se valorará con 0,20 puntos cada una de las preguntas contestadas correctamente, penalizando cada contestación errónea con 0,075 puntos. Las respuestas en blanco no penalizan. En caso de señalar más de una opción se considerará como respuesta en blanco». 0,20 / 0,075 = 2,6667 respuestas erróneas anulan una correcta.' },
    hasPsychometricTest: false,
    name: 'Auxiliar de Enfermería Geriatría de la Diputación de Cádiz',
    shortName: 'Aux. Enfermería Geriatría Dip. Cádiz',
    emoji: '🧑‍⚕️',
    badge: 'C2',
    color: 'emerald',
    administracion: 'local',
    aliases: ['auxiliar de enfermeria geriatria diputacion cadiz', 'tcae diputacion cadiz', 'auxiliar enfermeria diputacion de cadiz', 'auxiliar de enfermeria geriatria cadiz', 'tcae geriatria cadiz', 'oposicion auxiliar enfermeria geriatria cadiz'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Materias Comunes',
        ...
        themes: [
          ...
          { id: 4, name: 'El Estatuto de Autonomía para Andalucía: estructura y disposiciones generales' },
          { id: 5, name: 'La Provincia' },
          { id: 6, name: 'Los derechos de los ciudadanos ante la Administración Pública' },
          { id: 7, name: 'Ley Prevención de Riesgos Laborales' },
          { id: 8, name: 'Conceptualización básica' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '🧑‍⚕️',
        themes: [
          { id: 9, name: 'Documentación en el ámbito sanitario' },
          { id: 10, name: 'Las técnicas de comunicación interpersonal' },
          { id: 11, name: 'Necesidades fundamentales de la persona' },
          { id: 12, name: 'Epidemiología, cadena epidemiológica y transmisión de infecciones' },
          { id: 13, name: 'Limpieza en el medio sanitario' },
          { id: 14, name: 'Mobiliario y accesorios de la habitación hospitalaria' },
          { id: 15, name: 'La piel del anciano como órgano de protección ante las infecciones: los cambios de la piel como consecuencia del envejecimiento' },
          { id: 16, name: 'El sistema gastrointestinal: conceptos básicos y patologías más frecuentes' },
          { id: 17, name: 'Conceptos de nutrición enteral y parenteral' },
          { id: 18, name: 'Características de la orina' },
          { id: 19, name: 'Paciente geriátrico y necesidad de movilización' },
          { id: 20, name: 'Concepto clínico de muerte' },
          { id: 21, name: 'Las muestras de productos biológicos para analizar: concepto, tipos y normas generales de actuación' },
          { id: 22, name: 'Centros de atención y asistencia al anciano: definición y tipos' },
          { id: 23, name: 'Introducción a la Geriatría' },
          { id: 24, name: 'Hábitos de vida saludables en el anciano: el hábito de la higiene en el anciano, las prendas de vestir, la actividad física, la actividad sexual, el ocio y la dieta' },
          { id: 25, name: 'La atención centrada en la persona: concepto, metodología y buenas prácticas' },
        ],
      },
    ],
    totalTopics: 25,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/auxiliar-enfermeria-geriatria-diputacion-cadiz', label: 'Mi Oposición', icon: '🧑‍⚕️', featured: true },
      { href: '/auxiliar-enfermeria-geriatria-diputacion-cadiz/temario', label: 'Temario', icon: '📚' },
      { href: '/auxiliar-enfermeria-geriatria-diputacion-cadiz/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // Auxiliar de Clínica de la Diputación Provincial de Sevilla
  {
    id: 'auxiliar_clinica_diputacion_sevilla',
    slug: 'auxiliar-clinica-diputacion-sevilla',
    positionType: 'auxiliar_clinica_diputacion_sevilla',
    examScoring: { penaltyDivisor: 3, source: 'BOP Sevilla nº163 de 26/08/2025, bases específicas, primer ejercicio: «Se penalizará por cada tres respuestas erróneas con una correcta o su parte proporcional, en caso de tener menos de tres respuestas incorrectas, no puntuando las respuestas en blanco».' },
    hasPsychometricTest: false,
    name: 'Auxiliar de Clínica de la Diputación Provincial de Sevilla',
    shortName: 'Auxiliar de Clínica Dip. Sevilla',
    emoji: '🧑‍⚕️',
    badge: 'C2',
    color: 'emerald',
    administracion: 'local',
    aliases: ['auxiliar de clinica diputacion sevilla', 'auxiliar clinica diputacion de sevilla', 'tcae diputacion sevilla', 'auxiliar de enfermeria diputacion sevilla', 'auxiliar clinica sevilla', 'oposicion auxiliar de clinica sevilla'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Materias Comunes',
        ...
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución española de 1978: estructura. Derechos y deberes fundamentales' },
          { id: 2, name: 'Organización territorial del Estado. El municipio y la provincia. El Estatuto de Autonomía de Andalucía' },
          { id: 3, name: 'La Hacienda Local: clasificación de los recursos' },
          { id: 4, name: 'Igualdad y violencia de género. Igualdad real y efectiva de las personas trans y LGTBI' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Materias Específicas (atención sociosanitaria residencial)',
        subtitle: null,
        icon: '🧑‍⚕️',
        themes: [
          { id: 5, name: 'El auxiliar de clínica en el equipo multidisciplinar. Tareas del área asistencial' },
          { id: 6, name: 'La acogida de la nueva persona usuaria el día del ingreso' },
          { id: 7, name: 'La persona usuaria incontinente: comportamientos, actitudes y hábitos de autonomía' },
          { id: 8, name: 'Seguridad y accesibilidad de los espacios. Información previa a las personas usuarias' },
          { id: 9, name: 'Orden y condiciones higiénicas de la habitación de la persona usuaria' },
          { id: 10, name: 'Participación del auxiliar de clínica en la administración de la medicación' },
          { id: 11, name: 'Mantenimiento y mejora de las capacidades físicas y motoras de la persona usuaria' },
          { id: 12, name: 'Técnicas para favorecer las relaciones sociales. Comunicación verbal y no verbal' },
          { id: 13, name: 'Apoyo y estimulación de la comunicación: escucha activa, empatía y asertividad' },
          { id: 14, name: 'El auxiliar de clínica en el tratamiento no farmacológico del Alzheimer' },
          { id: 15, name: 'Limpieza y desinfección de materiales e instrumentos de uso común' },
          { id: 16, name: 'Técnicas sanitarias de urgencia y primeros auxilios ante un atragantamiento' },
          { id: 17, name: 'Factores que favorecen o dificultan la adaptación al centro residencial' },
          { id: 18, name: 'Principios éticos: actitudes y valores en la atención a personas dependientes' },
          { id: 19, name: 'Prevención y control de infecciones. Aislamiento y enfermedades transmisibles' },
          { id: 20, name: 'Constantes vitales: conceptos, equipos, técnicas y registros' },
        ],
      },
    ],
    totalTopics: 20,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/auxiliar-clinica-diputacion-sevilla', label: 'Mi Oposición', icon: '🧑‍⚕️', featured: true },
      { href: '/auxiliar-clinica-diputacion-sevilla/temario', label: 'Temario', icon: '📚' },
      { href: '/auxiliar-clinica-diputacion-sevilla/test', label: 'Tests', icon: '🎯' },
    ],
  },
  ...
  // Agentes de Tributos - Agencia Tributaria Canaria
  {
    ...
    positionType: 'administrativo_agencia_tributaria_canaria',
    examScoring: { penaltyDivisor: 3, source: 'BOC nº 117 de 12/06/2026 (Resolución de 29/05/2026): «cada contestación errónea se penalizará descontando de la puntuación total un tercio del valor de una respuesta correcta. Las respuestas en blanco no penalizan». confidence:alta' },
    hasPsychometricTest: false,
    name: 'Agentes de Tributos - Agencia Tributaria Canaria',
    shortName: 'Agentes Tributos Canarias',
    emoji: '🧾',
    badge: 'C1',
    color: 'teal',
    administracion: 'autonomica',
    aliases: ['Agentes de Tributos', 'Agencia Tributaria Canaria', 'ATC Canarias', 'Agente Tributario Canarias', 'Tributos Canarias'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Bloque I: Derecho Constitucional, Europeo, Administrativo y de Canarias',
        subtitle: null,
        icon: '',
        themes: [
          { id: 1, name: 'La Constitución Española de 1978: estructura y contenido' },
          { id: 2, name: 'La organización territorial del Estado' },
          { id: 3, name: 'Las Instituciones de la Unión Europea: el Consejo, el Parlamento Eu…' },
          { id: 4, name: 'Fuentes del Derecho Administrativo' },
          { id: 5, name: 'La Administración electrónica y protección de datos' },
          { id: 6, name: 'El acto administrativo: delimitación conceptual y elementos' },
          { id: 7, name: 'El procedimiento administrativo: concepto, naturaleza jurídica y cl…' },
          { id: 8, name: 'Los recursos administrativos' },
          { id: 9, name: 'Los contratos en el sector público: concepto y clases' },
          { id: 10, name: 'El Presupuesto de la Comunidad Autónoma de Canarias: concepto y est…' },
          { id: 11, name: 'El Estatuto Básico del Empleado Público' },
          { id: 12, name: 'La Ley Orgánica 3/2007, de 22 de marzo, para la igualdad efectiva d…' },
          { id: 13, name: 'El Estatuto de Autonomía de Canarias: estructura, contenido y natur…' },
          { id: 14, name: 'El Gobierno de Canarias: concepto y régimen jurídico' },
          { id: 15, name: 'La Administración Pública de la Comunidad Autónoma de Canarias' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Bloque II: Derecho Tributario',
        subtitle: null,
        icon: '',
        themes: [
          { id: 201, name: 'El sistema fiscal español y el subsistema tributario canario', displayNumber: 1 },
          { id: 202, name: 'Derecho Tributario: concepto y contenido', displayNumber: 2 },
          { id: 203, name: 'Las obligaciones formales de los contribuyentes: libros registros, …', displayNumber: 3 },
          { id: 204, name: 'Las declaraciones tributarias: concepto y clases', displayNumber: 4 },
          { id: 205, name: 'La extinción de la deuda tributaria', displayNumber: 5 },
          { id: 206, name: 'La aplicación de los tributos: información y asistencia', displayNumber: 6 },
          { id: 207, name: 'Normas comunes sobre actuaciones y procedimientos tributarios: fases', displayNumber: 7 },
          { id: 208, name: 'Actuaciones y procedimiento de gestión tributaria', displayNumber: 8 },
          { id: 209, name: 'Actuaciones y procedimiento de inspección: funciones y facultades', displayNumber: 9 },
          { id: 210, name: 'Infracciones y sanciones en materia tributaria', displayNumber: 10 },
          { id: 211, name: 'El procedimiento de recaudación en periodo voluntario', displayNumber: 11 },
          { id: 212, name: 'La recaudación en periodo ejecutivo', displayNumber: 12 },
          { id: 213, name: 'El embargo', displayNumber: 13 },
          { id: 214, name: 'La revisión de los actos de carácter tributario en vía administrativa', displayNumber: 14 },
          { id: 215, name: 'Los tributos propios de la Comunidad Autónoma de Canarias (I)', displayNumber: 15 },
          { id: 216, name: 'Los tributos propios de la Comunidad Autónoma de Canarias (II)', displayNumber: 16 },
          { id: 217, name: 'El Impuesto General Indirecto Canario (I)', displayNumber: 17 },
          { id: 218, name: 'Impuesto General Indirecto Canario (II)', displayNumber: 18 },
          { id: 219, name: 'Impuesto General Indirecto Canario (III)', displayNumber: 19 },
          { id: 220, name: 'El Arbitrio sobre la Importación y Entrega de Mercancías en las Isl…', displayNumber: 20 },
          { id: 221, name: 'La cesión de tributos a las Comunidades Autónomas', displayNumber: 21 },
          { id: 222, name: 'Impuesto sobre Sucesiones y Donaciones', displayNumber: 22 },
          { id: 223, name: 'El Impuesto sobre Transmisiones Patrimoniales y Actos Jurídicos Doc…', displayNumber: 23 },
          { id: 224, name: 'El Impuesto sobre Transmisiones Patrimoniales y Actos Jurídicos Doc…', displayNumber: 24 },
          { id: 225, name: 'Otros tributos cedidos', displayNumber: 25 },
        ],
      },
    ],
    totalTopics: 40,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/administrativo-agencia-tributaria-canaria', label: 'Mi Oposición', icon: '📋', featured: true },
      { href: '/administrativo-agencia-tributaria-canaria/temario', label: 'Temario', icon: '📚' },
      { href: '/administrativo-agencia-tributaria-canaria/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // Cuerpo de Ujieres de las Cortes Generales
  {
    ...
    positionType: 'ujieres_cortes_generales',
    examScoring: { penaltyDivisor: 3, source: 'BOE-A-2026-16036 (Resolución de 14/07/2026): ambos ejercicios se puntúan de 0 a 100, un punto por acierto y penalización de 1/3 del valor del acierto; respuestas en blanco y nulas no puntúan.' },
    hasPsychometricTest: true,
    name: 'Cuerpo de Ujieres de las Cortes Generales',
    shortName: 'Ujieres Cortes Generales',
    emoji: '🏛️',
    badge: 'C2',
    color: 'emerald',
    administracion: 'estado',
    aliases: ['ujieres cortes generales', 'ujier cortes generales', 'cuerpo de ujieres', 'ujier congreso de los diputados', 'ujier senado', 'ujieres parlamento', 'oposicion ujier', 'ujieres congreso'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Programa oficial (Anexo I)',
        subtitle: '17 temas: Constitución, Cortes Generales, personal y materias comunes',
        icon: '🏛️',
        themes: [
          { id: 1, name: 'La Constitución española de 1978' },
          { id: 2, name: 'Igualdad efectiva de mujeres y hombres' },
          { id: 3, name: 'Las Cortes Generales (I): composición y estatuto parlamentario' },
          { id: 4, name: 'Las Cortes Generales (II): órganos de gobierno' },
          { id: 5, name: 'Las Cortes Generales (III): órganos funcionales' },
          { id: 6, name: 'Las Cortes Generales (IV): funcionamiento' },
          { id: 7, name: 'Las Cortes Generales (V): debates y votaciones' },
          { id: 8, name: 'Las Cortes Generales (VI): funciones' },
          { id: 9, name: 'El personal de las Cortes Generales (I)' },
          { id: 10, name: 'El personal de las Cortes Generales (II): el Cuerpo de Ujieres' },
          { id: 11, name: 'El personal de las Cortes Generales (III): derechos y régimen disciplinario' },
          { id: 12, name: 'La Administración parlamentaria' },
          { id: 13, name: 'El Gobierno' },
          { id: 14, name: 'La organización territorial del Estado' },
          { id: 15, name: 'Atención al ciudadano y transparencia' },
          { id: 16, name: 'Administración electrónica y protección de datos' },
    ...
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/ujieres-cortes-generales', label: 'Mi Oposición', icon: '🏛️', featured: true },
      { href: '/ujieres-cortes-generales/temario', label: 'Temario', icon: '📚' },
      { href: '/ujieres-cortes-generales/test', label: 'Tests', icon: '🎯' },
    ],
  },
  ...
  // Oficial de Gestión del Parlamento de Andalucía
  {
    ...
    positionType: 'oficial_de_gestion_parlamento_de_andalucia',
    examScoring: { penaltyDivisor: 3, source: 'Acuerdo de 8 de julio de 2026, de la Mesa del Parlamento de Andalucía, base 7.2.1 (BOJA núm. 136, de 16 de julio de 2026): cada contestación errónea se penaliza con un tercio del valor de una respuesta acertada.' },
    hasPsychometricTest: false,
    name: 'Oficial de Gestión del Parlamento de Andalucía',
    shortName: 'Oficial de Gestión Parlamento Andalucía',
    emoji: '🏛️',
    badge: 'C1',
    color: 'green',
    administracion: 'autonomica',
    aliases: ['oficial de gestion parlamento de andalucia', 'oficiales de gestion parlamento andalucia', 'oficial gestion parlamento andaluz', 'oposicion oficial de gestion parlamento andalucia'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Bloque I. Materia General del Estado',
        subtitle: 'Constitución, poderes del Estado, organización territorial, presupuesto y Unión Europea',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'Las fuentes del Derecho en España' },
          { id: 2, name: 'La Constitución española de 1978' },
          { id: 3, name: 'Derechos y deberes fundamentales' },
          { id: 4, name: 'La Corona' },
          { id: 5, name: 'La representación política y el sistema electoral' },
          { id: 6, name: 'Las Cortes Generales' },
          { id: 7, name: 'El Gobierno' },
          { id: 8, name: 'La Administración General del Estado' },
          { id: 9, name: 'El Poder Judicial' },
          { id: 10, name: 'El Tribunal Constitucional, el Tribunal de Cuentas y el Defensor del Pueblo' },
          { id: 11, name: 'El Estado de las Autonomías' },
          { id: 12, name: 'Distribución de competencias entre el Estado y las comunidades autónomas' },
          { id: 13, name: 'Las entidades locales en España' },
          { id: 14, name: 'El Presupuesto' },
          { id: 15, name: 'El ciclo presupuestario' },
          { id: 16, name: 'La Unión Europea' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Bloque II. Andalucía y el Parlamento',
        subtitle: 'Derecho administrativo, Comunidad Autónoma, Parlamento de Andalucía y función pública',
        icon: '🏛️',
        themes: [
          { id: 17, name: 'Los contratos del sector público' },
          { id: 18, name: 'Los actos administrativos' },
          { id: 19, name: 'El procedimiento administrativo' },
          { id: 20, name: 'Los recursos administrativos' },
          { id: 21, name: 'La potestad sancionadora y la responsabilidad patrimonial' },
          { id: 22, name: 'Protección de datos y transparencia' },
          { id: 23, name: 'La Comunidad Autónoma de Andalucía' },
          { id: 24, name: 'Las competencias de la Comunidad Autónoma' },
          { id: 25, name: 'La Hacienda de la Comunidad Autónoma de Andalucía' },
          { id: 26, name: 'Organización territorial e institucional de Andalucía' },
          { id: 27, name: 'La Administración de la Comunidad Autónoma de Andalucía' },
          { id: 28, name: 'El Parlamento de Andalucía (I): composición y legislatura' },
          { id: 29, name: 'El Parlamento de Andalucía (II): diputados y grupos' },
          { id: 30, name: 'El Parlamento de Andalucía (III): organización interna' },
          { id: 31, name: 'El Parlamento de Andalucía (IV): funcionamiento' },
          { id: 32, name: 'El Parlamento de Andalucía (V): procedimiento legislativo' },
          { id: 33, name: 'El Parlamento de Andalucía (VI): investidura y control' },
          { id: 34, name: 'El Parlamento de Andalucía (VII): convenios y otras funciones' },
          { id: 35, name: 'El Parlamento de Andalucía (VIII): instrumentos de información' },
          { id: 36, name: 'El Estatuto de Gobierno y Régimen Interior del Parlamento' },
          { id: 37, name: 'El personal al servicio del Parlamento de Andalucía' },
          { id: 38, name: 'El presupuesto y la contratación del Parlamento de Andalucía' },
          { id: 39, name: 'Igualdad de género y lenguaje no sexista' },
          { id: 40, name: 'El Defensor del Pueblo Andaluz y la Oficina contra el Fraude' },
          { id: 41, name: 'La Cámara de Cuentas y otros órganos de extracción parlamentaria' },
          { id: 42, name: 'El Derecho de la función pública' },
          { id: 43, name: 'Adquisición y pérdida de la relación de servicio' },
          { id: 44, name: 'Representación del personal y prevención de riesgos laborales' },
        ],
      },
    ],
    totalTopics: 44,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/oficial-de-gestion-parlamento-de-andalucia', label: 'Mi Oposición', icon: '🏛️', featured: true },
      { href: '/oficial-de-gestion-parlamento-de-andalucia/temario', label: 'Temario', icon: '📚' },
      { href: '/oficial-de-gestion-parlamento-de-andalucia/test', label: 'Tests', icon: '🎯' },
    ],
  },
  ...
  // ========================================
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        icon: '📋',
        themes: [
          { id: 201, name: 'Atención al Público', displayNumber: 1 },
          { id: 202, name: 'Documento, Registro y Archivo', displayNumber: 2 },
          { id: 203, name: 'Administración Electrónica', displayNumber: 3 },
          { id: 204, name: 'Protección de Datos Personales', displayNumber: 4 },
        ],
      },
      {
        id: 'bloque3',
        ...
        icon: '⚖️',
        themes: [
          { id: 301, name: 'Las Fuentes del Derecho Administrativo', displayNumber: 1 },
          { id: 302, name: 'El Acto Administrativo', displayNumber: 2 },
          { id: 303, name: 'Las Leyes del Procedimiento Administrativo', displayNumber: 3 },
          { id: 304, name: 'Los Contratos del Sector Público', displayNumber: 4 },
          { id: 305, name: 'Procedimientos y Formas de la Actividad Administrativa', displayNumber: 5 },
          { id: 306, name: 'La Responsabilidad Patrimonial', displayNumber: 6 },
          { id: 307, name: 'Políticas de Igualdad', displayNumber: 7 },
        ],
      },
      {
        id: 'bloque4',
        ...
        icon: '👥',
        themes: [
          { id: 401, name: 'El Personal al Servicio de las Administraciones Públicas', displayNumber: 1 },
          { id: 402, name: 'Selección de Personal', displayNumber: 2 },
          { id: 403, name: 'El Personal Funcionario', displayNumber: 3 },
          { id: 404, name: 'Adquisición y Pérdida de la Condición de Funcionario', displayNumber: 4 },
          { id: 405, name: 'Provisión de Puestos de Trabajo', displayNumber: 5 },
          { id: 406, name: 'Las Incompatibilidades y Régimen Disciplinario', displayNumber: 6 },
          { id: 407, name: 'El Régimen de la Seguridad Social de los Funcionarios', displayNumber: 7 },
          { id: 408, name: 'El Personal Laboral', displayNumber: 8 },
          { id: 409, name: 'El Régimen de la Seguridad Social del Personal Laboral', displayNumber: 9 },
        ],
      },
      {
        id: 'bloque5',
        ...
        icon: '💰',
        themes: [
          { id: 501, name: 'El Presupuesto', displayNumber: 1 },
          { id: 502, name: 'El Presupuesto del Estado en España', displayNumber: 2 },
          { id: 503, name: 'El Procedimiento de Ejecución del Presupuesto de Gasto', displayNumber: 3 },
          { id: 504, name: 'Las Retribuciones e Indemnizaciones', displayNumber: 4 },
          { id: 505, name: 'Gastos para la Compra de Bienes y Servicios', displayNumber: 5 },
          { id: 506, name: 'Gestión Económica y Financiera', displayNumber: 6 },
        ],
      },
      {
        id: 'bloque6',
        ...
        icon: '💻',
        themes: [
          { id: 601, name: 'Informática Básica', displayNumber: 1 },
          { id: 602, name: 'Sistema Operativo Windows', displayNumber: 2 },
          { id: 603, name: 'El Explorador de Windows', displayNumber: 3 },
          { id: 604, name: 'Procesadores de Texto: Word 365', displayNumber: 4 },
          { id: 605, name: 'Hojas de Cálculo: Excel 365', displayNumber: 5 },
          { id: 606, name: 'Bases de Datos: Access 365', displayNumber: 6 },
          { id: 607, name: 'Correo Electrónico: Outlook 365', displayNumber: 7 },
          { id: 608, name: 'La Red Internet', displayNumber: 8 },
        ],
      },
    ],
    totalTopics: 45,
  ...
  // ========================================
  // CUIDADOR/A DIPUTACIÓN PROVINCIAL DE CÓRDOBA (C2)
  // ========================================
  {
    id: 'cuidador_diputacion_cordoba',
    slug: 'cuidador-diputacion-cordoba',
    positionType: 'cuidador_diputacion_cordoba',
    examScoring: { penaltyDivisor: 4, source: 'BOP Córdoba nº141 23/07/2026 (BOP-A-2026-2548) base 8ª: cada respuesta incorrecta resta una cuarta parte del valor de una correcta (1/4; 4 alternativas). confidence:alta' },
    name: 'Cuidador/a de la Diputación Provincial de Córdoba',
    shortName: 'Cuidador/a Dip. Córdoba',
    emoji: '🧑‍⚕️',
    badge: 'C2',
    color: 'teal',
    administracion: 'local',
    blocks: [
      {
        ...
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución Española de 1978 (I). Derechos y deberes. La Corona' },
          { id: 2, name: 'La Constitución Española de 1978 (II). Cortes, Gobierno, Poder Judicial y las leyes' },
          { id: 3, name: 'Organización territorial del Estado. Las Comunidades Autónomas. El Estatuto de Autonomía para Andalucía' },
          { id: 4, name: 'Normativa estatal y autonómica sobre igualdad de género' },
        ],
      },
      {
    ...
    totalTopics: 20,
    aliases: ['cuidador cordoba', 'cuidadora cordoba', 'cuidador diputacion cordoba', 'cuidador dependencia cordoba', 'cuidador dip cordoba'],
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/cuidador-diputacion-cordoba', label: 'Mi Oposición', icon: '🧑‍⚕️', featured: true },
      { href: '/cuidador-diputacion-cordoba/temario', label: 'Temario', icon: '📚' },
      { href: '/cuidador-diputacion-cordoba/test', label: 'Tests', icon: '🎯' },
    ],
  },
    ...
    blocks: [
      {
        ...
        themes: [
          { id: 1, name: 'La Constitución Española de 1978' },
          { id: 2, name: 'Ley 39/2015 (I)' },
          { id: 3, name: 'Ley 39/2015 (II)' },
          { id: 4, name: 'Ley 40/2015 (I)' },
          { id: 5, name: 'Ley 40/2015 (II)' },
          { id: 6, name: 'Protección de Datos (LOPDGDD)' },
          { id: 7, name: 'Transparencia (Comunidad de Madrid y UC3M)' },
          { id: 8, name: 'Igualdad efectiva de mujeres y hombres' },
          { id: 9, name: 'Ofimática: procesadores de texto, hojas de cálculo, Google y correo' },
        ],
      },
      {
        id: 'rrhh',
        ...
        themes: [
          ...
          { id: 12, name: 'Prevención de Riesgos Laborales' },
        ],
      },
      {
        id: 'universitaria',
        ...
        themes: [
          ...
          { id: 16, name: 'Organización de las enseñanzas universitarias' },
          { id: 17, name: 'Acceso y admisión a las enseñanzas universitarias' },
        ],
      },
      {
        id: 'economica',
        ...
        themes: [
          ...
          { id: 20, name: 'Ley de Contratos del Sector Público' },
        ],
      },
    ],
    totalTopics: 20,
    ...
    blocks: [
      ...
      },
      {
        ...
        themes: [
          ...
          { id: 16, name: 'Instituciones de la UE (II): el Tribunal de Cuentas, el Comité de las Regiones y el CES' },
    ...
    blocks: [
      {
        ...
        themes: [
          { id: 1, name: 'La Constitución Española de 1978' },
          { id: 2, name: 'Organización territorial del Estado' },
          { id: 3, name: 'La organización de la Administración pública' },
          { id: 4, name: 'El Estatuto de Autonomía de Aragón' },
          { id: 5, name: 'El ordenamiento jurídico-administrativo' },
          { id: 6, name: 'El acto administrativo' },
          { id: 7, name: 'La invalidez del acto administrativo' },
          { id: 8, name: 'Disposiciones generales del procedimiento administrativo común' },
          { id: 9, name: 'Terminación del procedimiento' },
          { id: 10, name: 'Recursos administrativos' },
          { id: 11, name: 'La Función Pública' },
        ],
      },
      {
        id: 'bloque-2',
        ...
        icon: '🏛️',
        themes: [
          { id: 12, name: 'El sistema de fuentes del Derecho Local' },
          { id: 13, name: 'Los municipios de régimen común' },
          { id: 14, name: 'Los municipios de gran población. La provincia' },
          { id: 15, name: 'Las competencias municipales' },
          { id: 16, name: 'Régimen de sesiones y acuerdos' },
          { id: 17, name: 'Los contratos del sector público' },
          { id: 18, name: 'Los recursos de las Haciendas Locales' },
      ...
      },
      {
        ...
        themes: [
          { id: 20, name: 'La Ley de Prevención de Riesgos Laborales' },
          { id: 21, name: 'La atención al público' },
          { id: 22, name: 'Concepto de documento, registro y archivo' },
          { id: 23, name: 'Análisis documental' },
          { id: 24, name: 'Aplicación de las nuevas tecnologías a la documentación del archivo' },
        ],
      },
      {
        id: 'bloque-4',
        ...
        icon: '💻',
        themes: [
          { id: 25, name: 'Conocimientos prácticos del entorno Windows y ofimática' },
        ],
      },
      {
        id: 'bloque-5',
    ...
    blocks: [
      ...
      },
      {
        ...
        themes: [
          ...
          { id: 26, name: 'Recursos de las Haciendas Locales' },
          { id: 27, name: 'El presupuesto de las entidades locales' },
          { id: 28, name: 'Windows 11, Microsoft Word 2016 y correo electrónico' },
          { id: 29, name: 'Hojas de cálculo: Microsoft Excel 2016' },
        ],
      },
    ],
    totalTopics: 29,
    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 3, name: 'El Estatuto de Autonomía de la Comunitat Valenciana' },
          { id: 4, name: 'La Ley 5/1983, del Consell (I)' },
          { id: 5, name: 'La Ley 5/1983, del Consell (II)' },
          { id: 6, name: 'Igualdad y violencia de género' },
          { id: 7, name: 'Transparencia y acceso a la información pública' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '⚖️',
        themes: [
          { id: 8, name: 'La Ley 39/2015, del Procedimiento Administrativo Común (I)' },
          { id: 9, name: 'La Ley 39/2015 (II) y la Ley 40/2015' },
          { id: 10, name: 'La Función Pública Valenciana (Ley 4/2021)' },
          { id: 11, name: 'Condiciones de trabajo (Decreto 42/2019)' },
          { id: 12, name: 'Atención a la ciudadanía (Decreto 30/2025)' },
          { id: 13, name: 'Control de acceso y protección de datos' },
          { id: 14, name: 'Prevención de riesgos laborales' },
          { id: 15, name: 'Seguridad digital (Orden 19/2013)' },
        ],
      },
    ],
    totalTopics: 15,
    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 16, name: 'Régimen Jurídico y Organizativo de la Atención Ciudadana' },
      ...
      },
      {
        ...
        icon: '💻',
        themes: [
          { id: 19, name: 'Sistema Operativo: Microsoft Windows 11' },
          { id: 20, name: 'El Explorador de Archivos en Windows 11' },
          { id: 21, name: 'Procesador de textos: Microsoft Word (Microsoft 365)' },
          { id: 22, name: 'Hoja de cálculo: Microsoft Excel (Microsoft 365)' },
          { id: 23, name: 'Correo electrónico: Microsoft Outlook (Microsoft 365)' },
    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 4, name: 'Derechos y deberes de las personas en relación con la salud (Ley 8/2003), LOPD (LO 3/2018) e Historia Clínica en CyL (Decreto 101/2005)' },
          ...
          { id: 7, name: 'Programas de Salud y Guías de Práctica Clínica de la GRS; Prevención de Riesgos Laborales (Ley 31/1995)' },
          { id: 8, name: 'Sistemas de información en Atención Especializada y Primaria; registros de enfermería; clasificaciones (CIAP-2, CIE-11, NANDA)' },
  ...
  // ========================================
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        icon: '💉',
        themes: [
          { id: 16, name: 'Marco conceptual y modelos de enfermería', displayNumber: 1 },
          { id: 17, name: 'Organización de los cuidados enfermeros en Atención Primaria y Atención Especializada', displayNumber: 2 },
          { id: 18, name: 'Metodología de Enfermería: Fases del Proceso de Enfermería', displayNumber: 3 },
          { id: 19, name: 'Gestión de servicios sanitarios: Tendencias actuales', displayNumber: 4 },
          { id: 20, name: 'Derechos y deberes de los usuarios del sistema sanitario de la Región de Murcia en relación…', displayNumber: 5 },
          { id: 21, name: 'Salud Publica en enfermería', displayNumber: 6 },
          { id: 22, name: 'Fundamento y Metodología de la investigación cuantitativa y cualitativa en enfermería.', displayNumber: 7 },
          { id: 23, name: 'Enfermería Basada en la Evidencia', displayNumber: 8 },
          { id: 24, name: 'Sistemas de información utilizados en Atención Primaria y Atención Especializada: Historia c…', displayNumber: 9 },
          { id: 25, name: 'Principios fundamentales de la Bioética', displayNumber: 10 },
          { id: 26, name: 'Atención domiciliaria: Concepto y etapas de la visita domiciliaria', displayNumber: 11 },
          { id: 27, name: 'Hospitalización a domicilio', displayNumber: 12 },
          { id: 28, name: 'Salud de la comunidad', displayNumber: 13 },
          { id: 29, name: 'La educación para la Salud individual, grupal y comunitaria: Concepto, metodología y técnica…', displayNumber: 14 },
          { id: 30, name: 'Técnicas y habilidades de comunicación: Relación enfermera paciente', displayNumber: 15 },
          { id: 31, name: 'Prevención y promoción de la salud: Concepto', displayNumber: 16 },
          { id: 32, name: 'Inmunizaciones: Concepto', displayNumber: 17 },
          { id: 33, name: 'Higiene en centros sanitarios: Conceptos generales', displayNumber: 18 },
          { id: 34, name: 'Infección nosocomial', displayNumber: 19 },
          { id: 35, name: 'Administración de fármacos por diferentes vías', displayNumber: 20 },
          { id: 36, name: 'Clasificación general de medicamentos', displayNumber: 21 },
          { id: 37, name: 'Actuación de Enfermería en el uso y autorización de dispensación de medicamentos: Real Decre…', displayNumber: 22 },
          { id: 38, name: 'Alimentación y nutrición: Clasificación de los alimentos', displayNumber: 23 },
          { id: 39, name: 'Promoción de la actividad física y la alimentación equilibrada', displayNumber: 24 },
          { id: 40, name: 'Valoración y cuidados de enfermería en personas con nutrición enteral y parenteral', displayNumber: 25 },
          { id: 41, name: 'Valoración y cuidados de enfermería en la mujer gestante: Alimentación, higiene y cambios fi…', displayNumber: 26 },
          { id: 42, name: 'Cuidados de la mujer en el climaterio', displayNumber: 27 },
          { id: 43, name: 'Valoración y cuidados de enfermería del recién nacido sano', displayNumber: 28 },
          { id: 44, name: 'Cuidados de enfermería en la infancia', displayNumber: 29 },
          { id: 45, name: 'Valoración y cuidados de enfermería del recién nacido enfermo', displayNumber: 30 },
          { id: 46, name: 'Valoración y cuidados de enfermería en el niño hospitalizado', displayNumber: 31 },
          { id: 47, name: 'Cuidados de enfermería en la adolescencia', displayNumber: 32 },
          { id: 48, name: 'Planificación familiar', displayNumber: 33 },
          { id: 49, name: 'Perspectiva de género en el proceso de salud/enfermedad', displayNumber: 34 },
          { id: 50, name: 'Valoración y cuidados de enfermería en pacientes con procesos infectocontagiosos: Hepatitis,…', displayNumber: 35 },
          { id: 51, name: 'Valoración y cuidados de enfermería a pacientes al final de la vida', displayNumber: 36 },
          { id: 52, name: 'Desarrollo de la conducta humana: Etapas del desarrollo', displayNumber: 37 },
          { id: 53, name: 'Valoración y cuidados de enfermería a personas con problemas de salud mental', displayNumber: 38 },
          { id: 54, name: 'Valoración y cuidados de enfermería a personas con problemas neurológicos: Accidente cerebro…', displayNumber: 39 },
          { id: 55, name: 'Valoración y cuidados de enfermería a personas con problemas respiratorios: Insuficiencia re…', displayNumber: 40 },
          { id: 56, name: 'Valoración y cuidados de enfermería a personas con problemas cardiovasculares: Insuficiencia…', displayNumber: 41 },
          { id: 57, name: 'Valoración y cuidados de enfermería a personas con problemas en el sistema renal: Insuficien…', displayNumber: 42 },
          { id: 58, name: 'Valoración y cuidados de enfermería a personas con problemas en el sistema músculo-esquelético', displayNumber: 43 },
          { id: 59, name: 'Valoración y cuidados de enfermería a personas con problemas gastrointestinales', displayNumber: 44 },
          { id: 60, name: 'Valoración y cuidados de enfermería a personas con problemas de los órganos de los sentidos:…', displayNumber: 45 },
          { id: 61, name: 'Valoración y cuidados de enfermería a personas con problemas oncológicos: Principales problemas', displayNumber: 46 },
          { id: 62, name: 'Valoración y cuidados de enfermería a personas con problemas endocrinológicos: Diabetes', displayNumber: 47 },
          { id: 63, name: 'Conceptos de urgencia y emergencia', displayNumber: 48 },
          { id: 64, name: 'Valoración y cuidados de enfermería ante situaciones críticas: Politraumatizados, quemados,…', displayNumber: 49 },
          { id: 65, name: 'Valoración y cuidados de enfermería del paciente quirúrgico: Preoperatorio e intraoperatorio', displayNumber: 50 },
          { id: 66, name: 'El paciente trasplantado: valoración y cuidados del paciente donante y el receptor', displayNumber: 51 },
          { id: 67, name: 'Cuidados de enfermería en pacientes postquirúrgicos', displayNumber: 52 },
          { id: 68, name: 'Manejo de heridas: Cuidados generales de la piel', displayNumber: 53 },
          { id: 69, name: 'Seguridad del paciente', displayNumber: 54 },
          { id: 70, name: 'Atención de enfermería a personas en situación de dependencia', displayNumber: 55 },
          { id: 71, name: 'Participación en la formación sanitaria especializada y de grado en enfermería', displayNumber: 56 },
        ],
      },
    ],
    totalTopics: 71,
