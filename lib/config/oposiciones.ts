    ...
    blocks: [
      ...
      },
      {
        ...
        themes: [
          { id: 16, name: 'Procedimientos declarativos LEC' },
          { id: 17, name: 'Procedimientos de ejecución LEC' },
          { id: 18, name: 'Procedimientos penales LECrim' },
          { id: 19, name: 'Procedimientos contencioso-administrativos' },
          { id: 20, name: 'El proceso laboral' },
          { id: 21, name: 'Los actos procesales' },
          { id: 22, name: 'Las resoluciones de los órganos judiciales' },
          { id: 23, name: 'Comunicación con otros tribunales y autoridades' },
          { id: 24, name: 'Comunicación a las partes' },
    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 3, name: 'El Gobierno y la Administración. Protección de Datos' },
          { id: 4, name: 'La organización territorial del Estado' },
          { id: 5, name: 'Fuentes del derecho público' },
          { id: 6, name: 'El procedimiento administrativo. Ley 39/2015' },
          { id: 7, name: 'Fases del procedimiento administrativo' },
          { id: 8, name: 'Actos administrativos. Recursos' },
          { id: 9, name: 'Prevención de Riesgos Laborales' },
          { id: 10, name: 'Ley 40/2015. Organización administrativa' },
        ],
      },
      {
        id: 'bloque2',
        ...
        themes: [
          ...
          { id: 12, name: 'El Municipio. Empadronamiento' },
          { id: 13, name: 'Competencias y órganos municipales' },
          { id: 14, name: 'Ordenanzas y Reglamentos locales' },
          { id: 15, name: 'Órganos colegiados locales' },
          { id: 16, name: 'Personal de la Administración Local' },
          ...
          { id: 20, name: 'Igualdad y violencia de género' },
          { id: 21, name: 'Administración Electrónica (PIAE)' },
        ],
      },
    ],
    totalTopics: 21,
