...
export const OPOSICIONES: Oposicion[] = [
  ...
  // ========================================
  {
    ...
    blocks: [
      {
        id: 'bloque1',
        title: 'Temario Cuerpo Auxiliar Administrativo',
        ...
        themes: [
          ...
          { id: 15, name: 'Gestión de la documentación en los archivos de oficina' },
          { id: 16, name: 'Registros electrónicos de entrada y salida de documentos' },
          { id: 17, name: 'El documento y el expediente administrativo' },
          { id: 18, name: 'Legalizaciones de firmas y validación en la administración electrónica' },
          { id: 19, name: 'Administración educativa no universitaria' },
          { id: 20, name: 'Derechos de la ciudadanía en sus relaciones con las Administraciones Públicas' },
          { id: 21, name: 'La ciudadanía como destinataria de los servicios públicos' },
          { id: 22, name: 'La comunicación escrita en la Administración' },
          { id: 23, name: 'La comunicación oral en la Administración' },
          { id: 24, name: 'Fuentes del derecho administrativo' },
          { id: 25, name: 'La organización administrativa: los órganos administrativos' },
          { id: 26, name: 'El acto administrativo' },
          { id: 27, name: 'El procedimiento administrativo: principios e interesados' },
          { id: 28, name: 'Fases del procedimiento administrativo' },
          { id: 29, name: 'Revisión de los actos administrativos' },
          { id: 30, name: 'La responsabilidad de las Administraciones Públicas' },
          { id: 31, name: 'Correspondencia y paquetería' },
        ],
      },
    ],
    totalTopics: 31,
