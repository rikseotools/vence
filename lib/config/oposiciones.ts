...
const OfficialExamConvocatoriaSchema = z.object({
  ...
  // ⚠️ Este archivo se BUNDLEA AL CLIENTE → TODO lo que pongas aquí viaja al
  // navegador y es visible en el código fuente, aunque no se renderice. Por eso
  // NO existe un campo "interno": NUNCA metas estado de QA, fuentes de import,
  // "verificado por IA", pendientes, content_hash, needs_human, etc. en NINGÚN
  // campo. SOLO info de cara al opositor (plazas, turno, ejercicios). La
  // trazabilidad interna va en commits/memoria/docs, NO en la config.
...
export const OPOSICIONES: Oposicion[] = [
  // Subalternos del Parlamento de Andalucía
  {
    id: 'subalterno_parlamento_andalucia',
    slug: 'subalterno-parlamento-andalucia',
    positionType: 'subalterno_parlamento_andalucia',
    examScoring: { penaltyDivisor: 3, source: 'Acuerdo de 8 de julio de 2026, de la Mesa del Parlamento de Andalucía, base 7.1.6 (BOJA núm. 136, de 16 de julio de 2026): cada contestación errónea se penaliza con un tercio del valor de una respuesta acertada.' },
    hasPsychometricTest: true,
    name: 'Subalternos del Parlamento de Andalucía',
    shortName: 'Subalternos Parlamento Andalucía',
    emoji: '🏛️',
    badge: 'C2',
    color: 'green',
    administracion: 'autonomica',
    aliases: ['subalterno parlamento de andalucia', 'subalternos parlamento andalucia', 'subalterno parlamento andaluz', 'ordenanza parlamento de andalucia', 'oposicion subalterno parlamento andalucia'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Bloque I. Materia General y de Andalucía',
        subtitle: 'Constitución, Estatuto de Autonomía, instituciones andaluzas, empleo público y Unión Europea',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución española de 1978' },
          { id: 2, name: 'La Corona, las Cortes Generales y los poderes del Estado' },
          { id: 3, name: 'La organización territorial del Estado' },
          { id: 4, name: 'La autonomía andaluza y el Estatuto de Autonomía' },
          { id: 5, name: 'Otras instituciones de autogobierno de Andalucía' },
          { id: 6, name: 'El protocolo y los símbolos de Andalucía' },
          { id: 7, name: 'El Parlamento de Andalucía: sedes e historia' },
          { id: 8, name: 'El Estatuto de Gobierno y Régimen Interior del Parlamento' },
          { id: 9, name: 'El personal al servicio del Parlamento de Andalucía' },
          { id: 10, name: 'La Unión Europea' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Bloque II. El Parlamento de Andalucía',
        subtitle: 'Régimen, organización, funciones y funcionamiento de la Cámara',
        icon: '🏛️',
        themes: [
          { id: 11, name: 'El Parlamento de Andalucía (I): régimen parlamentario' },
          { id: 12, name: 'El Parlamento de Andalucía (II): composición y órganos' },
          { id: 13, name: 'El Parlamento de Andalucía (III): diputados, grupos y comisiones' },
          { id: 14, name: 'El Parlamento de Andalucía (IV): funciones y procedimiento legislativo' },
          { id: 15, name: 'El Parlamento de Andalucía (V): funcionamiento' },
        ],
      },
    ],
    totalTopics: 15,
    navLinks: [
      ...
      { href: '/subalterno-parlamento-andalucia', label: 'Mi Oposición', icon: '🏛️', featured: true },
      { href: '/subalterno-parlamento-andalucia/temario', label: 'Temario', icon: '📚' },
      { href: '/subalterno-parlamento-andalucia/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // Administrativo de la Comunidad Autónoma de Aragón
  {
    id: 'administrativo_aragon',
    slug: 'administrativo-aragon',
    positionType: 'administrativo_aragon',
    examScoring: { penaltyDivisor: 3, source: 'BOA nº 247, 23/12/2025 (proceso 25/0102), base 6: dos ejercicios tipo test (80 preguntas teóricas + 40 prácticas, 4 alternativas). Cada acierto +1; respuesta errónea resta 0,3333 (−1/3); no contestadas no penalizan.' },
    hasPsychometricTest: false,
    name: 'Administrativo de la Comunidad Autónoma de Aragón',
    shortName: 'Administrativo (DGA)',
    emoji: '📋',
    badge: 'C1',
    color: 'blue',
    administracion: 'autonomica',
    aliases: ['administrativo dga', 'administrativo gobierno de aragon', 'cuerpo ejecutivo escala general administrativa aragon', 'administrativo aragon c1'],
    blocks: [
      {
        id: 'bloque1',
        ...
        themes: [
          ...
          { id: 4, name: 'El Gobierno y la Administración de Aragón' },
          { id: 5, name: 'La prevención de riesgos laborales' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '📚',
        themes: [
          { id: 101, name: 'Fuentes del Derecho Administrativo', displayNumber: 1 },
          { id: 102, name: 'El procedimiento administrativo', displayNumber: 2 },
          { id: 103, name: 'Los interesados. Transparencia y acceso a la información', displayNumber: 3 },
          { id: 104, name: 'La actividad de las AAPP. El acto administrativo', displayNumber: 4 },
          { id: 105, name: 'Revisión de actos y recursos administrativos', displayNumber: 5 },
          { id: 106, name: 'La jurisdicción contencioso-administrativa', displayNumber: 6 },
          { id: 107, name: 'Los bienes de las Administraciones Públicas', displayNumber: 7 },
          { id: 108, name: 'Los Contratos del Sector Público (I)', displayNumber: 8 },
          { id: 109, name: 'Los Contratos del Sector Público (II)', displayNumber: 9 },
          { id: 110, name: 'Potestad sancionadora y responsabilidad patrimonial', displayNumber: 10 },
          { id: 111, name: 'Personal de la Administración de Aragón (I)', displayNumber: 11 },
          { id: 112, name: 'Personal de la Administración de Aragón (II)', displayNumber: 12 },
          { id: 113, name: 'Personal de la Administración de Aragón (III)', displayNumber: 13 },
          { id: 114, name: 'Personal de la Administración de Aragón (IV)', displayNumber: 14 },
          { id: 115, name: 'Personal de la Administración de Aragón (V). Personal laboral', displayNumber: 15 },
          { id: 116, name: 'Personal de la Administración de Aragón (VI). Seguridad Social', displayNumber: 16 },
          { id: 117, name: 'Personal de la Administración de Aragón (VII). Negociación colectiva', displayNumber: 17 },
          { id: 118, name: 'Personal de la Administración de Aragón (VIII). Personal estatutario y de Justicia', displayNumber: 18 },
          { id: 119, name: 'El Presupuesto: concepto, clases y principios', displayNumber: 19 },
          { id: 120, name: 'El Presupuesto de la Comunidad Autónoma de Aragón', displayNumber: 20 },
          { id: 121, name: 'Régimen de financiación de la Comunidad Autónoma de Aragón', displayNumber: 21 },
          { id: 122, name: 'Los créditos presupuestarios y sus modificaciones', displayNumber: 22 },
          { id: 123, name: 'La ejecución del presupuesto', displayNumber: 23 },
          { id: 124, name: 'Pagos y anticipos de caja fija', displayNumber: 24 },
          { id: 125, name: 'Contabilidad pública', displayNumber: 25 },
          { id: 126, name: 'Control del gasto público. Cámara de Cuentas de Aragón', displayNumber: 26 },
          { id: 127, name: 'Retribuciones y nóminas', displayNumber: 27 },
          { id: 128, name: 'Informática básica', displayNumber: 28 },
          { id: 129, name: 'La Red Internet', displayNumber: 29 },
          { id: 130, name: 'La Administración electrónica', displayNumber: 30 },
        ],
      },
    ],
    totalTopics: 35,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/administrativo-aragon', label: 'Mi Oposición', icon: '📋', featured: true },
      { href: '/administrativo-aragon/temario', label: 'Temario', icon: '📚' },
      { href: '/administrativo-aragon/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // Auxiliar de Archivos, Bibliotecas y Museos del Estado — Sección Museos
  {
    id: 'auxiliar_museos_estado',
    slug: 'auxiliar-museos-estado',
    positionType: 'auxiliar_museos_estado',
    examScoring: { penaltyDivisor: 3, source: 'BOE-A-2025-23564 (Res. 13/11/2025): Escala Auxiliar de ABM, subgrupo C2, sección Museos. Penalización -1/3 por error, en blanco no penaliza.' },
    hasPsychometricTest: false,
    name: 'Auxiliar de Archivos, Bibliotecas y Museos del Estado (Sección Museos)',
    shortName: 'Auxiliar de Museos (Estado)',
    emoji: '📋',
    badge: 'C2',
    color: 'blue',
    administracion: 'estado',
    aliases: ['museos', 'auxiliar de museos', 'auxiliar museos', 'museos estado', 'auxiliar archivos bibliotecas museos', 'museos ministerio cultura', 'museologia', 'conservador de museos'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Legislación',
        ...
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución Española de 1978: estructura y contenido. Los derechos y liberta' },
          { id: 2, name: 'Las Cortes Generales. El Congreso de los Diputados. El Senado. Funciones de las ' },
          { id: 3, name: 'Organización territorial del Estado. Las Comunidades Autónomas. Los Estatutos de' },
          { id: 4, name: 'La Administración General del Estado. Órganos superiores. Órganos directivos. De' },
          { id: 5, name: 'Disposiciones administrativas y actos administrativos. El procedimiento administ' },
          { id: 6, name: 'El Real Decreto Legislativo 5/2015, de 30 de octubre, por el que se aprueba el t' },
          { id: 7, name: 'Políticas de Igualdad de Género. La Ley Orgánica 3/2007, de 22 de marzo, para la' },
          { id: 8, name: 'La Ley 19/2013, de 9 de diciembre, de transparencia, acceso a la información púb' },
          { id: 9, name: 'El Ministerio Cultura. Organización, competencias, organismos y políticas públic' },
          { id: 10, name: 'La legislación española sobre el Patrimonio Histórico Español' },
          { id: 11, name: 'Normativa estatal en materia de museos. El Reglamento de Museos de Titularidad E' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '📜',
        themes: [
          { id: 101, name: 'Culturas prerromanas en la Península Ibérica', displayNumber: 1 },
          { id: 102, name: 'Manifestaciones culturales de la Hispania Romana', displayNumber: 2 },
          { id: 103, name: 'La huella cultural islámica en la Península Ibérica', displayNumber: 3 },
          { id: 104, name: 'Arte y Cultura en la Alta Edad Media: El Románico en los Reinos Peninsulares', displayNumber: 4 },
          { id: 105, name: 'Arte y Cultura en la Baja Edad Media: El Gótico en los Reinos Peninsulares', displayNumber: 5 },
          { id: 106, name: 'El Renacimiento en España', displayNumber: 6 },
          { id: 107, name: 'El siglo XVII español', displayNumber: 7 },
          { id: 108, name: 'Aspectos culturales de la Ilustración española', displayNumber: 8 },
          { id: 109, name: 'Cultura y sociedad en España durante el siglo XIX', displayNumber: 9 },
          { id: 110, name: 'Manifestaciones culturales del siglo XX en España: vanguardias y cultura de masa', displayNumber: 10 },
        ],
      },
      {
        id: 'bloque3',
        title: 'Museología (parte específica)',
        subtitle: null,
        icon: '🏛️',
        themes: [
          { id: 201, name: 'El Museo Nacional del Prado: historia de la institución y formación de sus colec', displayNumber: 1 },
          { id: 202, name: 'El Museo Nacional Centro de Arte Reina Sofía: historia de la institución y forma', displayNumber: 2 },
          { id: 203, name: 'Museo Nacional de Escultura: historia de la institución y formación de sus colec', displayNumber: 3 },
          { id: 204, name: 'El Legado del marqués de la Vega-Inclán: la creación del Museo del Greco, el Mus', displayNumber: 4 },
          { id: 205, name: 'El Museo Sorolla: historia de la institución y formación de sus colecciones', displayNumber: 5 },
          { id: 206, name: 'El Museo Cerralbo: historia de la institución y formación de sus colecciones', displayNumber: 6 },
          { id: 207, name: 'El Museo Nacional de Artes Decorativas: historia de la institución y formación d', displayNumber: 7 },
          { id: 208, name: 'El Museo Nacional de Cerámica y de las Artes Suntuarias ‘González Martí’: histor', displayNumber: 8 },
          { id: 209, name: 'El Museo del Traje. CIPE: historia de la institución y formación de sus coleccio', displayNumber: 9 },
          { id: 210, name: 'El Museo Nacional de Antropología: historia de la institución y formación de sus', displayNumber: 10 },
          { id: 211, name: 'El Museo de América: historia de la institución y formación de sus colecciones', displayNumber: 11 },
          { id: 212, name: 'El Museo Arqueológico Nacional: historia de la institución y formación de sus co', displayNumber: 12 },
          { id: 213, name: 'El Museo Nacional de Arte Romano: historia de la institución y formación de sus ', displayNumber: 13 },
          { id: 214, name: 'El Museo Nacional y Centro de Investigación de Altamira: historia de la instituc', displayNumber: 14 },
          { id: 215, name: 'El Museo Sefardí: historia de la institución y formación de sus colecciones', displayNumber: 15 },
          { id: 216, name: 'El Museo Nacional de Arqueología Subacuática: historia de la institución y forma', displayNumber: 16 },
          { id: 217, name: 'El Museo Nacional de Ciencias Naturales y el Museo Nacional de Ciencia y Tecnolo', displayNumber: 17 },
          { id: 218, name: 'Los museos del Ministerio de Defensa: historia y formación de las colecciones de', displayNumber: 18 },
          { id: 219, name: 'Concepto de museo y sus funciones. La organización interna de los museos', displayNumber: 19 },
          { id: 220, name: 'Modos de ingreso y movimiento de los fondos museográficos', displayNumber: 20 },
          { id: 221, name: 'Criterios básicos de la conservación preventiva. Criterios para la planificación', displayNumber: 21 },
          { id: 222, name: 'El sistema de documentación en el museo. La aplicación de documentación y gestió', displayNumber: 22 },
          { id: 223, name: 'El público en el museo. El museo como espacio de aprendizaje', displayNumber: 23 },
          { id: 224, name: 'El discurso expositivo: exposición permanente y exposición temporal', displayNumber: 24 },
        ],
      },
      {
        id: 'bloque4',
        ...
        icon: '🧩',
        themes: [
          { id: 301, name: 'Adaptación de la documentación del museo al modelo normalizado del Sistema Integ', displayNumber: 1 },
          { id: 302, name: 'Movimiento y control de fondos museográficos', displayNumber: 2 },
          { id: 303, name: 'Control de la instalación expositiva y de la visita a la misma', displayNumber: 3 },
        ],
      },
    ],
    totalTopics: 48,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/auxiliar-museos-estado', label: 'Mi Oposición', icon: '📋', featured: true },
      { href: '/auxiliar-museos-estado/temario', label: 'Temario', icon: '📚' },
      { href: '/auxiliar-museos-estado/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // Auxiliar de Archivos, Bibliotecas y Museos del Estado (Sección Archivos)
  {
    id: 'auxiliar_archivos_estado',
    slug: 'auxiliar-archivos-estado',
    positionType: 'auxiliar_archivos_estado',
    examScoring: { penaltyDivisor: 3, source: 'BOE-A-2025-23564: ejercicio único, 100 preguntas (Bloques I-III) + 2 supuestos de 15 (Bloque IV); penalización -1/3 por error, en blanco no penaliza.' },
    hasPsychometricTest: false,
    name: 'Auxiliar de Archivos, Bibliotecas y Museos del Estado (Sección Archivos)',
    shortName: 'Auxiliar de Archivos (Estado)',
    emoji: '📋',
    badge: 'C2',
    color: 'blue',
    administracion: 'estado',
    aliases: ['archivero', 'archivos', 'auxiliar de archivos', 'archivos estado', 'auxiliar archivos bibliotecas museos', 'archivos ministerio cultura'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Legislación',
        ...
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución Española de 1978. La Corona' },
          { id: 2, name: 'Cortes Generales, Gobierno y Poder Judicial' },
          { id: 3, name: 'Organización territorial del Estado' },
          { id: 4, name: 'La Administración General del Estado' },
          { id: 5, name: 'Disposiciones y actos administrativos. El procedimiento' },
          { id: 6, name: 'El Estatuto Básico del Empleado Público' },
          { id: 7, name: 'Políticas de Igualdad de Género' },
          { id: 8, name: 'Transparencia y derecho de acceso en los archivos' },
          { id: 9, name: 'El Ministerio de Cultura y los archivos' },
          { id: 10, name: 'Archivos y Patrimonio Documental en la Ley 16/1985' },
          { id: 11, name: 'El Sistema Español de Archivos (RD 1708/2011)' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '🏛️',
        themes: [
          { id: 101, name: 'Los reinos de la península Ibérica en la Edad Media', displayNumber: 1 },
          { id: 102, name: 'Ciencia, técnica y cultura escrita en la Edad Media peninsular', displayNumber: 2 },
          { id: 103, name: 'El Renacimiento español', displayNumber: 3 },
          { id: 104, name: 'El Barroco español', displayNumber: 4 },
          { id: 105, name: 'El Siglo de las Luces', displayNumber: 5 },
          { id: 106, name: 'Cultura y sociedad en España en el siglo XIX', displayNumber: 6 },
          { id: 107, name: 'Cultura y pensamiento en España en el siglo XX', displayNumber: 7 },
        ],
      },
      {
        id: 'bloque3',
        title: 'Archivística (parte específica)',
        subtitle: null,
        icon: '🗂️',
        themes: [
          { id: 201, name: 'Concepto de Archivística, archivo y documento', displayNumber: 1 },
          { id: 202, name: 'Principio de procedencia, ciclo vital y continuum', displayNumber: 2 },
          { id: 203, name: 'Tipos de archivos según el ciclo vital', displayNumber: 3 },
          { id: 204, name: 'Ingreso, instalación, transferencias y préstamos', displayNumber: 4 },
          { id: 205, name: 'Identificación y clasificación de fondos', displayNumber: 5 },
          { id: 206, name: 'Valoración, selección y eliminación. La CSCDA', displayNumber: 6 },
          { id: 207, name: 'La ordenación de documentos', displayNumber: 7 },
          { id: 208, name: 'Las agrupaciones documentales', displayNumber: 8 },
          { id: 209, name: 'Agrupaciones, niveles e instrumentos de descripción', displayNumber: 9 },
          { id: 210, name: 'La planificación descriptiva y la descripción multinivel', displayNumber: 10 },
          { id: 211, name: 'La CNEDA y el Portal de Archivos Españoles (PARES)', displayNumber: 11 },
          { id: 212, name: 'Soportes documentales, conservación y restauración', displayNumber: 12 },
          { id: 213, name: 'Reprografía, digitalización y preservación digital', displayNumber: 13 },
          { id: 214, name: 'El edificio, los depósitos y las instalaciones del archivo', displayNumber: 14 },
          { id: 215, name: 'La función social y cultural de los archivos', displayNumber: 15 },
          { id: 216, name: 'La atención de usuarios y el acceso a los archivos', displayNumber: 16 },
          { id: 217, name: 'La Administración Española de los Archivos Estatales', displayNumber: 17 },
          { id: 218, name: 'El Sistema Español de Archivos y el Consejo de Cooperación Archivística', displayNumber: 18 },
          { id: 219, name: 'El Sistema de Archivos de la AGE y sus Organismos Públicos', displayNumber: 19 },
          { id: 220, name: 'La Subdirección General de los Archivos Estatales. CIDA', displayNumber: 20 },
          { id: 221, name: 'Archivo de la Corona de Aragón y Real Chancillería de Valladolid', displayNumber: 21 },
          { id: 222, name: 'Archivo General de Simancas y Archivo General de Indias', displayNumber: 22 },
          { id: 223, name: 'Archivo Histórico Nacional y Archivo Histórico de la Nobleza', displayNumber: 23 },
          { id: 224, name: 'Archivo General de la Administración y Archivo Histórico de los Movimientos Sociales', displayNumber: 24 },
          { id: 225, name: 'Archivo de la Guerra Civil y Centro Documental de la Memoria Histórica', displayNumber: 25 },
          { id: 226, name: 'Los Archivos Históricos Provinciales', displayNumber: 26 },
          { id: 227, name: 'El Sistema Archivístico de la Defensa', displayNumber: 27 },
        ],
      },
      {
        id: 'bloque4',
        ...
        icon: '🧩',
        themes: [
          { id: 301, name: 'Ordenación, control y conservación de fondos (práctico)', displayNumber: 1 },
          { id: 302, name: 'Atención e información a investigadores y usuarios (práctico)', displayNumber: 2 },
          { id: 303, name: 'Apoyo a procesos técnicos (práctico)', displayNumber: 3 },
        ],
      },
    ],
    totalTopics: 48,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/auxiliar-archivos-estado', label: 'Mi Oposición', icon: '📋', featured: true },
      { href: '/auxiliar-archivos-estado/temario', label: 'Temario', icon: '📚' },
      { href: '/auxiliar-archivos-estado/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // Auxiliar de Archivos, Bibliotecas y Museos del Estado (Sección Bibliotecas)
  {
    id: 'auxiliar_biblioteca_estado',
    slug: 'auxiliar-biblioteca-estado',
    positionType: 'auxiliar_biblioteca_estado',
    examScoring: { penaltyDivisor: 3, source: 'BOE-A-2024-15769 (Res. 25/07/2024) y BOE-A-2025-23564: 100 preguntas + 2 supuestos de 15; penalizacion -1/3 por error, en blanco no penaliza.' },
    hasPsychometricTest: false,
    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 3, name: 'Organización territorial del Estado' },
          { id: 4, name: 'La Administración General del Estado' },
          { id: 5, name: 'El procedimiento administrativo' },
          { id: 6, name: 'El Estatuto Básico del Empleado Público' },
          { id: 7, name: 'Políticas de Igualdad de Género' },
          { id: 8, name: 'Transparencia y buen gobierno' },
          { id: 9, name: 'El Ministerio de Cultura' },
          { id: 10, name: 'Patrimonio Histórico y Propiedad Intelectual' },
          { id: 11, name: 'Legislación bibliotecaria española' },
        ],
      },
      {
        id: 'bloque2',
        ...
        themes: [
          ...
          { id: 102, name: 'El libro y las bibliotecas en los siglos XVI y XVII', displayNumber: 2 },
          { id: 103, name: 'El libro y las bibliotecas en los siglos XVIII y XIX', displayNumber: 3 },
          { id: 104, name: 'El libro y las bibliotecas en el siglo XX', displayNumber: 4 },
        ],
      },
      {
        id: 'bloque3',
        ...
        themes: [
          ...
          { id: 202, name: 'Bibliotecas nacionales', displayNumber: 2 },
          { id: 203, name: 'Bibliotecas públicas', displayNumber: 3 },
          { id: 204, name: 'Bibliotecas universitarias', displayNumber: 4 },
          { id: 205, name: 'Bibliotecas especializadas', displayNumber: 5 },
          { id: 206, name: 'Las hemerotecas', displayNumber: 6 },
          { id: 207, name: 'Los documentos y sus clases', displayNumber: 7 },
          { id: 208, name: 'Colecciones especiales', displayNumber: 8 },
          { id: 209, name: 'Instalaciones y equipamiento', displayNumber: 9 },
          { id: 210, name: 'Preservación y conservación', displayNumber: 10 },
          { id: 211, name: 'Digitalización y preservación digital', displayNumber: 11 },
          { id: 212, name: 'Selección y adquisición de fondos', displayNumber: 12 },
          { id: 213, name: 'El depósito legal', displayNumber: 13 },
          { id: 214, name: 'Proceso técnico: registro y sellado', displayNumber: 14 },
          { id: 215, name: 'Proceso técnico: ordenación y depósitos', displayNumber: 15 },
          { id: 216, name: 'Descripción bibliográfica y control de autoridades', displayNumber: 16 },
          { id: 217, name: 'El formato MARC 21', displayNumber: 17 },
          { id: 218, name: 'Números de identificación bibliográfica', displayNumber: 18 },
          { id: 219, name: 'Clasificación. La CDU', displayNumber: 19 },
          { id: 220, name: 'Servicios a los lectores: referencia y ALFIN', displayNumber: 20 },
          { id: 221, name: 'Servicios a los lectores: lectura en sala y libre acceso', displayNumber: 21 },
          { id: 222, name: 'Tipos de préstamos. Préstamo interbibliotecario', displayNumber: 22 },
          { id: 223, name: 'Bibliografías. Bibliografías nacionales', displayNumber: 23 },
          { id: 224, name: 'Sistemas integrados de gestión bibliotecaria', displayNumber: 24 },
          { id: 225, name: 'OPAC y herramientas de descubrimiento', displayNumber: 25 },
          { id: 226, name: 'Internet: historia y gobernanza', displayNumber: 26 },
          { id: 227, name: 'Cooperación bibliotecaria', displayNumber: 27 },
          { id: 228, name: 'Principales catálogos colectivos', displayNumber: 28 },
          { id: 229, name: 'Bibliotecas digitales y OAI-PMH', displayNumber: 29 },
          { id: 230, name: 'Agentes de la producción y difusión del libro', displayNumber: 30 },
        ],
      },
      {
        id: 'bloque4',
        ...
        themes: [
          ...
          { id: 302, name: 'Atención a investigadores y usuarios (práctico)', displayNumber: 2 },
          { id: 303, name: 'Apoyo a procesos técnicos (práctico)', displayNumber: 3 },
        ],
      },
    ],
    ...
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/auxiliar-biblioteca-estado', label: 'Mi Oposición', icon: '📋', featured: true },
      { href: '/auxiliar-biblioteca-estado/temario', label: 'Temario', icon: '📚' },
      { href: '/auxiliar-biblioteca-estado/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
  // AYUDANTES EN EJECUCIÓN PENAL - EUSKADI (C1) - Administración Penitenciaria Vasca
  // ========================================
  {
    id: 'ayudantes_ejecucion_penal_pais_vasco',
    slug: 'ayudantes-ejecucion-penal-pais-vasco',
    positionType: 'ayudantes_ejecucion_penal_pais_vasco',
    examScoring: { penaltyDivisor: 3, source: 'Provisional (concurso-oposición BOPV nº80, 04/05/2026); penalización exacta pendiente de bases específicas del IVAP. confidence:baja' },
    hasPsychometricTest: false,
    name: 'Escala de Ayudantes en Ejecución Penal - Administración Penitenciaria de Euskadi',
    shortName: 'Ayudantes Ejecución Penal (Euskadi)',
    emoji: '🔒',
    badge: 'C1',
    color: 'green',
    administracion: 'autonomica',
    aliases: ['ayudantes ejecucion penal', 'ejecucion penal euskadi', 'prisiones pais vasco', 'ayudantes prisiones euskadi', 'penitenciaria vasca', 'ayudante ejecucion penal c1', 'funcionario prisiones euskadi', 'carcel euskadi'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Parte general',
        subtitle: 'Derecho constitucional y administrativo, organización de Euskadi',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'Constitución' },
          { id: 2, name: 'El Poder Judicial' },
          { id: 3, name: 'Derecho de la Unión Europea' },
          { id: 4, name: 'La organización territorial del Estado' },
          { id: 5, name: 'Organización política y administrativa de la CAE' },
          { id: 6, name: 'El Gobierno abierto' },
          { id: 7, name: 'Normativa autonómica para la igualdad de mujeres y hombres y vidas libres de violencia m…' },
          { id: 8, name: 'Normalización lingüística del uso del euskera en la administración general' },
          { id: 9, name: 'Personal al servicio de las administraciones públicas vascas' },
          { id: 10, name: 'Estructura y organización del empleo en las Administraciones Públicas vascas' },
          { id: 11, name: 'Prevención de riesgos laborales' },
          { id: 12, name: 'Aspectos básicos de la protección de datos personales' },
          { id: 13, name: 'La actividad de las Administraciones Públicas' },
          { id: 14, name: 'Administración Electrónica' },
          { id: 15, name: 'El expediente administrativo' },
          { id: 16, name: 'Fuentes del derecho administrativo' },
          { id: 17, name: 'El acto administrativo' },
          { id: 18, name: 'Procedimiento administrativo' },
          { id: 19, name: 'Revisión de los actos' },
          { id: 20, name: 'La responsabilidad de las Administraciones Públicas y sus autoridades y demás Personal' },
          { id: 21, name: 'Derechos de la ciudadanía en sus relaciones con las Administraciones Públicas' },
          { id: 22, name: 'Comunicación oral' },
          { id: 23, name: 'Elementos de la conducta humana' },
          { id: 24, name: 'Organización social de la prisión' },
          { id: 25, name: 'El comportamiento social' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Parte específica',
        subtitle: 'Derecho Penal, proceso penal y Derecho Penitenciario',
        icon: '🔒',
        themes: [
          { id: 101, name: 'Marco general del Derecho Penal', displayNumber: 1 },
          { id: 102, name: 'El delito', displayNumber: 2 },
          { id: 103, name: 'Principales delitos', displayNumber: 3 },
          { id: 104, name: 'Las penas', displayNumber: 4 },
          { id: 105, name: 'El proceso penal', displayNumber: 5 },
          { id: 106, name: 'Fases del procedimiento penal', displayNumber: 6 },
          { id: 107, name: 'Medidas cautelares', displayNumber: 7 },
          { id: 108, name: 'Concepto, contenido y fuentes del Derecho Penitenciario', displayNumber: 8 },
          { id: 109, name: 'Actividad penitenciaria en CAPV', displayNumber: 9 },
          { id: 110, name: 'Naturaleza, fines y principios de la actividad penitenciaria', displayNumber: 10 },
          { id: 111, name: 'Establecimientos penitenciarios', displayNumber: 11 },
          { id: 112, name: 'Organización penitenciaria', displayNumber: 12 },
          { id: 113, name: 'Régimen penitenciario', displayNumber: 13 },
          { id: 114, name: 'Seguridad penitenciaria', displayNumber: 14 },
          { id: 115, name: 'Régimen disciplinario', displayNumber: 15 },
          { id: 116, name: 'Tipología del régimen', displayNumber: 16 },
          { id: 117, name: 'Tratamiento penitenciario', displayNumber: 17 },
          { id: 118, name: 'Programas y actividades', displayNumber: 18 },
          { id: 119, name: 'Trabajo penitenciario', displayNumber: 19 },
          { id: 120, name: 'Permisos y salidas programadas', displayNumber: 20 },
          { id: 121, name: 'Libertad y excarcelación', displayNumber: 21 },
          { id: 122, name: 'Formas Especiales de Ejecución', displayNumber: 22 },
          { id: 123, name: 'Prestaciones y servicios', displayNumber: 23 },
          { id: 124, name: 'Oficina Única de Gestión', displayNumber: 24 },
          { id: 125, name: 'Gestión de penas de prisión', displayNumber: 25 },
          { id: 126, name: 'Gestión económica y patrimonial', displayNumber: 26 },
          { id: 127, name: 'El control de la actividad penitenciaria', displayNumber: 27 },
          { id: 128, name: 'Igualdad de trato en el contexto penitenciario', displayNumber: 28 },
        ],
      },
    ],
    totalTopics: 53,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/ayudantes-ejecucion-penal-pais-vasco', label: 'Mi Oposición', icon: '🔒', featured: true },
      { href: '/ayudantes-ejecucion-penal-pais-vasco/temario', label: 'Temario', icon: '📚' },
      { href: '/ayudantes-ejecucion-penal-pais-vasco/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
  // ETGOA - SANIDAD Y CONSUMO (A1) - Organismos Autónomos del Estado
  // ========================================
  {
    id: 'etgoa_sanidad_consumo',
    slug: 'etgoa-sanidad-consumo',
    positionType: 'etgoa_sanidad_consumo',
    examScoring: { penaltyDivisor: 4, source: 'BOE-A-2025-26903 (ETGOA Sanidad y Consumo, Ejercicio 1): acierto +1, error -0,25 -> 1/4; en blanco no penaliza. confidence:alta' },
    hasPsychometricTest: false,
    name: 'Escala Técnica de Gestión de Organismos Autónomos (ETGOA) - Sanidad y Consumo',
    shortName: 'ETGOA Sanidad y Consumo',
    emoji: '🔬',
    badge: 'A1',
    color: 'cyan',
    administracion: 'estado',
    aliases: ['etgoa', 'organismos autonomos', 'escala tecnica organismos autonomos', 'etgoa sanidad', 'etgoa consumo', 'sanidad y consumo', 'gestion organismos autonomos', 'etgoa a1'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Parte común',
        subtitle: 'Derecho constitucional y administrativo, empleo público y UE',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución Española de 1978' },
          { id: 2, name: 'El Poder Judicial' },
          { id: 3, name: 'La Corona' },
          { id: 4, name: 'El Gobierno' },
          { id: 5, name: 'La Administración Pública en la Constitución Española' },
          { id: 6, name: 'Las fuentes del Derecho Administrativo' },
          { id: 7, name: 'La Ley 39/2015, de 1 de octubre, de Procedimiento Administrativo Común de las Administra…' },
          { id: 8, name: 'La Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público (I)' },
          { id: 9, name: 'La Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público (II)' },
          { id: 10, name: 'La Ley 9/2017, de 8 de noviembre, de Contratos del Sector Público' },
          { id: 11, name: 'Régimen jurídico del personal al servicio de las Administraciones Públicas' },
          { id: 12, name: 'Políticas de igualdad, protección y no discriminación en la Administración General del E…' },
          { id: 13, name: 'Política de integración de las personas con discapacidad' },
          { id: 14, name: 'Ley 31/1995, de 8 de noviembre, de Prevención de Riesgos Laborales' },
          { id: 15, name: 'El Ministerio de Sanidad' },
          { id: 16, name: 'El Ministerio de Derechos Sociales, Consumo y Agenda 2030' },
          { id: 17, name: 'La Organización de Naciones Unidas y otros organismos internacionales en materia sanitaria' },
          { id: 18, name: 'La Organización Mundial de la Salud' },
          { id: 19, name: 'La Unión Europea' },
          { id: 20, name: 'La gobernanza pública y el gobierno abierto' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Área de Consumo (parte específica)',
        subtitle: 'Materia específica — en elaboración',
        icon: '🔬',
        themes: [
          { id: 101, name: 'La configuración constitucional de la sanidad en España', displayNumber: 1 },
          { id: 102, name: 'Normativa básica en materia de Sanidad (I)', displayNumber: 2 },
          { id: 103, name: 'Normativa básica en materia de Sanidad (II)', displayNumber: 3 },
          { id: 104, name: 'El Sistema Nacional de Salud español', displayNumber: 4 },
          { id: 105, name: 'Real Decreto Legislativo 1/2015, de 24 de julio, por el que se aprueba el texto refundid…', displayNumber: 5 },
          { id: 106, name: 'Texto refundido de la Ley General para la Defensa de los Consumidores y Usuarios y otras…', displayNumber: 6 },
          { id: 107, name: 'El derecho de los consumidores a la información', displayNumber: 7 },
          { id: 108, name: 'Ley 28/2015, de 30 de julio, para la defensa de la calidad alimentaria', displayNumber: 8 },
          { id: 109, name: 'La libre circulación de mercancías', displayNumber: 9 },
          { id: 110, name: 'La salud pública en los Tratados de la Unión Europea', displayNumber: 10 },
          { id: 111, name: 'El Consejo de Europa', displayNumber: 11 },
          { id: 112, name: 'Economía de la salud', displayNumber: 12 },
          { id: 113, name: 'La Agencia Europea de Medicamentos', displayNumber: 13 },
          { id: 114, name: 'La lucha contra las resistencias a los antibióticos', displayNumber: 14 },
          { id: 115, name: 'La Dirección General de Consumo del Ministerio de Derechos Sociales, Consumo y Agenda 2030', displayNumber: 15 },
          { id: 116, name: 'El Sistema arbitral de consumo', displayNumber: 16 },
          { id: 117, name: 'El Registro Estatal de Asociaciones de Consumidores y Usuarios', displayNumber: 17 },
          { id: 118, name: 'Régimen jurídico de las subvenciones públicas concedidas a las Asociaciones de Consumido…', displayNumber: 18 },
          { id: 119, name: 'Condiciones Generales de Contratación y Cláusulas Abusivas', displayNumber: 19 },
          { id: 120, name: 'Régimen legal de la competencia desleal para la mejora de la protección de las personas…', displayNumber: 20 },
          { id: 121, name: 'Las medidas europeas en el marco de la protección de las personas consumidoras', displayNumber: 21 },
          { id: 122, name: 'La protección de las personas consumidoras en la Unión Europea', displayNumber: 22 },
          { id: 123, name: 'La Cooperación Institucional entre las administraciones de consumo', displayNumber: 23 },
          { id: 124, name: 'Garantías en relación con los bienes de naturaleza duradera, y en la prestación de servi…', displayNumber: 24 },
          { id: 125, name: 'Regulación de la Unión Europea sobre la protección de los usuarios del transporte aéreo,…', displayNumber: 25 },
          { id: 126, name: 'La potestad sancionadora en materia de consumo prevista en texto refundido de la Ley Gen…', displayNumber: 26 },
          { id: 127, name: 'Reglamento (UE) 2017/2394 del Parlamento Europeo y del Consejo, de 12 de diciembre de 20…', displayNumber: 27 },
          { id: 128, name: 'Reglamento (UE) 2016/425 del Parlamento Europeo y del Consejo, de 9 de marzo de 2016, re…', displayNumber: 28 },
          { id: 129, name: 'Reglamento (UE) 2019/1020 del Parlamento Europeo y del Consejo, de 20 de junio de 2019,…', displayNumber: 29 },
          { id: 130, name: 'Reglamento (UE) 2023/988 del Parlamento Europeo y del Consejo, de 10 de mayo de 2023, re…', displayNumber: 30 },
          { id: 131, name: 'Sistema Safety Gate', displayNumber: 31 },
          { id: 132, name: 'Control a la importación de determinados productos respecto a las normas aplicables en m…', displayNumber: 32 },
          { id: 133, name: 'Seguridad de los juguetes', displayNumber: 33 },
          { id: 134, name: 'Regulación de los contratos de créditos al consumo', displayNumber: 34 },
          { id: 135, name: 'Real Decreto 562/2025 de 1 de julio, relativo a los controles y otras actividades oficia…', displayNumber: 35 },
          { id: 136, name: 'El Registro de intermediarios financieros', displayNumber: 36 },
          { id: 137, name: 'La posición de las personas consumidoras en el ordenamiento jurídico español', displayNumber: 37 },
          { id: 138, name: 'Organismos internacionales con competencia en seguridad alimentaria', displayNumber: 38 },
          { id: 139, name: 'Organismos internacionales relacionados con las políticas de protección de los consumido…', displayNumber: 39 },
          { id: 140, name: 'Norma UNE-EN ISO/IEC 17025', displayNumber: 40 },
          { id: 141, name: 'Requisitos de la Norma UNE-EN ISO/IEC 17025 relativos a la documentación del sistema de…', displayNumber: 41 },
          { id: 142, name: 'Requisitos de la Norma UNE-EN ISO/IEC 17025 relativos a la revisión de solicitudes, ofer…', displayNumber: 42 },
          { id: 143, name: 'Requisitos y criterios de la Norma UNE-EN ISO/IEC 17025 relativos a la validación de los…', displayNumber: 43 },
          { id: 144, name: 'Requisitos de la Norma UNE-EN ISO/IEC 17025 relativos al aseguramiento de la validez de…', displayNumber: 44 },
          { id: 145, name: 'Ensayos de intercomparación', displayNumber: 45 },
          { id: 146, name: 'Requisitos de la Norma UNE-EN ISO/IEC 17025 relativos al equipamiento del laboratorio y…', displayNumber: 46 },
          { id: 147, name: 'Requisitos de la Norma UNE-EN ISO/IEC 17025 relativos al informe de resultados de ensayo…', displayNumber: 47 },
          { id: 148, name: 'Requisitos de la Norma UNE-EN ISO/IEC 17025 relativos a los Trabajos No Conformes, Accio…', displayNumber: 48 },
          { id: 149, name: 'Requisitos de la Norma UNE-EN ISO/IEC 17025 relativos a las auditorías internas y a las…', displayNumber: 49 },
          { id: 150, name: 'Alcances de acreditación cerrados y flexibles (Categorías de ensayos)', displayNumber: 50 },
          { id: 151, name: 'Errores en el análisis cuantitativo', displayNumber: 51 },
          { id: 152, name: 'Parámetros fundamentales de la estadística descriptiva', displayNumber: 52 },
          { id: 153, name: 'Estadística aplicada a los resultados analíticos', displayNumber: 53 },
          { id: 154, name: 'Tipos de errores en análisis instrumental', displayNumber: 54 },
          { id: 155, name: 'Métodos de calibración en el análisis instrumental', displayNumber: 55 },
          { id: 156, name: 'Técnicas para la preparación de muestras en análisis físico-químicos de alimentos', displayNumber: 56 },
          { id: 157, name: 'Sistemas de extracción', displayNumber: 57 },
          { id: 158, name: 'Análisis gravimétrico y volumétrico', displayNumber: 58 },
          { id: 159, name: 'Separaciones cromatográficas', displayNumber: 59 },
          { id: 160, name: 'Cromatografía en fase gaseosa', displayNumber: 60 },
          { id: 161, name: 'Cromatografía de líquidos de alta resolución', displayNumber: 61 },
          { id: 162, name: 'Cromatografía iónica', displayNumber: 62 },
          { id: 163, name: 'Espectrometría de absorción molecular ultravioleta y visible', displayNumber: 63 },
          { id: 164, name: 'Espectrometría de fluorescencia molecular', displayNumber: 64 },
          { id: 165, name: 'Espectrometría de Infrarrojo', displayNumber: 65 },
          { id: 166, name: 'Espectrometría de emisión de plasma', displayNumber: 66 },
          { id: 167, name: 'Espectrometría de absorción atómica de llama', displayNumber: 67 },
          { id: 168, name: 'Espectrometría de absorción atómica con atomización electrotérmica', displayNumber: 68 },
          { id: 169, name: 'Espectrometría de resonancia magnética nuclear', displayNumber: 69 },
          { id: 170, name: 'Espectrometría de masas', displayNumber: 70 },
          { id: 171, name: 'Espectrometría de masas en acoplamiento con otras técnicas', displayNumber: 71 },
          { id: 172, name: 'Técnicas analíticas de electroforesis', displayNumber: 72 },
          { id: 173, name: 'Técnicas automáticas de análisis', displayNumber: 73 },
          { id: 174, name: 'Microscopía óptica y electrónica', displayNumber: 74 },
          { id: 175, name: 'Análisis sensorial', displayNumber: 75 },
          { id: 176, name: 'El laboratorio de microbiología', displayNumber: 76 },
          { id: 177, name: 'Estructura del ADN', displayNumber: 77 },
          { id: 178, name: 'Inmunoquímica', displayNumber: 78 },
          { id: 179, name: 'Detección de materias extrañas en alimentos', displayNumber: 79 },
          { id: 180, name: 'Agentes de mejora de alimentos', displayNumber: 80 },
          { id: 181, name: 'Agentes de mejora de alimentos', displayNumber: 81 },
          { id: 182, name: 'Otros agentes de mejora de alimentos', displayNumber: 82 },
          { id: 183, name: 'Materiales destinados a entrar en contacto con los alimentos', displayNumber: 83 },
          { id: 184, name: 'Preparados para lactantes y preparados de continuación', displayNumber: 84 },
          { id: 185, name: 'Contaminantes presentes en los productos alimenticios', displayNumber: 85 },
          { id: 186, name: 'Productos eléctricos', displayNumber: 86 },
          { id: 187, name: 'Marcado CE en productos de consumo', displayNumber: 87 },
          { id: 188, name: 'La red de alerta nacional', displayNumber: 88 },
          { id: 189, name: 'Reglamento (UE) 1169/2011 del Parlamento Europeo y del Consejo, 25 de octubre de 2011, s…', displayNumber: 89 },
          { id: 190, name: 'Información obligatoria que debe figurar en el etiquetado de los productos no alimentici…', displayNumber: 90 },
          { id: 191, name: 'Marco general de principios y normas en materia de acreditación y vigilancia del mercado…', displayNumber: 91 },
          { id: 192, name: 'Real Decreto 579/2017, de 9 de junio, por el que se regulan determinados aspectos relati…', displayNumber: 92 },
          { id: 193, name: 'Reglamento (CE) n.º 648/2004 del Parlamento Europeo y del Consejo, de 31 de marzo de 200…', displayNumber: 93 },
          { id: 194, name: 'Real Decreto 1718/1995, de 27 de octubre, por el que se regula el etiquetado de los mate…', displayNumber: 94 },
          { id: 195, name: 'Regulación de los controles oficiales realizados sobre productos alimenticios', displayNumber: 95 },
          { id: 196, name: 'Plan Nacional de Control Oficial de la Cadena Alimentaria', displayNumber: 96 },
          { id: 197, name: 'Reglamento (UE) n.º 1007/2011 del Parlamento Europeo y del Consejo, de 27 de septiembre…', displayNumber: 97 },
          { id: 198, name: 'Reglamento (UE) 2022/2065 del Parlamento Europeo y del Consejo de 19 de octubre de 2022…', displayNumber: 98 },
          { id: 199, name: 'Directiva (UE) 2024/1799 del Parlamento Europeo y del Consejo, de 13 de junio de 2024, p…', displayNumber: 99 },
          { id: 200, name: 'Directiva (UE) 2024/2853 del Parlamento Europeo y del Consejo, de 23 de octubre de 2024,…', displayNumber: 100 },
        ],
      },
    ],
    totalTopics: 120,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/etgoa-sanidad-consumo', label: 'Mi Oposición', icon: '🔬', featured: true },
      { href: '/etgoa-sanidad-consumo/temario', label: 'Temario', icon: '📚' },
      { href: '/etgoa-sanidad-consumo/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
  ...
  // ========================================
  {
    ...
    positionType: 'escala_administrativa_universidad_de_granada',
    examScoring: { penaltyDivisor: 4, source: 'BOE-A-2026-14538, ANEXO II (Sistema de Corrección): NPP = NPC − NPI/NRAP, NRAP=4 → cada errónea resta 1/4. confidence:alta' },
    name: 'Escala Administrativa - Universidad de Granada',
    shortName: 'Administrativa U. Granada',
    emoji: '🎓',
    badge: 'C1',
    color: 'red',
    administracion: 'autonomica',
    ...
    blocks: [
      {
        id: 'materia1',
        title: 'I. Organización Universitaria y Gestión de la UGR (12 temas)',
        subtitle: null,
        icon: '🎓',
        themes: [
          { id: 101, displayNumber: 1, name: 'Ley Orgánica 2/2023 del Sistema Universitario (LOSU)' },
          { id: 102, displayNumber: 2, name: 'Estatutos de la Universidad de Granada' },
          { id: 103, displayNumber: 3, name: 'Ley 1/2026 Universitaria para Andalucía' },
          { id: 104, displayNumber: 4, name: 'RD 822/2021: organización de las enseñanzas universitarias' },
          { id: 105, displayNumber: 5, name: 'RD 99/2011: enseñanzas oficiales de doctorado' },
          { id: 106, displayNumber: 6, name: 'RD 1002/2010: expedición de títulos universitarios oficiales' },
          { id: 107, displayNumber: 7, name: 'RD 534/2024: acceso y admisión a enseñanzas universitarias de Grado' },
          { id: 108, displayNumber: 8, name: 'Reglamento de Permanencia de la UGR (Grado y Máster)' },
          { id: 109, displayNumber: 9, name: 'Reglamento de Gestión Académica de la UGR' },
          { id: 110, displayNumber: 10, name: 'Normativa de evaluación y de calificación de los estudiantes de la UGR' },
          { id: 111, displayNumber: 11, name: 'Reglamento de Régimen Económico-Financiero de la UGR' },
          { id: 112, displayNumber: 12, name: 'Presupuesto de la UGR 2026: bases de ejecución, indemnizaciones y gestión patrimonial' },
        ],
      },
      {
        id: 'materia2',
        title: 'II. Derecho Administrativo y Función Pública (10 temas)',
        subtitle: null,
        icon: '⚖️',
        themes: [
          { id: 201, displayNumber: 1, name: 'La Constitución Española: Títulos preliminar, I y IV' },
          { id: 202, displayNumber: 2, name: 'Ley 39/2015 del Procedimiento Administrativo Común' },
          { id: 203, displayNumber: 3, name: 'Ley 40/2015 de Régimen Jurídico del Sector Público' },
          { id: 204, displayNumber: 4, name: 'RD 203/2021: actuación del sector público por medios electrónicos' },
          { id: 205, displayNumber: 5, name: 'LO 3/2018 de Protección de Datos y garantía de los derechos digitales' },
          { id: 206, displayNumber: 6, name: 'Texto Refundido de la Ley del Estatuto Básico del Empleado Público (TREBEP)' },
          { id: 207, displayNumber: 7, name: 'Ley 5/2023 de la Función Pública de Andalucía' },
          { id: 208, displayNumber: 8, name: 'Igualdad de mujeres y hombres (LO 3/2007) e igualdad de las personas trans y LGTBI (Ley 4/2023)' },
          { id: 209, displayNumber: 9, name: 'Ley 38/2003 General de Subvenciones' },
          { id: 210, displayNumber: 10, name: 'Ley 9/2017 de Contratos del Sector Público (tipos de contratos)' },
        ],
      },
      {
        id: 'materia3',
        title: 'III. Herramientas Google Workspace (versión web) (4 temas)',
        subtitle: null,
        icon: '🌐',
        themes: [
          { id: 301, displayNumber: 1, name: 'Google Calendar: planificación y gestión de agendas (web)' },
          { id: 302, displayNumber: 2, name: 'Google Meet: videocomunicación (web)' },
          { id: 303, displayNumber: 3, name: 'Google Forms: recopilación de datos (web)' },
          { id: 304, displayNumber: 4, name: 'Google Drive: almacenamiento, organización y compartición (web)' },
        ],
      },
      {
        id: 'materia4',
        title: 'IV. Ofimática: Microsoft Word y Excel (2 temas)',
        subtitle: null,
        icon: '🖥️',
        themes: [
          { id: 401, displayNumber: 1, name: 'Microsoft Word' },
          { id: 402, displayNumber: 2, name: 'Microsoft Excel' },
        ],
      },
    ],
    aliases: ['administrativa granada', 'administrativo universidad de granada', 'escala administrativa ugr', 'administrativos ugr', 'oposiciones administrativa granada', 'pas administrativo granada'],
    navLinks: [
      { href: '/escala-administrativa-universidad-de-granada', label: 'Mi Oposición', icon: '🎓', featured: true },
      { href: '/escala-administrativa-universidad-de-granada/temario', label: 'Temario', icon: '📚' },
      { href: '/escala-administrativa-universidad-de-granada/test', label: 'Tests', icon: '🎯' },
    ],
  },
  {
  ...
  // ========================================
  {
    ...
    positionType: 'ayudante_instituciones_penitenciarias',
    examScoring: { penaltyDivisor: 3, source: 'Bases convocatoria Cuerpo de Ayudantes de IIPP (OEP 2024/2025): respuestas incorrectas restan un tercio del valor de una correcta (1/3); en blanco no penalizan. confidence:alta' },
    name: 'Ayudante de Instituciones Penitenciarias',
    shortName: 'Ayudante II.PP.',
    emoji: '🔒',
    badge: 'C1',
    color: 'blue',
    administracion: 'estado',
    blocks: [
      {
        id: 'bloque1',
        title: 'Bloque I: Organización del Estado, Derecho Administrativo y Gestión',
        subtitle: 'Organización del Estado, Derecho Administrativo, Personal y Gestión Financiera',
        icon: '🏛️',
        themes: [
          { id: 1, name: 'La Constitución Española de 1978' },
          { id: 2, name: 'El Poder Judicial' },
          { id: 3, name: 'El Gobierno' },
          { id: 4, name: 'La organización territorial del Estado' },
          { id: 5, name: 'La Unión Europea' },
          { id: 6, name: 'El Ministerio del Interior' },
          { id: 7, name: 'El personal de Instituciones Penitenciarias' },
          { id: 8, name: 'Régimen jurídico del personal de las Administraciones Públicas' },
          { id: 9, name: 'El acceso al empleo público' },
          { id: 10, name: 'Los Contratos del Sector Público' },
          { id: 11, name: 'Ley de Voluntariado' },
          { id: 12, name: 'Políticas Públicas' },
          { id: 13, name: 'El Gobierno Abierto' },
          { id: 14, name: 'La actividad de las Administraciones Públicas' },
          { id: 15, name: 'El Derecho Administrativo' },
          { id: 16, name: 'El Régimen Jurídico de las Administraciones Públicas' },
          { id: 17, name: 'El Presupuesto' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Bloque II: Derecho Penal',
        subtitle: 'Derecho Penal',
        icon: '⚖️',
        themes: [
          { id: 101, displayNumber: 1, name: 'El Derecho Penal' },
          { id: 102, displayNumber: 2, name: 'Los delitos' },
          { id: 103, displayNumber: 3, name: 'Las personas criminalmente responsables y las penas (1)' },
          { id: 104, displayNumber: 4, name: 'Las penas (2)' },
          { id: 105, displayNumber: 5, name: 'Principales delitos (1)' },
          { id: 106, displayNumber: 6, name: 'Principales delitos (2)' },
          { id: 107, displayNumber: 7, name: 'Principales delitos (3)' },
          { id: 108, displayNumber: 8, name: 'Principales delitos (4)' },
          { id: 109, displayNumber: 9, name: 'La jurisdicción penal' },
          { id: 110, displayNumber: 10, name: 'Procesos y recursos penales' },
        ],
      },
      {
        id: 'bloque3',
        title: 'Bloque III: Derecho Penitenciario',
        subtitle: 'Derecho Penitenciario',
        icon: '🔒',
        themes: [
          { id: 201, displayNumber: 1, name: 'La regulación supranacional en materia penitenciaria' },
          { id: 202, displayNumber: 2, name: 'El Derecho Penitenciario' },
          { id: 203, displayNumber: 3, name: 'La relación jurídico-penitenciaria' },
          { id: 204, displayNumber: 4, name: 'Prestaciones de la Administración Penitenciaria' },
          { id: 205, displayNumber: 5, name: 'El Régimen Penitenciario (1)' },
          { id: 206, displayNumber: 6, name: 'El Régimen Penitenciario (2)' },
          { id: 207, displayNumber: 7, name: 'Los establecimientos penitenciarios' },
          { id: 208, displayNumber: 8, name: 'Régimen cerrado y abierto' },
          { id: 209, displayNumber: 9, name: 'El Tratamiento Penitenciario (1)' },
          { id: 210, displayNumber: 10, name: 'El Tratamiento Penitenciario (2)' },
          { id: 211, displayNumber: 11, name: 'La relación laboral en el medio penitenciario' },
          { id: 212, displayNumber: 12, name: 'Los permisos de salida' },
          { id: 213, displayNumber: 13, name: 'Libertad y excarcelación' },
          { id: 214, displayNumber: 14, name: 'Formas especiales de ejecución de la pena de prisión' },
          { id: 215, displayNumber: 15, name: 'El régimen disciplinario' },
          { id: 216, displayNumber: 16, name: 'El control de la actividad penitenciaria' },
          { id: 217, displayNumber: 17, name: 'El modelo organizativo penitenciario' },
          { id: 218, displayNumber: 18, name: 'El régimen administrativo de los establecimientos penitenciarios (1)' },
          { id: 219, displayNumber: 19, name: 'El régimen administrativo de los establecimientos penitenciarios (2)' },
          { id: 220, displayNumber: 20, name: 'El régimen económico de los establecimientos penitenciarios' },
        ],
      },
      {
        id: 'bloque4',
        title: 'Bloque IV: Conducta Humana',
        subtitle: 'Conducta Humana',
        icon: '🧠',
        themes: [
          { id: 301, displayNumber: 1, name: 'Elementos de la conducta humana' },
          { id: 302, displayNumber: 2, name: 'Organización social de la prisión' },
          { id: 303, displayNumber: 3, name: 'El comportamiento social' },
        ],
      },
    ],
    totalTopics: 50,
    aliases: ['iipp', 'penitenciarias', 'ayudante prisiones', 'instituciones penitenciarias', 'ayudante penitenciario', 'prisiones'],
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/ayudante-instituciones-penitenciarias', label: 'Mi Oposición', icon: '🔒', featured: true },
      { href: '/ayudante-instituciones-penitenciarias/temario', label: 'Temario', icon: '📚' },
      { href: '/ayudante-instituciones-penitenciarias/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
  ...
  // ========================================
  // ENFERMERO/A SACYL CASTILLA Y LEÓN (A2)
  // ========================================
  {
    id: 'enfermero_sacyl',
    slug: 'enfermero-sacyl',
    positionType: 'enfermero_sacyl',
    examScoring: { penaltyDivisor: 3, source: 'Bases SACYL Enfermero (Orden SAN/1396/2025, BOCyL nº238 11/12/2025): test con penalización de errores 1/(nº opciones-1) = 1/3 (4 alternativas). confidence:media — confirmar en bases específicas' },
    name: 'Enfermero/a del Servicio de Salud de Castilla y León (SACYL)',
    shortName: 'Enfermero SACYL',
    emoji: '🏥',
    badge: 'A2',
    color: 'green',
    administracion: 'autonomica',
    aliases: ['enfermero sacyl', 'enfermera sacyl', 'enfermero castilla y leon', 'enfermeria castilla y leon', 'enfermero sacyl castilla leon', 'sacyl enfermeria', 'enfermero a2 castilla leon'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Parte General',
        subtitle: 'Legislación sanitaria, organización del SACYL, calidad y bioética',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'Estructura de la Consejería de Sanidad y de la Gerencia Regional de Salud' },
          { id: 2, name: 'Estatuto Jurídico del personal estatutario (Ley 2/2007) y Ley 8/2010 de Ordenación del Sistema de Salud de CyL' },
          { id: 3, name: 'Autonomía del Paciente (Ley 41/2002)' },
          { id: 4, name: 'Derechos y deberes de las personas en relación con la salud (Ley 8/2003), LOPD e Historia Clínica en CyL' },
          { id: 5, name: 'Plan de gestión de la calidad y seguridad del paciente de la Gerencia Regional de Salud de CyL' },
          { id: 6, name: 'Responsabilidad profesional, código deontológico y bioética; instrucciones previas y comités de ética en CyL' },
          { id: 7, name: 'Programas de Salud y Guías de Práctica Clínica de la GRS; Prevención de Riesgos Laborales' },
          { id: 8, name: 'Sistemas de información en Atención Especializada y Primaria; registros de enfermería; CIAP-2, CIE-11, NANDA' },
          { id: 9, name: 'No discriminación por orientación sexual e identidad de género; igualdad y violencia de género; discapacidad y dependencia' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Parte Específica',
        subtitle: 'Enfermería clínica, salud pública, investigación y metodología',
        icon: '💉',
        themes: [
          { id: 10, name: 'Metodología de Enfermería: proceso, patrones de Gordon, NANDA, NOC y NIC' },
          { id: 11, name: 'Metodología de Investigación: diseño, técnicas cuantitativas y cualitativas, fases' },
          { id: 12, name: 'Investigación básica y aplicada en enfermería' },
          { id: 13, name: 'Estadística descriptiva e inferencial' },
          { id: 14, name: 'Epidemiología: método, diseños, vigilancia epidemiológica y EDO' },
          { id: 15, name: 'Demografía Sanitaria: concepto, tendencias e indicadores demográficos' },
          { id: 16, name: 'Salud Pública: determinantes, indicadores y priorización' },
          { id: 17, name: 'Prevención y promoción de la salud; factores de riesgo por etapas de la vida' },
          { id: 18, name: 'Inmunizaciones: vacunas, pautas y calendario de vacunaciones de Castilla y León' },
          { id: 19, name: 'Educación para la Salud individual, grupal y comunitaria' },
          { id: 20, name: 'Estrategia de promoción y prevención en el SNS; grupos de autoayuda; participación comunitaria' },
          { id: 21, name: 'Comunicación y relación interpersonal; entrevista clínica; apoyo emocional' },
          { id: 22, name: 'Higiene en centros sanitarios; esterilización; infección nosocomial; aislamiento; residuos sanitarios' },
          { id: 23, name: 'Desarrollo de la conducta humana' },
          { id: 24, name: 'Problemas psicosociales y de adaptación del paciente hospitalizado' },
          { id: 25, name: 'Sexualidad, reproducción, métodos anticonceptivos y prevención de ITS' },
          { id: 26, name: 'Cuidados de enfermería en la mujer gestante y puérpera; urgencias obstétrico-ginecológicas' },
          { id: 27, name: 'Cuidados de enfermería del niño sano de 0 a 14 años; urgencias pediátricas' },
          { id: 28, name: 'Cuidados de enfermería del niño enfermo; recién nacido de bajo peso y prematuro' },
          { id: 29, name: 'Cuidados de enfermería en procesos infectocontagiosos (hepatitis, tuberculosis, SIDA, meningitis)' },
          { id: 30, name: 'Cuidados de enfermería en el anciano; valoración geriátrica integral; Plan Gerontológico' },
          { id: 31, name: 'Grandes síndromes geriátricos; prevención de accidentes; apoyo al cuidador' },
          { id: 32, name: 'Cuidados de enfermería en el enfermo terminal; dolor y duelo' },
          { id: 33, name: 'Cuidados de enfermería en problemas de salud mental; urgencias psiquiátricas' },
          { id: 34, name: 'Plan Nacional de Drogas; drogodependencias' },
          { id: 35, name: 'Malos tratos: detección y prevención; violencia de género' },
          { id: 36, name: 'Urgencias y emergencias: politraumatizados, quemados, shock, PCR y RCP' },
          { id: 37, name: 'Priorización y triaje en situaciones de múltiples víctimas y catástrofes' },
          { id: 38, name: 'Proceso de Atención al Paciente Pluripatológico Complejo' },
          { id: 39, name: 'Clasificación de medicamentos; farmacovigilancia; conservación' },
          { id: 40, name: 'Administración de medicamentos: vías, técnicas y cálculo de dosis' },
          { id: 41, name: 'Alimentación y nutrición; dietas terapéuticas' },
          { id: 42, name: 'Cuidados de enfermería en nutrición enteral y parenteral' },
          { id: 43, name: 'Cuidados de enfermería en problemas neurológicos (ACV, epilepsia, EM, ELA, coma)' },
          { id: 44, name: 'Cuidados de enfermería en problemas respiratorios (IRA, EPOC, asma, TEP)' },
          { id: 45, name: 'Cuidados de enfermería en problemas cardiovasculares (IC, SCA, HTA)' },
          { id: 46, name: 'Cuidados de enfermería en problemas del sistema renal y urológico; diálisis y trasplante' },
          { id: 47, name: 'Cuidados de enfermería en problemas endocrinológicos (diabetes, tiroides)' },
          { id: 48, name: 'Cuidados de enfermería en problemas del sistema músculo-esquelético; traumatismos' },
          { id: 49, name: 'Cuidados de enfermería en problemas gastrointestinales' },
          { id: 50, name: 'Cuidados de enfermería en problemas hematológicos; transfusiones' },
          { id: 51, name: 'Cuidados de enfermería en problemas oftalmológicos y otorrinolaringológicos' },
          { id: 52, name: 'Cuidados de enfermería en problemas oncológicos; manipulación de citostáticos' },
          { id: 53, name: 'Cuidados de enfermería del paciente quirúrgico' },
          { id: 54, name: 'Cuidados de enfermería en problemas de la piel; úlceras por presión (Braden, Norton, EMINA)' },
        ],
      },
    ],
    totalTopics: 54,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/enfermero-sacyl', label: 'Mi Oposición', icon: '🏥', featured: true },
      { href: '/enfermero-sacyl/temario', label: 'Temario', icon: '📚' },
      { href: '/enfermero-sacyl/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
  ...
  // ========================================
  // ENFERMERO/A SMS MURCIA (A2)
  // ========================================
  {
    id: 'enfermero_sms',
    slug: 'enfermero-sms',
    positionType: 'enfermero_sms',
    examScoring: { penaltyDivisor: 4, source: 'BORM nº289 16/12/2025 anuncio 6070 (OPE 2022-2024 SMS), bases 11.4/12.4: erróneas restan 1/4. confidence:alta' },
    name: 'Enfermero/a del Servicio Murciano de Salud (SMS)',
    shortName: 'Enfermero SMS',
    emoji: '🏥',
    badge: 'A2',
    color: 'red',
    administracion: 'autonomica',
    aliases: ['enfermera murcia', 'enfermero murcia', 'enfermeria sms', 'due murcia', 'enfermero servicio murciano de salud', 'oposiciones enfermeria murcia', 'sms enfermeria'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Parte Común',
        subtitle: 'Legislación sanitaria, bioética, epidemiología e investigación',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución Española: derechos y deberes fundamentales; la protección de la salud en la…' },
          { id: 2, name: 'Ley 14/1986, de 25 de abril, General de Sanidad: la organización general del sistema sanitar…' },
          { id: 3, name: 'Ley 3/2009, de 11 de mayo, de los derechos y deberes de los usuarios del Sistema Sanitario d…' },
          { id: 4, name: 'Las prestaciones del Sistema Nacional de Salud en la Ley 16/2003, de 28 de mayo: ordenación;…' },
          { id: 5, name: 'Clasificación del personal, situaciones administrativas e incompatibilidades en la Ley 5/200…' },
          { id: 6, name: 'La Ley 44/2003, de 21 de noviembre, de ordenación de las profesiones sanitarias: profesiones…' },
          { id: 7, name: 'Ley 31/1995, de 8 de noviembre, de prevención de Riesgos Laborales: objeto, ámbito de aplica…' },
          { id: 8, name: 'Ley Orgánica 3/2007, de 22 de marzo: el principio de igualdad y la tutela contra la discrimi…' },
          { id: 9, name: 'Principios fundamentales de la Bioética: dilemas éticos; inteligencia artificial' },
          { id: 10, name: 'Calidad en el Sistema Nacional de Salud: características de la atención sanitaria' },
          { id: 11, name: 'Epidemiología: concepto y método epidemiológico' },
          { id: 12, name: 'Metodología de investigación cuantitativa: conceptos generales' },
          { id: 13, name: 'Fundamentos de la investigación cualitativa: principales diseños y métodos' },
          { id: 14, name: 'Salud Pública: concepto' },
          { id: 15, name: 'Demografía sanitaria: concepto y tendencias de la población española' },
        ],
      },
      {
        id: 'bloque2',
        title: 'Parte Específica',
        subtitle: 'Cuidados de enfermería, metodología y clínica',
        icon: '💉',
        themes: [
          { id: 16, name: 'Marco conceptual y modelos de enfermería' },
          { id: 17, name: 'Organización de los cuidados enfermeros en Atención Primaria y Atención Especializada' },
          { id: 18, name: 'Metodología de Enfermería: Fases del Proceso de Enfermería' },
          { id: 19, name: 'Gestión de servicios sanitarios: Tendencias actuales' },
          { id: 20, name: 'Derechos y deberes de los usuarios del sistema sanitario de la Región de Murcia en relación…' },
          { id: 21, name: 'Salud Publica en enfermería' },
          { id: 22, name: 'Fundamento y Metodología de la investigación cuantitativa y cualitativa en enfermería.' },
          { id: 23, name: 'Enfermería Basada en la Evidencia' },
          { id: 24, name: 'Sistemas de información utilizados en Atención Primaria y Atención Especializada: Historia c…' },
          { id: 25, name: 'Principios fundamentales de la Bioética' },
          { id: 26, name: 'Atención domiciliaria: Concepto y etapas de la visita domiciliaria' },
          { id: 27, name: 'Hospitalización a domicilio' },
          { id: 28, name: 'Salud de la comunidad' },
          { id: 29, name: 'La educación para la Salud individual, grupal y comunitaria: Concepto, metodología y técnica…' },
          { id: 30, name: 'Técnicas y habilidades de comunicación: Relación enfermera paciente' },
          { id: 31, name: 'Prevención y promoción de la salud: Concepto' },
          { id: 32, name: 'Inmunizaciones: Concepto' },
          { id: 33, name: 'Higiene en centros sanitarios: Conceptos generales' },
          { id: 34, name: 'Infección nosocomial' },
          { id: 35, name: 'Administración de fármacos por diferentes vías' },
          { id: 36, name: 'Clasificación general de medicamentos' },
          { id: 37, name: 'Actuación de Enfermería en el uso y autorización de dispensación de medicamentos: Real Decre…' },
          { id: 38, name: 'Alimentación y nutrición: Clasificación de los alimentos' },
          { id: 39, name: 'Promoción de la actividad física y la alimentación equilibrada' },
          { id: 40, name: 'Valoración y cuidados de enfermería en personas con nutrición enteral y parenteral' },
          { id: 41, name: 'Valoración y cuidados de enfermería en la mujer gestante: Alimentación, higiene y cambios fi…' },
          { id: 42, name: 'Cuidados de la mujer en el climaterio' },
          { id: 43, name: 'Valoración y cuidados de enfermería del recién nacido sano' },
          { id: 44, name: 'Cuidados de enfermería en la infancia' },
          { id: 45, name: 'Valoración y cuidados de enfermería del recién nacido enfermo' },
          { id: 46, name: 'Valoración y cuidados de enfermería en el niño hospitalizado' },
          { id: 47, name: 'Cuidados de enfermería en la adolescencia' },
          { id: 48, name: 'Planificación familiar' },
          { id: 49, name: 'Perspectiva de género en el proceso de salud/enfermedad' },
          { id: 50, name: 'Valoración y cuidados de enfermería en pacientes con procesos infectocontagiosos: Hepatitis,…' },
          { id: 51, name: 'Valoración y cuidados de enfermería a pacientes al final de la vida' },
          { id: 52, name: 'Desarrollo de la conducta humana: Etapas del desarrollo' },
          { id: 53, name: 'Valoración y cuidados de enfermería a personas con problemas de salud mental' },
          { id: 54, name: 'Valoración y cuidados de enfermería a personas con problemas neurológicos: Accidente cerebro…' },
          { id: 55, name: 'Valoración y cuidados de enfermería a personas con problemas respiratorios: Insuficiencia re…' },
          { id: 56, name: 'Valoración y cuidados de enfermería a personas con problemas cardiovasculares: Insuficiencia…' },
          { id: 57, name: 'Valoración y cuidados de enfermería a personas con problemas en el sistema renal: Insuficien…' },
          { id: 58, name: 'Valoración y cuidados de enfermería a personas con problemas en el sistema músculo-esquelético' },
          { id: 59, name: 'Valoración y cuidados de enfermería a personas con problemas gastrointestinales' },
          { id: 60, name: 'Valoración y cuidados de enfermería a personas con problemas de los órganos de los sentidos:…' },
          { id: 61, name: 'Valoración y cuidados de enfermería a personas con problemas oncológicos: Principales problemas' },
          { id: 62, name: 'Valoración y cuidados de enfermería a personas con problemas endocrinológicos: Diabetes' },
          { id: 63, name: 'Conceptos de urgencia y emergencia' },
          { id: 64, name: 'Valoración y cuidados de enfermería ante situaciones críticas: Politraumatizados, quemados,…' },
          { id: 65, name: 'Valoración y cuidados de enfermería del paciente quirúrgico: Preoperatorio e intraoperatorio' },
          { id: 66, name: 'El paciente trasplantado: valoración y cuidados del paciente donante y el receptor' },
          { id: 67, name: 'Cuidados de enfermería en pacientes postquirúrgicos' },
          { id: 68, name: 'Manejo de heridas: Cuidados generales de la piel' },
          { id: 69, name: 'Seguridad del paciente' },
          { id: 70, name: 'Atención de enfermería a personas en situación de dependencia' },
          { id: 71, name: 'Participación en la formación sanitaria especializada y de grado en enfermería' },
        ],
      },
    ],
    totalTopics: 71,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/enfermero-sms', label: 'Mi Oposición', icon: '🏥', featured: true },
      { href: '/enfermero-sms/temario', label: 'Temario', icon: '📚' },
      { href: '/enfermero-sms/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
  // ENFERMERO/A SCS CANTABRIA (A2)
  // ========================================
  {
    id: 'enfermero_scs_cantabria',
    slug: 'enfermero-scs-cantabria',
    positionType: 'enfermero_scs_cantabria',
    examScoring: { penaltyDivisor: 4, source: 'BOC Extra nº27 29/12/2025 Orden SAL/18/2025, base 6.2.a: erróneas restan 0,10/0,40 = 1/4. confidence:alta' },
    name: 'Enfermero/a del Servicio Cántabro de Salud (SCS)',
    shortName: 'Enfermero/a SCS Cantabria',
    emoji: '🏥',
    badge: 'A2',
    color: 'red',
    administracion: 'autonomica',
    aliases: ['enfermera cantabria', 'enfermero cantabria', 'enfermeria scs cantabria', 'due cantabria', 'enfermero servicio cantabro de salud', 'oposiciones enfermeria cantabria', 'scs cantabria enfermeria'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Parte General',
        subtitle: 'Legislación sanitaria estatal y de Cantabria',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'Constitución Española de 1978' },
          { id: 2, name: 'Ley 16/2003, de 28 de mayo, de cohesión y calidad del Sistema Nacional de Salud' },
          { id: 3, name: 'Ley 41/2002, de 14 de noviembre, Básica Reguladora de la Autonomía del Paciente y de Derecho…' },
          { id: 4, name: 'Ley 7/2002, de 10 de diciembre, de Ordenación Sanitaria de Cantabria' },
          { id: 5, name: 'Ley 9/2010, de 23 de diciembre, de personal estatutario de instituciones sanitarias de la Co…' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '💉',
        themes: [
          { id: 6, name: 'Principios fundamentales de la Bioética' },
          { id: 7, name: 'Organización de los cuidados enfermeros en Atención Primaria y Atención Especializada' },
          { id: 8, name: 'La Atención domiciliaria' },
          { id: 9, name: 'Marco conceptual y modelos de enfermería' },
          { id: 10, name: 'Metodología de Enfermería I' },
          { id: 11, name: 'Metodología de Enfermería II' },
          { id: 12, name: 'Sistemas de información utilizados en Atención Especializada y Atención Primaria' },
          { id: 13, name: 'Calidad en el Sistema Nacional de Salud' },
          { id: 14, name: 'Metodología de Investigación' },
          { id: 15, name: 'Investigación enfermería básica' },
          { id: 16, name: 'La docencia como actividad necesaria para el desarrollo profesional' },
          { id: 17, name: 'Epidemiología' },
          { id: 18, name: 'Salud Pública' },
          { id: 19, name: 'Prevención y promoción de la salud' },
          { id: 20, name: 'Inmunizaciones' },
          { id: 21, name: 'La Educación para la Salud individual, grupal y comunitaria' },
          { id: 22, name: 'Criterios para la elaboración de programas de educación para la salud' },
          { id: 23, name: 'Técnicas y habilidades de comunicación y relación interpersonal' },
          { id: 24, name: 'Higiene en centros sanitarios' },
          { id: 25, name: 'Desarrollo de la conducta humana' },
          { id: 26, name: 'El hospital y los problemas psicosociales y de adaptación del paciente hospitalizado' },
          { id: 27, name: 'Sexualidad' },
          { id: 28, name: 'Valoración y cuidados de enfermería en la mujer en las distintas etapas de su vida' },
          { id: 29, name: 'Valoración y cuidados de enfermería en la mujer gestante' },
          { id: 30, name: 'Valoración y cuidados de enfermería del niño sano de cero a catorce años (I)' },
          { id: 31, name: 'Valoración y cuidados de enfermería del niño sano de cero a catorce años (II)' },
          { id: 32, name: 'Valoración y cuidados de enfermería del niño enfermo (I)' },
          { id: 33, name: 'Valoración y cuidados de enfermería del niño enfermo (II)' },
          { id: 34, name: 'Valoración y cuidados de enfermería en pacientes con procesos infectocontagiosos' },
          { id: 35, name: 'Valoración y cuidados de enfermería en el anciano' },
          { id: 36, name: 'Grandes síndromes geriátricos' },
          { id: 37, name: 'Valoración y cuidados de enfermería en el enfermo terminal' },
          { id: 38, name: 'Valoración y cuidados de enfermería a personas con problemas de salud mental' },
          { id: 39, name: 'Drogodependencias' },
          { id: 40, name: 'Malos Tratos' },
          { id: 41, name: 'Urgencias y emergencia' },
          { id: 42, name: 'Valoración y cuidados de enfermería en urgencias' },
          { id: 43, name: 'Priorización y triage en situaciones de múltiples víctimas y catástrofes.' },
          { id: 44, name: 'Clasificación general de los medicamentos' },
          { id: 45, name: 'Administración de medicamentos' },
          { id: 46, name: 'Alimentación y nutrición' },
          { id: 47, name: 'Valoración y cuidados de enfermería en personas con nutrición enteral y parenteral' },
          { id: 48, name: 'Valoración y cuidados de enfermería a personas con problemas neurológicos' },
          { id: 49, name: 'Valoración y cuidados de enfermería a personas con problemas respiratorios (I)' },
          { id: 50, name: 'Valoración y cuidados de enfermería a personas con problemas respiratorios (II)' },
          { id: 51, name: 'Valoración y cuidados de enfermería a personas con problemas cardiovasculares (I)' },
          { id: 52, name: 'Valoración y cuidados de enfermería a personas con problemas cardiovasculares (II)' },
          { id: 53, name: 'Valoración y cuidados de enfermería a personas con problemas en el sistema renal (I)' },
          { id: 54, name: 'Valoración y cuidados de enfermería a personas con problemas en el sistema renal (II)' },
          { id: 55, name: 'Valoración y cuidados de enfermería a personas con problemas endocrinológicos' },
          { id: 56, name: 'Valoración y cuidados de enfermería a personas con problemas en el sistema músculo-esquelético' },
          { id: 57, name: 'Valoración y cuidados de enfermería a personas con problemas gastrointestinales' },
          { id: 58, name: 'Valoración de enfermería a personas con problemas hematológicos' },
          { id: 59, name: 'Valoración y cuidados de enfermería a personas con problemas de los órganos de los sentidos' },
          { id: 60, name: 'Valoración y cuidados de enfermería a personas con problemas oncológicos' },
          { id: 61, name: 'Valoración y cuidados de enfermería del paciente quirúrgico' },
          { id: 62, name: 'Cirugía Mayor Ambulatoria y Cirugía Menor en los Equipos de Atención Primaria' },
          { id: 63, name: 'Valoración y cuidados de enfermería en las úlceras por presión' },
          { id: 64, name: 'Demografía sanitaria' },
          { id: 65, name: 'Prevención de riesgos laborales en las Instituciones Sanitarias' },
        ],
      },
    ],
    totalTopics: 65,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/enfermero-scs-cantabria', label: 'Mi Oposición', icon: '🏥', featured: true },
      { href: '/enfermero-scs-cantabria/temario', label: 'Temario', icon: '📚' },
      { href: '/enfermero-scs-cantabria/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
  ...
  // ========================================
  {
    id: 'enfermero_scs_canarias',
    slug: 'enfermero-scs-canarias',
    positionType: 'enfermero_scs_canarias',
    examScoring: { penaltyDivisor: null, source: 'BOC nº116 13/06/2025 (OPE SCS 2025): "las preguntas contestadas erróneamente no serán consideradas" = SIN penalización. confidence:alta' },
    name: 'Enfermero/a del Servicio Canario de la Salud (SCS)',
    shortName: 'Enfermero SCS',
    emoji: '🏥',
    badge: 'A2',
    color: 'green',
    administracion: 'autonomica',
    aliases: ['enfermera canarias', 'enfermero canarias', 'enfermeria scs', 'due canarias', 'enfermero servicio canario de salud', 'oposiciones enfermeria canarias', 'scs enfermeria'],
    blocks: [
      {
        id: 'bloque1',
        title: 'Temario Común',
        subtitle: 'Legislación sanitaria, bioética y calidad',
        icon: '⚖️',
        themes: [
          { id: 1, name: 'El derecho a la protección de la salud en la Constitución española de 1978' },
          { id: 2, name: 'Ley 44/2003, de ordenación de las profesiones sanitarias' },
          { id: 3, name: 'Ley Orgánica 1/2004, de Medidas de Protección Integral contra la Violencia de Género' },
          { id: 4, name: 'Ley 31/1995, de Prevención de Riesgos Laborales' },
          { id: 5, name: 'El secreto profesional' },
          { id: 6, name: 'Principios fundamentales de la Bioética' },
          { id: 7, name: 'Plan de calidad para el Sistema Nacional de Salud' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '💉',
        themes: [
          { id: 8, name: 'Organización de los cuidados de enfermería en Atención Primaria y Especializada' },
          { id: 9, name: 'Valoración y cuidados de enfermería en la atención y hospitalización del paciente' },
          { id: 10, name: 'Metodología de Enfermería' },
          { id: 11, name: 'Plan de cuidados enfermeros' },
          { id: 12, name: 'Metodología de Investigación Básica e Investigación Aplicada' },
          { id: 13, name: 'Estadística descriptiva' },
          { id: 14, name: 'Enfermería basada en la evidencia' },
          { id: 15, name: 'Epidemiología: concepto. Enfermedades transmisibles de mayor incidencia' },
          { id: 16, name: 'Salud Pública: concepto. Salud y Enfermedad. Indicadores de salud' },
          { id: 17, name: 'Prevención y promoción de la salud' },
          { id: 18, name: 'Inmunizaciones: concepto. Clasificación y tipos de vacunas' },
          { id: 19, name: 'La educación para la salud individual, grupal y comunitaria' },
          { id: 20, name: 'Técnicas y habilidades de comunicación y relación interpersonal' },
          { id: 21, name: 'Gestión y planificación sanitaria' },
          { id: 22, name: 'Higiene en centros sanitarios' },
          { id: 23, name: 'Urgencia y emergencia' },
          { id: 24, name: 'Sexualidad y Reproducción' },
          { id: 25, name: 'Valoración y cuidados de enfermería en la mujer gestante' },
          { id: 26, name: 'Cuidados de enfermería a mujeres en el climaterio' },
          { id: 27, name: 'Valoración y medidas para el fomento de la salud en el niño sano' },
          { id: 28, name: 'Valoración y cuidados de enfermería del niño enfermo' },
          { id: 29, name: 'Cuidados en la adolescencia' },
          { id: 30, name: 'Valoración y cuidados de enfermería en pacientes con proceso infectocontagioso' },
          { id: 31, name: 'Valoración y cuidados de enfermería en el anciano' },
          { id: 32, name: 'Valoración y cuidados de enfermería en el enfermo terminal' },
          { id: 33, name: 'Valoración y cuidados de enfermería a personas con problemas de salud mental' },
          { id: 34, name: 'Clasificación general de los medicamentos' },
          { id: 35, name: 'Precauciones previas a la administración de un fármaco' },
          { id: 36, name: 'Promoción de la actividad física y alimentación equilibrada' },
          { id: 37, name: 'Dietas terapéuticas. Valoración y cuidados de enfermería' },
          { id: 38, name: 'Valoración y cuidados de enfermería a personas con problemas neurológicos' },
          { id: 39, name: 'Valoración y cuidados de enfermería en los problemas oftalmológicos' },
          { id: 40, name: 'Valoración y cuidados de enfermería a personas con problemas respiratorios' },
          { id: 41, name: 'Valoración y cuidados de enfermería a personas con problemas cardiovasculares' },
          { id: 42, name: 'Valoración y cuidados de enfermería a personas con problemas nefrourológicos' },
          { id: 43, name: 'Valoración y cuidados de enfermería a personas con problemas endocrinológicos' },
          { id: 44, name: 'Valoración y cuidados de enfermería a personas con problemas musculoesqueléticos' },
          { id: 45, name: 'Valoración y cuidados de enfermería a personas con problemas gastrointestinales' },
          { id: 46, name: 'Valoración y cuidados de enfermería a personas con problemas hematológicos' },
          { id: 47, name: 'Valoración y cuidados de enfermería a personas con problemas otorrinolaringológicos' },
          { id: 48, name: 'Valoración y cuidados de enfermería a personas con problemas oncológicos' },
          { id: 49, name: 'Valoración y cuidados de enfermería del paciente quirúrgico' },
          { id: 50, name: 'Valoración y cuidados de enfermería en pacientes con problemas en la piel' },
        ],
      },
    ],
    totalTopics: 50,
    navLinks: [
      { href: '/es', label: 'Inicio', icon: '🏠' },
      { href: '/enfermero-scs-canarias', label: 'Mi Oposición', icon: '🏥', featured: true },
      { href: '/enfermero-scs-canarias/temario', label: 'Temario', icon: '📚' },
      { href: '/enfermero-scs-canarias/test', label: 'Tests', icon: '🎯' },
    ],
  },
  // ========================================
