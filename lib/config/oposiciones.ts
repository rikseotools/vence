  ...
  // ========================================
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        subtitle: 'Windows 11, Office 365, Teams y Seguridad',
        icon: '💻',
        themes: [
          { id: 19, name: 'Windows 11' },
          { id: 20, name: 'Explorador de archivos Windows 11' },
          { id: 21, name: 'Microsoft Word (Microsoft 365)' },
          { id: 22, name: 'Microsoft Excel (Microsoft 365)' },
          { id: 23, name: 'Correo electrónico y Outlook (Microsoft 365)' },
          { id: 24, name: 'Microsoft Teams' },
          { id: 25, name: 'Seguridad informática' },
        ],
      },
    ],
    totalTopics: 25,
    ...
    blocks: [
      ...
      },
      {
        ...
        themes: [
          ...
          { id: 9, name: 'Ley Orgánica de Reintegración y Amejoramiento del Régimen Foral' },
          { id: 10, name: 'El Parlamento de Navarra' },
          { id: 11, name: 'El Gobierno de Navarra' },
          { id: 12, name: 'Ley Foral 11/2019 Administración Foral de Navarra' },
    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 2, name: 'El Registro y patrimonio documental de La Rioja' },
          ...
          { id: 11, name: 'Ley 39/2015 (II): actos administrativos' },
    ...
    blocks: [
      {
        ...
        icon: '⚖️',
        themes: [
          { id: 1, name: 'La Constitución Española: derechos fundamentales y derecho a la salud' },
          { id: 2, name: 'Estatuto de Autonomía de Andalucía: salud y organización institucional' },
          { id: 3, name: 'Organización sanitaria (I): Ley General de Sanidad y Ley de Salud de Andalucía' },
          { id: 4, name: 'Organización sanitaria (II): estructura del SAS y Atención Primaria/Especializada' },
          { id: 5, name: 'Protección de datos (LO 3/2018) y Transparencia Pública de Andalucía' },
          { id: 6, name: 'Prevención de riesgos laborales (Ley 31/1995)' },
          { id: 7, name: 'Igualdad de género y violencia de género en Andalucía' },
          { id: 8, name: 'Estatuto Marco del personal estatutario (Ley 55/2003)' },
          { id: 9, name: 'Autonomía del paciente (Ley 41/2002): información y documentación clínica' },
          { id: 10, name: 'Tecnologías de la información y comunicaciones en el SAS' },
        ],
      },
      {
        id: 'bloque2',
        ...
        icon: '💉',
        themes: [
          { id: 11, name: 'Sistema Nacional de Salud: Ley 16/2003 de cohesión y calidad' },
          { id: 12, name: 'Epidemiología y Salud Pública: demografía sanitaria e indicadores' },
          { id: 13, name: 'Calidad en el SSPA: evaluación y mejora continua' },
          { id: 14, name: 'Derechos de los ciudadanos y cartera de servicios del SNS' },
          { id: 15, name: 'Responsabilidad patrimonial de las Administraciones Públicas' },
          { id: 16, name: 'Formación y desarrollo profesional: Ley 44/2003 LOPS' },
          { id: 17, name: 'Gestión Sanitaria y Economía de la Salud' },
          { id: 18, name: 'Planificación sanitaria: programas de salud y evaluación' },
          { id: 19, name: 'Sistemas de información sanitaria: DIRAYA y CMBD' },
          { id: 20, name: 'Investigación cuantitativa y estadística' },
          { id: 21, name: 'Investigación cualitativa' },
          { id: 22, name: 'Proyectos de investigación: protocolo y publicación científica' },
          { id: 23, name: 'Enfermería Basada en la Evidencia' },
          { id: 24, name: 'Procesos Asistenciales Integrados (PAIs)' },
          { id: 25, name: 'Bioética y conflictos éticos en enfermería' },
          { id: 26, name: 'Gestión de Cuidados en Andalucía: continuidad y personalización' },
          { id: 27, name: 'Gestión de casos: modelo andaluz' },
          { id: 28, name: 'Telecontinuidad de Cuidados y Salud Responde' },
          { id: 29, name: 'Fundamentos de Enfermería: modelos y teorías' },
          { id: 30, name: 'Proceso Enfermero: valoración, taxonomías y planes de cuidados' },
          { id: 31, name: 'Educación para la salud individual, grupal y comunitaria' },
          { id: 32, name: 'Comunicación: relación enfermera-paciente y entrevista motivacional' },
          { id: 33, name: 'Enfermedades transmisibles, infecciones nosocomiales y esterilización' },
          { id: 34, name: 'Farmacología general: absorción, distribución, farmacovigilancia' },
          { id: 35, name: 'Prescripción enfermera en el SSPA' },
          { id: 36, name: 'Seguridad en administración de fármacos y medicamentos de alto riesgo' },
          { id: 37, name: 'Actividad física y alimentación saludable' },
          { id: 38, name: 'Alteraciones nutricionales: nutrición oral, parenteral y enteral' },
          { id: 39, name: 'Ansiedad, depresión, somatizaciones y trastornos alimentarios' },
          { id: 40, name: 'Trastorno mental grave: atención a la persona y familia' },
          { id: 41, name: 'Prevención del consumo de tabaco, alcohol y drogas' },
          { id: 42, name: 'Urgencias y Emergencias: Plan Andaluz y triaje' },
          { id: 43, name: 'Paciente crítico: Soporte Vital Básico y Avanzado' },
          { id: 44, name: 'Paciente quirúrgico: pre, intra y postoperatorio' },
          { id: 45, name: 'Manejo de heridas, úlceras y quemaduras' },
          { id: 46, name: 'Inmunizaciones: calendario vacunal de Andalucía' },
          { id: 47, name: 'Desarrollo de la conducta humana' },
          { id: 48, name: 'Recién nacido sano: valoración y cribado neonatal' },
          { id: 49, name: 'Recién nacido enfermo: situaciones críticas y urgencias' },
          { id: 50, name: 'Cuidados en la infancia: controles, alimentación y prevención' },
          { id: 51, name: 'Cuidados en la adolescencia y Programa Forma Joven' },
          { id: 52, name: 'Género y salud: perspectiva de género y equidad' },
          { id: 53, name: 'Protocolos ante violencia de género, infancia y agresiones sexuales' },
          { id: 54, name: 'Mujer gestante: embarazo, parto, puerperio y lactancia' },
          { id: 55, name: 'Diversidad de género y sexualidad: acceso a servicios sanitarios' },
          { id: 56, name: 'Salud sexual: ITS y planificación familiar' },
          { id: 57, name: 'Enfermedades infecciosas: VIH/SIDA, tuberculosis, hepatitis' },
          { id: 58, name: 'Fragilidad, vulnerabilidad, dependencia y discapacidad' },
          { id: 59, name: 'Salud en mayores de 65 años y envejecimiento saludable' },
          { id: 60, name: 'Atención y hospitalización domiciliaria' },
          { id: 61, name: 'Atención a la familia y genograma' },
          { id: 62, name: 'Salud comunitaria: promoción y activos en salud' },
          { id: 63, name: 'Atención integrada a pacientes crónicos (PAAIPEC)' },
          { id: 64, name: 'Atención al dolor: escalas y medidas farmacológicas/no farmacológicas' },
          { id: 65, name: 'Prevención de caídas: evidencia y cribado' },
          { id: 66, name: 'Dependencia: Ley de autonomía personal y coordinación sociosanitaria' },
          { id: 67, name: 'Problemas cardiovasculares: IC, IAM, HTA e ictus' },
          { id: 68, name: 'Problemas respiratorios: asma, EPOC y ventilación mecánica' },
          { id: 69, name: 'Problemas endocrinológicos: Diabetes Mellitus' },
          { id: 70, name: 'Problemas músculo-esqueléticos: traumatismos e inmovilización' },
          { id: 71, name: 'Problemas renales y urológicos: incontinencia urinaria' },
          { id: 72, name: 'Accesos vasculares: tipos, inserción y cuidados' },
          { id: 73, name: 'Paciente ostomizado' },
          { id: 74, name: 'Calidad asistencial: indicadores y cuadro de mandos' },
          { id: 75, name: 'Humanización del SSPA' },
          { id: 76, name: 'Seguridad del paciente (I): eventos adversos y gestión de riesgos' },
          { id: 77, name: 'Seguridad del paciente (II): cultura de seguridad y buenas prácticas' },
          { id: 78, name: 'Cuidados Paliativos: fase terminal y sedación paliativa' },
          { id: 79, name: 'Duelo: tipos, fases y cuidados' },
        ],
      },
    ],
    totalTopics: 79,
