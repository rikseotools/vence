    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 4, name: 'Régimen Jurídico del Gobierno de Cantabria' },
          ...
          { id: 10, name: 'Ley de Transparencia de Cantabria' },
          { id: 11, name: 'Ley 31/1995 de Prevención de Riesgos Laborales' },
          { id: 12, name: 'Igualdad y violencia de género' },
          { id: 13, name: 'Derechos de personas con discapacidad' },
          { id: 14, name: 'Carta de Derechos de la Ciudadanía' },
          { id: 15, name: 'Protección de datos (LO 3/2018)' },
          { id: 16, name: 'Atención Ciudadana (Decreto 42/2019)' },
          { id: 17, name: 'Archivos de Cantabria' },
          { id: 18, name: 'Administración electrónica Cantabria' },
        ],
      },
      {
        id: 'bloque2',
        ...
        themes: [
          ...
          { id: 23, name: 'Correo electrónico y Outlook' },
    ...
    blocks: [
      {
        ...
        icon: '📋',
        themes: [
          { id: 1, name: 'Derechos de las personas ante la Administración' },
          { id: 2, name: 'Protección de datos y comunicación' },
      ...
      },
      {
        ...
        themes: [
          ...
          { id: 8, name: 'El Derecho comunitario: fuentes' },
          { id: 9, name: 'LORAFNA (Amejoramiento del Fuero)' },
          { id: 10, name: 'El Parlamento de Navarra' },
          { id: 11, name: 'El Gobierno de Navarra' },
          { id: 12, name: 'Las Fuentes del Derecho' },
          { id: 13, name: 'Ley 40/2015 LRJSP' },
          { id: 14, name: 'Ley Foral 11/2019 Administración de Navarra' },
          { id: 15, name: 'Actos administrativos' },
          { id: 16, name: 'Procedimiento administrativo' },
          { id: 17, name: 'Estatuto del Personal de Navarra' },
          { id: 18, name: 'Hacienda Pública de Navarra' },
          { id: 19, name: 'Contratos Públicos Navarra' },
          { id: 20, name: 'Administración Electrónica en Navarra' },
          { id: 21, name: 'Transparencia Navarra' },
          { id: 22, name: 'Protección de datos (LO 3/2018)' },
          { id: 23, name: 'Igualdad de género' },
        ],
      },
      {
        id: 'bloque3',
    ...
    blocks: [
      {
        ...
        themes: [
          ...
          { id: 15, name: 'Funcionamiento y régimen jurídico de La Rioja' },
