...
function analizarIntruso(enunciado) {
  ...
  return /\bno\s+(figura|figuran|se considera|se consideran|está|están|esta|estan|forma parte|forman parte|se incluye|se incluyen|aparece|aparecen|se beneficia|se benefician|goza|gozan|disfruta|disfrutan|se presume|se presumen|se entiende|se entienden)/.test(t)
}
