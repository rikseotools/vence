...
function analizarIntruso(enunciado) {
  ...
  return /\bno\s+(figura|figuran|se considera|se consideran|está|están|esta|estan|forma parte|forman parte|se incluye|se incluyen|aparece|aparecen|se beneficia|se benefician|goza|gozan|disfruta|disfrutan|se presume|se presumen|se entiende|se entienden|se prevé|se preve|se prevén|se preven|se contempla|se contemplan|se admite|se admiten|se recoge|se recogen|se enumera|se enumeran)/.test(t)
}
