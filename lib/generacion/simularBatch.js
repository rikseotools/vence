...
/**
 * Comprueba el LOTE completo: distribución y secuencia de `correct_option` (§2.2-ter) y el
 * tell de FORMA de lote (longitud/absolutos, §2.2-bis a nivel de lote — T-150).
...
function analizarLote(preguntas) {
  ...
  const { avisos } = analizarFormaLote(preguntas)
