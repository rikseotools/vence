...
export const PREMIUM_FEATURES = {
  ...
  // Descarga/impresión del temario en PDF (POR TEMA). Es Premium para TODOS los temas
  // (decisión 21/07): free/anónimo → 👑 + modal; premium → descarga directa. No hay
  // descarga "de todo", solo por tema.
  print_pdf: {
    id: 'print_pdf',
    kind: 'ui_feature',
    ...
    modalBody:
      'Descargar el temario en PDF para estudiar sin conexión o imprimirlo es una función Premium. Con Premium tienes además tests, chat con IA y lectura por voz sin límite.',
