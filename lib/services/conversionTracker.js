 ...
 * @param {string} fromSource - Fuente de donde vino (ej: 'ai_chat_limit', 'upgrade_modal', etc)
 */
export async function trackPremiumPageView(supabase, userId, referrer = null, fromSource = null) {
  return trackConversionEvent(supabase, userId, CONVERSION_EVENTS.PREMIUM_PAGE_VIEWED, {
    referrer,
    from_source: fromSource, // ej: 'ai_chat_limit'
    timestamp: new Date().toISOString()
  })
}
