...
export async function canSendEmailType(userId, emailType) {
  ...
  switch (emailType) {
    ...
    case 'soporte_respuesta':
      return true  // Por defecto permitir emails de soporte (críticos para funcionalidad)
    case 'impugnacion_respuesta':
      return true  // Por defecto permitir emails de impugnaciones (críticos para funcionalidad)
    default:
