...
export const emailTemplates = {
    ...
    html: (userName, daysInactive, testUrl, unsubscribeUrl) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h1 style="color: #2563eb; margin: 0;">iLoveTest</h1>
        ...
        <p style="font-size: 16px; line-height: 1.6;">
          Hace <strong style="color: #dc2626;">${daysInactive} días</strong> que no te vemos por iLoveTest.
        </p>
        <p style="font-size: 16px; line-height: 1.6;">
        ...
        <div style="color: #6b7280; font-size: 12px; text-align: center;">
          ...
          <p style="margin-top: 15px;">
            iLoveTest - Preparación de Oposiciones<br>
            <a href="mailto:info@ilovetest.pro" style="color: #6b7280;">info@ilovetest.pro</a>
          </p>
        </div>
      </div>
    `
    ...
    html: (userName, daysInactive, testUrl, unsubscribeUrl) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px; background: #fef2f2; padding: 20px; border-radius: 8px;">
          <h1 style="color: #dc2626; margin: 0;">🚨 iLoveTest - ALERTA</h1>
    ...
    html: (userName, daysSince, testUrl, unsubscribeUrl) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="color: #6b7280; font-size: 12px; text-align: center;">
          ...
          <p style="margin-top: 15px;">
            iLoveTest - Tu compañero en oposiciones<br>
            <a href="mailto:info@ilovetest.pro" style="color: #6b7280;">info@ilovetest.pro</a>
          </p>
        </div>
      </div>
  ...
  welcome: {
    subject: (userName) => `¡Bienvenido a iLoveTest, ${userName}! 🎉 Tu cuenta está lista`,
    html: (userName, daysInactive, testUrl, unsubscribeUrl) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div style="background: white; border-radius: 10px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #2563eb; margin: 0; font-size: 28px;">¡Bienvenido a iLoveTest!</h1>
            <p style="color: #6b7280; margin: 10px 0; font-size: 18px;">Tu plataforma de preparación de oposiciones</p>
          </div>
          
          <h2 style="color: #2563eb;">¡Hola ${userName}! 👋</h2>
          <p style="font-size: 16px; line-height: 1.6; color: #374151;">
            <strong>¡Tu cuenta en iLoveTest está lista!</strong> Nos alegra mucho que hayas decidido preparar tu oposición con nosotros.
          </p>
          ...
          <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: center;">
            <h3 style="margin-top: 0; color: white;">🚀 ¿Listo para empezar?</h3>
            <p style="margin-bottom: 0; opacity: 0.9;">
              <strong>Paso 1:</strong> Haz tu primer test para que podamos personalizar tu experiencia
            </p>
          </div>
          
          <div style="text-align: center; margin: 30px 0;">
            <a href="${testUrl}" style="display: inline-block; background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: white; padding: 18px 35px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px rgba(37, 99, 235, 0.3);">
              🎯 Hacer Mi Primer Test (5 min)
            </a>
          </div>
          
          <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #2563eb;">
            <h3 style="color: #1f2937; margin-top: 0;">💡 ¿Qué puedes hacer en iLoveTest?</h3>
            <ul style="color: #374151; margin: 0; padding-left: 20px;">
              <li><strong>Tests personalizados</strong> adaptados a tu nivel</li>
              <li><strong>Seguimiento de progreso</strong> con estadísticas detalladas</li>
              <li><strong>Preguntas de exámenes oficiales</strong> reales</li>
              <li><strong>Artículos más importantes</strong> detectados automáticamente</li>
            </ul>
          </div>
          
          <div style="background: #fef3c7; padding: 15px; border-radius: 6px; margin: 20px 0;">
            <p style="margin: 0; color: #92400e; font-size: 14px; text-align: center;">
              💪 <strong>Consejo:</strong> Dedica solo 15 minutos al día y verás resultados increíbles
            </p>
          </div>
      ...
      return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="color: #6b7280; font-size: 12px; text-align: center;">
            ...
            <p style="margin-top: 15px;">
              iLoveTest - Tu progreso semanal<br>
              <a href="mailto:info@ilovetest.pro" style="color: #6b7280;">info@ilovetest.pro</a>
            </p>
          </div>
        </div>
...
export function getEmailTypeName(type) {
  const names = {
    ...
    'resumen_semanal': 'Resumen Semanal'  // 🆕 NUEVO
  }
