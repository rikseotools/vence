...
export const emailTemplates = {
  ...
  welcome: {
    subject: (userName) => `¡Bienvenido a Vence, ${userName}! 🎉 Tu cuenta está lista`,
    html: (userName, daysInactive, testUrl, unsubscribeUrl) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div style="background: white; border-radius: 10px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #2563eb; margin: 0; font-size: 28px;">¡Bienvenido a Vence!</h1>
            <p style="color: #6b7280; margin: 10px 0; font-size: 18px;">Tu plataforma de preparación de oposiciones</p>
          </div>
          
          <h2 style="color: #2563eb;">¡Hola ${userName}! 👋</h2>
          <p style="font-size: 16px; line-height: 1.6; color: #374151;">
            <strong>¡Tu cuenta en Vence está lista!</strong> Nos alegra mucho que hayas decidido preparar tu oposición con nosotros.
          </p>
          ...
          <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #2563eb;">
            <h3 style="color: #1f2937; margin-top: 0;">💡 ¿Qué puedes hacer en Vence?</h3>
          ...
          <div style="color: #6b7280; font-size: 12px; text-align: center;">
            ...
            <p style="margin-top: 15px;">
              Vence - Tu éxito en oposiciones<br>
              <a href="mailto:info@vence.es" style="color: #6b7280;">info@vence.es</a>
            </p>
          </div>
        </div>
