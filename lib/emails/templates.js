  ...
  soporte_respuesta: {
    ...
    html: (userName, adminMessage, chatUrl, unsubscribeUrl) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <h2 style="color: #2563eb;">¡Hola ${userName}! 💬</h2>
        <p style="font-size: 16px; line-height: 1.6;">
          El equipo de <strong style="color: #2563eb;">Vence</strong> te ha respondido a tu consulta.
        </p>
        
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #2563eb;">
          <h3 style="color: #1f2937; margin-top: 0;">📩 Mensaje del equipo:</h3>
          <p style="margin-bottom: 0; font-style: italic; color: #374151; background: white; padding: 15px; border-radius: 6px; border: 1px solid #e5e7eb;">
            "${adminMessage}"
          </p>
        </div>
        
        <div style="text-align: center; margin: 30px 0;">
          <a href="${chatUrl}" style="display: inline-block; background: #2563eb; color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
            💬 Ver Chat Completo
          </a>
        </div>
        ...
        <div style="background: #f3f4f6; padding: 15px; border-radius: 6px; margin: 20px 0;">
          <p style="margin: 0; color: #374151; font-size: 14px;">
            💡 <strong>Nota:</strong> Puedes continuar la conversación directamente en la plataforma.
          </p>
        </div>
        ...
        <div style="color: #6b7280; font-size: 12px; text-align: center;">
          <p>Este email se envió porque el equipo de soporte te ha respondido y no estabas conectado.</p>
          <p>
            Si no quieres recibir emails de soporte, puedes 
            <a href="${unsubscribeUrl}" style="color: #2563eb;">desactivarlos en tu perfil</a>.
          </p>
          <p style="margin-top: 15px;">
            Vence - Preparación de Oposiciones<br>
