...
const oposicionToExamSourcePattern: Record<string, string> = {
  ...
  'auxiliar-administrativo-carm': '%Auxiliar Administrativo CARM Murcia%',
  'auxiliar-administrativo-extremadura': '%Auxiliar Administrativo Junta de Extremadura%',
  'auxiliar-administrativo-canarias': '%Auxiliar Administrativo Gobierno de Canarias%',
