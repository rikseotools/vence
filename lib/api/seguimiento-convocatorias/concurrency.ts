// lib/api/seguimiento-convocatorias/concurrency.ts
// Helpers de concurrencia para el cron check-seguimiento (refactor 2026-05-07).
// Sin dependencias externas — implementación mínima de concurrency limit.
