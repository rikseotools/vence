...
(async () => {
  ...
  if (q && q.primary_article_id) {
    ...
    if (art) {
      ...
      articuloCompleto = {
        id: art.id,
        numero: art.article_number,
        contenido: art.content,
        ley: law ? law.short_name : null,
        leyCompleta: law ? law.full_name : null
      };
    }
  }

  console.log("========================================");
  console.log("IMPUGNACIÓN #1");
  console.log("========================================");
  console.log("");
  ...
  if (articuloCompleto) {
    console.log("Art.", articuloCompleto.numero, articuloCompleto.ley);
    console.log("Ley completa:", articuloCompleto.leyCompleta);
    console.log("");
    console.log("CONTENIDO COMPLETO:");
    console.log(articuloCompleto.contenido);
  } else {
    console.log("(sin artículo vinculado)");
  }
})();
