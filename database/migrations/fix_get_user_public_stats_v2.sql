-- Migration: fix_get_user_public_stats_v2
-- Corrige la función para usar test_questions en lugar de detailed_answers (que no existe)
...
'Estadísticas públicas del usuario. Usa test_questions (no detailed_answers). total_topics es dinámico según la oposición.';
